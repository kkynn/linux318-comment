...
//#pragma message "CONFIG_UBI_MTD_RTK_PATCH is not predefined!"
#define CONFIG_UBI_MTD_RTK_PATCH 0
#else
#pragma message "CONFIG_UBI_MTD_RTK_PATCH is " XSTR(CONFIG_UBI_MTD_RTK_PATCH)
#endif

#ifndef CONFIG_MAX_ALLOWED_ERR_IN_BLANK_PAGE
//#pragma message "CONFIG_MAX_ALLOWED_ERR_IN_BLANK_PAGE is not predefined!"
#define CONFIG_MAX_ALLOWED_ERR_IN_BLANK_PAGE 4
#endif
#pragma message "CONFIG_MAX_ALLOWED_ERR_IN_BLANK_PAGE is " XSTR(CONFIG_MAX_ALLOWED_ERR_IN_BLANK_PAGE)
