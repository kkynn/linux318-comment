...
onfi_get_sts_reg_t *_ofu_get_sts_reg_ptr SECTION_SDATA = (onfi_get_sts_reg_t *)_onfi_dummy_func;
...
onfi_page_read_write_ecc_t  *_ofu_page_read_with_ode_ptr = (onfi_page_read_write_ecc_t *)_onfi_dummy_func;
onfi_page_read_write_ecc_t  *_ofu_page_write_with_ode_ptr = (onfi_page_read_write_ecc_t *)_onfi_dummy_func;
...
symb_retrive_entry_t onfi_func_retrive_list[] SECTION_RECYCLE_DATA = {
    ...
    {ONFI_GET_STATUS_FUNC,         &_ofu_get_sts_reg_ptr},
