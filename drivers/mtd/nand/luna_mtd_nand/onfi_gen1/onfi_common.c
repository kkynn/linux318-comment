...
#if defined(__LUNA_KERNEL__)
fpv_t  *_opu_reset_ptr                   = onfi_reset_nand_chip;
onfi_get_sts_reg_t *_opu_get_sts_reg_ptr = onfi_get_status_register;
fps32_t *_opu_chk_program_erase_sts_ptr  = onfi_check_program_erase_status;
fpu32_t *_opu_read_onfi_id               = onfi_read_id;
#endif
