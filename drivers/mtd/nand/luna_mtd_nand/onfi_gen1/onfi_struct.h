...
struct onfi_info_s {
    ...
    /* NOTE:
         * "bs_page_size" is only exists in "onfi_gen1". 
         * There is no boot-strappin can pass this info in the RTL design.
         * Set in "project/info.in" temporarily for "onfi_gen1".
         */
