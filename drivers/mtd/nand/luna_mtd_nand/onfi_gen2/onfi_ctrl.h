...
/************************************************************/
/****** Parallel NAND Controller Field Enable/Disable Description ******/
/************************************************************/
// Register(NASR)
#define NECN       (1<<4)
#define NRER       (1<<3)
...
/***********************************************
  *  ONFI Controller Drivers & Function Pointer 
  ***********************************************/
extern onfi_model_info_t onfi_rom_general_model;
extern onfi_model_info_t onfi_ode_model;

#define WAIT_ONFI_CTRL_READY()    while(!RFLD_NACR(ready))
#define DIS_ONFI_CE0_CE1()        NACMRrv=0
#define CLEAR_ONFI_CTRL_STS_REG() NASRrv=(NWER|NRER|NDRS|NDWS)
