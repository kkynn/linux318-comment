...
struct mtd_info *spi_probe_g2(struct map_info *map) {
	...
	mtd->_erase   = mtd_spi_erase_g2;
	mtd->_read    = mtd_spi_read_g2;
	mtd->_write   = mtd_spi_write_g2;
	mtd->_sync    = mtd_spi_sync_g2;
	mtd->_lock    = mtd_spi_lock_g2;
	mtd->_unlock  = mtd_spi_unlock_g2;
	mtd->_suspend = mtd_spi_suspend_g2;
	mtd->_resume  = mtd_spi_resume_g2;
	mtd->priv    = (void *)map;
