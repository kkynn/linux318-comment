...
int32 _rtk_rg_apollo_classifyEntry_add(rtk_rg_classifyEntry_t *classifyFilter)
{
	...
	if(classifyFilter->filter_fields & EGRESS_GEMIDX_BIT){
		...
		rg_db.systemGlobal.classifyField[CF_PATTERN_GEMIDX_OR_LLID].classify_pattern.fieldData.value=(classifyFilter->gemidx & 0xff);
		if(classifyFilter->gemidx_mask==0x0){
			//for compitible of non-mask version (mask not set means all care)
			rg_db.systemGlobal.classifyField[CF_PATTERN_GEMIDX_OR_LLID].classify_pattern.fieldData.mask=0x7f;	
			classifyFilter->gemidx_mask=0x7f;
		}else{
			rg_db.systemGlobal.classifyField[CF_PATTERN_GEMIDX_OR_LLID].classify_pattern.fieldData.mask=(classifyFilter->gemidx_mask&0xff); 
		}
	}

	if(classifyFilter->filter_fields & EGRESS_LLID_BIT){
		rg_db.systemGlobal.classifyField[CF_PATTERN_GEMIDX_OR_LLID].fieldType=CLASSIFY_FIELD_TOS_DSIDX;
		rg_db.systemGlobal.classifyField[CF_PATTERN_GEMIDX_OR_LLID].classify_pattern.fieldData.value=(classifyFilter->llid & 0xf); //llid 4 bits only
		rg_db.systemGlobal.classifyField[CF_PATTERN_GEMIDX_OR_LLID].classify_pattern.fieldData.mask=0xf;	
	}
...
static int _rtk_rg_aclAndCfReservedRuleHeadReflash(void)
{
	...
	for(i=1;i<rg_db.systemGlobal.aclAndCfReservedRule.aclLowerBoundary;i++){
				...
				case RTK_RG_ACLANDCF_RESERVED_L2TP_CONTROL_LCP_PACKET_TRAP_AND_ASSIGN_PRIORITY:
					{
						...
						aclField_dmac0.fieldUnion.data.value = 0x1; //using pktLen[0]
						aclField_dmac0.fieldUnion.data.mask = 0xffff;
						if(rtk_acl_igrRuleField_add(&aclRule, &aclField_dmac0)){
							ACL_RSV("add reserved ACL&CF RTK_RG_ACLANDCF_RESERVED_L2TP_CONTROL_LCP_PACKET_TRAP_AND_ASSIGN_PRIORITY failed!!!");
							addRuleFailedFlag=1;
...
int _rtk_rg_aclAndCfReservedRuleAdd(rtk_rg_aclAndCf_reserved_type_t rsvType, void *parameter)
{
	...
	switch(rsvType){
		...
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_FAIL_TRAP:
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(3,0));
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_FAIL_TRAP]=ENABLED; 
			break;

		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF0_NONE_IP_VLAN_TRANSLATE: 
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[0],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF0_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF1_NONE_IP_VLAN_TRANSLATE:
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[1],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF1_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF2_NONE_IP_VLAN_TRANSLATE:
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[2],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF2_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF3_NONE_IP_VLAN_TRANSLATE:			
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[3],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF3_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF4_NONE_IP_VLAN_TRANSLATE:
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[4],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF4_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF5_NONE_IP_VLAN_TRANSLATE:
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[5],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF5_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF6_NONE_IP_VLAN_TRANSLATE:
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[6],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF6_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		case RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF7_NONE_IP_VLAN_TRANSLATE: 
			assert_ok(_rtk_rg_aclAndCfReservedRuleAddCheck(1,0));
			memcpy(&rg_db.systemGlobal.aclAndCfReservedRule.none_ip_bind_translate_vid[7],(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t*)parameter,sizeof(rtk_rg_aclAndCf_reserved_none_ip_bind_translate_vid_t));				
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_PORTBINDING_INTF7_NONE_IP_VLAN_TRANSLATE]=ENABLED; 
			break;
		...
		case RTK_RG_ACLANDCF_RESERVED_LAN_TO_INTERNET_BRIDGEWAN_VLAN_TRANSLATE:
			...
			rg_db.systemGlobal.aclAndCfReservedRule.reservedMask[RTK_RG_ACLANDCF_RESERVED_LAN_TO_INTERNET_BRIDGEWAN_VLAN_TRANSLATE]=ENABLED; 
			break;
