...
#ifndef __DAL_RTL9603D_TRAP_H__
#define __DAL_RTL9603D_TRAP_H__
 ...
 * Data Declaration
 */
typedef enum rtl9603d_igmpAction_e
{
    RTL9603D_IGMP_ACT_FORWARD  = 0,
    RTL9603D_IGMP_ACT_DROP,
    RTL9603D_IGMP_ACT_TRAP,
    RTL9603D_IGMP_ACT_END,
} rtl9603d_igmpAction_t;

typedef enum rtl9603d_l2_commonAct_e
{
    RTL9603D_L2_COMMON_ACT_FORWARD = 0,
    RTL9603D_L2_COMMON_ACT_DROP,
    RTL9603D_L2_COMMON_ACT_TRAP,
    RTL9603D_L2_COMMON_ACT_COPY2CPU,
    RTL9603D_L2_COMMON_ACT_END,
}rtl9603d_l2_commonAct_t;

typedef enum rtl9603d_rmaAction_e
{
    RTL9603D_RMA_ACT_FORWARD  = 0,
    RTL9603D_RMA_ACT_TRAP ,
    RTL9603D_RMA_ACT_DROP ,
    RTL9603D_RMA_ACT_END ,
} rtl9603d_rmaAction_t;

typedef enum
{
    RTL9603D_TRAP_HASH_SPA = 0,
    RTL9603D_TRAP_HASH_SMAC,
    RTL9603D_TRAP_HASH_DMAC,
    RTL9603D_TRAP_HASH_SIP_INNER,
    RTL9603D_TRAP_HASH_DIP_INNER,
    RTL9603D_TRAP_HASH_SPORT_INNER,
    RTL9603D_TRAP_HASH_DPORT_INNER,
    RTL9603D_TRAP_HASH_END
} rtl9603d_trap_hash_t;
...
/* Function Name:
 *      dal_rtl9603d_trap_rmaVlanCheckEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaVlanCheckEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9603d_trap_rmaVlanCheckEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaVlanCheckEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9603d_trap_rmaPortIsolationEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaPortIsolationEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9603d_trap_rmaPortIsolationEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaPortIsolationEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9603d_trap_rmaStormControlEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaStormControlEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9603d_trap_rmaStormControlEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaStormControlEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9603d_trap_rmaKeepCtagEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaKeepCtagEnable_get(rtk_mac_t *pRmaFrame, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9603d_trap_rmaKeepCtagEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_rmaKeepCtagEnable_set(rtk_mac_t *pRmaFrame, rtk_enable_t enable);
...
/* Function Name:
 *      dal_rtl9603d_trap_oamPduAction_get
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_oamPduAction_get(rtk_action_t *pAction);

/* Function Name:
 *      dal_rtl9603d_trap_oamPduAction_set
 * Description:
 ...
 */
extern int32
dal_rtl9603d_trap_oamPduAction_set(rtk_action_t action);
 ...
 */
extern int32
dal_rtl9603d_trap_portOamPduAction_get ( rtk_port_t port, rtk_action_t* pAction );
 ...
 */
extern int32
dal_rtl9603d_trap_portOamPduAction_set ( rtk_port_t port, rtk_action_t action );
 ...
 */
extern int32
dal_rtl9603d_trap_uniTrapPriorityEnable_set(rtk_enable_t state);
 ...
 */
extern int32
dal_rtl9603d_trap_uniTrapPriorityEnable_get(rtk_enable_t *pState);
