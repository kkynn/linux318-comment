 ...
 *
 */
#ifndef _DAL_RTL9603D_EPON_H_
#define _DAL_RTL9603D_EPON_H_
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_init(void);  
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_intrMask_get(rtk_epon_intrType_t intrType, rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_intrMask_set(rtk_epon_intrType_t intrType, rtk_enable_t state);




/* Function Name:
 *      dal_rtl9603d_epon_topIntr_get
 * Description:
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_intr_get(rtk_epon_intrType_t intrType, rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_intr_disableAll(void);  
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_llid_entry_set(rtk_epon_llid_entry_t *pLlidEntry);  
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_llid_entry_get(rtk_epon_llid_entry_t *pLlidEntry);  
 ...
 * Note:
 */
extern int32  dal_rtl9603d_epon_forceLaserState_set(rtk_epon_laser_status_t laserStatus);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_forceLaserState_get(rtk_epon_laser_status_t *pLaserStatus);
 ...
 * Note:
 */
extern int32  dal_rtl9603d_epon_laserTime_set(uint8 lasetOnTime, uint8 lasetOffTime);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_laserTime_get(uint8 *pLasetOnTime, uint8 *pLasetOffTime);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_syncTime_get(uint8 *pSyncTime);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_registerReq_get(rtk_epon_regReq_t *pRegEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_registerReq_set(rtk_epon_regReq_t *pRegEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_churningKey_set(rtk_epon_churningKeyEntry_t *pEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_churningKey_get(rtk_epon_churningKeyEntry_t *pEntry);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_usFecState_get(rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_usFecState_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_dsFecState_get(rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_dsFecState_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_mibCounter_get(rtk_epon_counter_t *pCounter);
...
/* Function Name:
 *      dal_rtl9603d_epon_fecState_get
 * Description:
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_fecState_get(rtk_enable_t *pState);


/* Function Name:
 *      dal_rtl9603d_epon_fecState_set
 * Description:
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_fecState_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_llidEntryNum_get(uint32 *num);
...
extern int32 rtl9603d_raw_epon_forceLaserOn_set(uint32 force);
extern int32 rtl9603d_raw_epon_forceLaserOn_get(uint32 *pForce);
 ...
 *      
 */
extern int32 dal_rtl9603d_epon_multiLlidMode_set(rtk_epon_multiLlidMode_t mode);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_multiLlidMode_get(rtk_epon_multiLlidMode_t *pMode);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_forcePRBS_set ( rtk_epon_prbs_t prbsCfg );
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_forcePRBS_get ( rtk_epon_prbs_t* pPrbsCfg );
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_autoPowerSavingState_get(rtk_enable_t *pEnable);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_autoPowerSavingState_set(rtk_enable_t enable);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_autoPowerSavingOeRecoverTime_get(int *pRecoverTime);
 ...
 * Note:
 */
extern int32 dal_rtl9603d_epon_autoPowerSavingOeRecoverTime_set(int recoverTime);




#endif /*#ifndef _DAL_RTL9603D_EPON_H_*/
