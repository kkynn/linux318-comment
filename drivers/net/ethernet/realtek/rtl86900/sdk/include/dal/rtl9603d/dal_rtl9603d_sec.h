...
#ifndef __DAL_RTL9603D_SEC_H__
#define __DAL_RTL9603D_SEC_H__
...
typedef enum rtl9603d_raw_dosAction_e
{
    DAL_RTL9603D_DOS_ACT_DROP  = 0,
    DAL_RTL9603D_DOS_ACT_TRAP,

} rtl9603d_raw_dosAction_t;
