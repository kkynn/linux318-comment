...
#ifndef __DAL_RTL9607C_L2_H__
#define __DAL_RTL9607C_L2_H__
...
/* Constant Definition											*/
/****************************************************************/
#define RTL9607C_RAW_LUT_AGESPEEDMAX    0x1FFFFF
#define RTL9607C_RAW_LUT_AGEMAX         0x7
#define RTL9607C_RAW_LUT_L3IDXAMAX      0XFFFFFFF
#define RTL9607C_RAW_LUT_EXT_SPAMAX     0X7
#define RTL9607C_RAW_LUT_L3MCRIDXMAX    0X7
#define RTL9607C_RAW_LUT_EXTMBRIDX      0x1F
#define RTL9607C_RAW_LUT_FIDMAX         0X3

#define RTL9607C_LUT_4WAY_NO            2048
#define RTL9607C_LUT_CAM_NO             64
#define RTL9607C_LUT_TBL_NO             (RTL9607C_LUT_4WAY_NO + RTL9607C_LUT_CAM_NO) /*2K 4 ways hash entries + 64 CAM entries*/
#define RTL9607C_LUT_TBL_MAX            (RTL9607C_LUT_TBL_NO - 1)
	
#define RTL9607C_PORTMASK               0x7FF
#define RTL9607C_TBL_BUSY_CHECK_NO      0xFF

#define RTL9607C_IPMC_TABLE_ENTRY       64
#define RTL9607C_IPMC_TABLE_IDX_MAX     (RTL9607C_IPMC_TABLE_ENTRY - 1)

#define RTL9607C_HASH_FLAG_CHECK(x, y)  ((((x) & (y)) == (y)) ? 1 : 0)

/****************************************************************/
/* Type Definition												*/
/****************************************************************/
typedef enum rtl9607c_raw_l2_entryType_e
{
    RTL9607C_RAW_LUT_ENTRY_TYPE_L2UC = 0,
    RTL9607C_RAW_LUT_ENTRY_TYPE_L2MC,
    RTL9607C_RAW_LUT_ENTRY_TYPE_L3MC,
    RTL9607C_RAW_LUT_ENTRY_TYPE_END,
}rtl9607c_raw_l2_entryType_t;

typedef enum rtl9607c_raw_ipmc_type_e
{
    RTL9607C_RAW_IPMC_TYPE_MAC_AND_FID_VID = 0,
    RTL9607C_RAW_IPMC_TYPE_GIP_AND_FID_VID,
    RTL9607C_RAW_IPMC_TYPE_GIP_AND_SIP,
    RTL9607C_RAW_IPMC_TYPE_END
}rtl9607c_raw_ipmc_type_t;

typedef enum rtl9607c_raw_ipmcVlan_mode_e
{
    RTL9607C_RAW_IPMC_VLAN_MODE_IVL_SVL = 0,
    RTL9607C_RAW_IPMC_VLAN_MODE_FORCE_NO_VLAN,
    RTL9607C_RAW_IPMC_VLAN_MODE_FORCE_VLAN,
    RTL9607C_RAW_IPMC_VLAN_END
}rtl9607c_raw_ipmcVlan_mode_t;

typedef enum rtl9607c_raw_l2_readMethod_e
{
	RTL9607C_RAW_LUT_READ_METHOD_MAC = 0,
	RTL9607C_RAW_LUT_READ_METHOD_ADDRESS,
	RTL9607C_RAW_LUT_READ_METHOD_NEXT_ADDRESS,
	RTL9607C_RAW_LUT_READ_METHOD_NEXT_L2UC,
	RTL9607C_RAW_LUT_READ_METHOD_NEXT_L2MC,
	RTL9607C_RAW_LUT_READ_METHOD_NEXT_L3MC,
	RTL9607C_RAW_LUT_READ_METHOD_NEXT_L2L3MC,
	RTL9607C_RAW_LUT_READ_METHOD_NEXT_L2UCSPA,
	RTL9607C_RAW_LUT_READ_METHOD_END,
}rtl9607c_raw_l2_readMethod_t;

typedef enum rtl9607c_raw_l2_flushStatus_e
{
	RTL9607C_RAW_FLUSH_STATUS_NONBUSY =0,
	RTL9607C_RAW_FLUSH_STATUS_BUSY,
	RTL9607C_RAW_FLUSH_STATUS_END,
}rtl9607c_raw_l2_flushStatus_t;

typedef enum rtl9607c_raw_l2_flushMode_e
{
	RTL9607C_RAW_FLUSH_MODE_PORT = 0,
	RTL9607C_RAW_FLUSH_MODE_VID,
	RTL9607C_RAW_FLUSH_MODE_FID,
	RTL9607C_RAW_FLUSH_MODE_END,
}rtl9607c_raw_l2_flushMode_t;

typedef enum rtl9607c_raw_l2_flushType_e
{
	RTL9607C_RAW_FLUSH_TYPE_DYNAMIC = 0,
	RTL9607C_RAW_FLUSH_TYPE_STATIC ,
	RTL9607C_RAW_FLUSH_TYPE_BOTH,
	RTL9607C_RAW_FLUSH_TYPE_END,
}rtl9607c_raw_l2_flushType_t;

typedef enum rtl9607c_raw_l2_l2HashType_e
{
	RTL9607C_RAW_L2_HASH_SVL = 0,
	RTL9607C_RAW_L2_HASH_IVL,
	RTL9607C_RAW_L2_HASH_END
}rtl9607c_raw_l2_l2HashType_t;

typedef enum rtl9607c_l2_resAct_e
{
	RTL9607C_L2_RESACT_NORMAL_UKNOWN_MC = 0,
	RTL9607C_L2_RESACT_FLOODING,
	RTL9607C_L2_RESACT_TRAP,
	RTL9607C_L2_RESACT_END
}rtl9607c_l2_resAct_t;

typedef struct rtl9607c_raw_flush_ctrl_s
{
    rtl9607c_raw_l2_flushStatus_t flushStatus;
    rtl9607c_raw_l2_flushMode_t flushMode;
    rtl9607c_raw_l2_flushType_t flushType;
    rtk_vlan_t vid;
    rtk_fid_t fid;
}rtl9607c_raw_flush_ctrl_t;

typedef struct rtl9607c_raw_l2_table_s
{
    rtl9607c_raw_l2_readMethod_t method;
    /*s/w information*/
    rtl9607c_raw_l2_entryType_t table_type;
    uint32 lookup_hit;
    uint32 lookup_busy;
    uint32 address;
    uint32 wait_time;
    ...
    uint32 l3lookup;
    uint32 nosalearn;
    rtl9607c_raw_l2_l2HashType_t ivl_svl;
    uint32 valid;
    ...
    uint32 mbr;
    uint32 ext_mbr_idx;
}rtl9607c_lut_table_t;

/*
 * Data Declaration
 */
extern int32 rtl9607c_raw_l2_lookUpTb_set(rtl9607c_lut_table_t *pL2Table);
extern int32 rtl9607c_raw_l2_lookUpTb_get(rtl9607c_lut_table_t *pL2Table);
extern int32 rtl9607c_raw_l2_flushEn_set(rtk_port_t port, rtk_enable_t enabled);
extern int32 rtl9607c_raw_l2_flushEn_get(rtk_port_t port, rtk_enable_t *pEnabled);
extern int32 rtl9607c_raw_l2_flushCtrl_set(rtl9607c_raw_flush_ctrl_t *pCtrl);
extern int32 rtl9607c_raw_l2_flushCtrl_get(rtl9607c_raw_flush_ctrl_t *pCtrl);
extern int32 rtl9607c_l2_unknReservedIpv4McAction_set(rtl9607c_l2_resAct_t act);
extern int32 rtl9607c_l2_unknReservedIpv4McAction_get(rtl9607c_l2_resAct_t *pAct);
extern int32 rtl9607c_l2_unknReservedIpv6McAction_set(rtl9607c_l2_resAct_t act);
extern int32 rtl9607c_l2_unknReservedIpv6McAction_get(rtl9607c_l2_resAct_t *pAct);
extern int32 rtl9607c_l2_unknMcIcmpv6_set(rtk_enable_t enable);
extern int32 rtl9607c_l2_unknMcIcmpv6_get(rtk_enable_t *pEnable);
extern int32 rtl9607c_l2_unknMcDhcpv6_set(rtk_enable_t enable);
extern int32 rtl9607c_l2_unknMcDhcpv6_get(rtk_enable_t *pEnable);
...
/* Function Name:
 *      dal_rtl9607c_l2_staticAgingEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl9607c_l2_staticAgingEnable_get(rtk_enable_t *pEnable);
 ...
 */
extern int32
dal_rtl9607c_l2_staticAgingEnable_set(rtk_enable_t enable);
