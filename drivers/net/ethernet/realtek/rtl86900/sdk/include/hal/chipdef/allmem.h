 ...
 *
 * $Revision: 86572 $
 * $Date: 2018-03-12 19:24:25 +0800 (Mon, 12 Mar 2018) $
 *
...
/* structure is word array that have the maximum value of all supported chips. */
    ...
    /*L2 table entry*/
    MEM_ENTRY_DECLARE(rtl9603d_l2_entry_t, 3);
    /*LUT entry*/
    MEM_ENTRY_DECLARE(rtl9603d_l2_lut_entry_t, 3);
    /*Vlan table entry*/
    MEM_ENTRY_DECLARE(rtl9603d_vlan_entry_t, 2);
    /*ACL table entry*/
    MEM_ENTRY_DECLARE(rtl9603d_acl_act_entry_t, 2);
    MEM_ENTRY_DECLARE(rtl9603d_acl_rule_entry_t, 5);
    /*classification table entry*/
    MEM_ENTRY_DECLARE(rtl9603d_cf_act_entry_t, 3);
    MEM_ENTRY_DECLARE(rtl9603d_cf_rule_entry_t, 2);	
	/*debug table entry*/
    MEM_ENTRY_DECLARE(rtl9603d_hsb_entry_t, 27);
    MEM_ENTRY_DECLARE(rtl9603d_hsa_entry_t, 21);

    /*L34 table entry*/
    MEM_ENTRY_DECLARE(rtl9603d_l34_pppoe_entry_t, 1);
    MEM_ENTRY_DECLARE(rtl9603d_l34_arp_entry_t, 2);
    MEM_ENTRY_DECLARE(rtl9603d_l34_netif_entry_t, 4);
    MEM_ENTRY_DECLARE(rtl9603d_l34_routing_entry_t, 2);
    MEM_ENTRY_DECLARE(rtl9603d_l34_nexthop_entry_t, 1);
    MEM_ENTRY_DECLARE(rtl9603d_l34_extip_entry_t, 3);
    MEM_ENTRY_DECLARE(rtl9603d_l34_napt_inbound_entry_t, 3);
    MEM_ENTRY_DECLARE(rtl9603d_l34_napt_outbound_entry_t, 1);
    MEM_ENTRY_DECLARE(rtl9603d_l34_ipv6_routing_entry_t, 5);
    MEM_ENTRY_DECLARE(rtl9603d_l34_ipv6_neighbor_entry_t, 3);
    MEM_ENTRY_DECLARE(rtl9603d_l34_binding_entry_t, 1);
    MEM_ENTRY_DECLARE(rtl9603d_l34_wan_type_entry_t, 1);
    MEM_ENTRY_DECLARE(rtl9603d_l34_hsa_entry_t, 5);
    MEM_ENTRY_DECLARE(rtl9603d_l34_hsb_entry_t, 14);
    MEM_ENTRY_DECLARE(rtl9603d_l34_flow_route_entry_t, 5);
#endif
