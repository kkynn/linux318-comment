...
#define RTL9601B_MII_DATA_GPIO_PIN  (61)
    ...
    #define RTL9607C_DEFAULT_MIIM_PAGE    (0xA40)
        ...
        #define SDK_ASICDRV_RTL9607C_TEST_L2_SIZE             2048
...
#ifdef CONFIG_SDK_RTL9603D
    #define RTL9603D_L34_TABLE_WORD  (5)
    #define RTL9603D_L2_TABLE_WORD   (5)
    #define RTL9603D_LUT_TABLE_WORD  (4)

    #define RTL9603D_DEFAULT_MIIM_PAGE    (0xA40)

    #if defined(CONFIG_SDK_ASICDRV_TEST)
        #define SDK_ASICDRV_RTL9603D_TEST_VLAN_SIZE           (RTK_VLAN_ID_MAX+1)
        #define SDK_ASICDRV_RTL9603D_TEST_ACLACTION_SIZE      128
        #define SDK_ASICDRV_RTL9603D_TEST_CFACTION_SIZE       256
        #define SDK_ASICDRV_RTL9603D_TEST_CFTBLENTRY_SIZE     256
        #define SDK_ASICDRV_RTL9603D_TEST_L2_SIZE             2048
        #define SDK_ASICDRV_RTL9603D_TEST_PPPOE_SIZE          RTL9603D_L34_PPPOE_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_ARP_SIZE            RTL9603D_L34_ARP_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_NETIF_SIZE          RTL9603D_L34_NETIF_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_ROUTE_SIZE          RTL9603D_L34_ROUTING_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_NEXTHOP_SIZE        RTL9603D_L34_NH_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_NAPT_OUTBOUND_SIZE  RTL9603D_L34_NAPT_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_NAPT_INBOUND_SIZE   RTL9603D_L34_NAPTR_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_L34_EXTIP_SIZE      RTL9603D_L34_EXTIP_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_ROUTE6_SIZE         RTL9603D_L34_IPV6_ROUTING_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_NBR_SIZE            RTL9603D_L34_IPV6_NBR_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_BINDING_SIZE        RTL9603D_L34_BINDING_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_WAN_TYPE_SIZE       RTL9603D_L34_WAN_TYPE_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_ARP_SIZE            RTL9603D_L34_ARP_TABLE_MAX
        #define SDK_ASICDRV_RTL9603D_TEST_FLOW_ROUTE_SIZE       RTL9603D_L34_FLOW_ROUTE_TABLE_MAX

        rtl9603d_vlan_entry_t      Rtl9607cVirtualVlanTable[SDK_ASICDRV_RTL9603D_TEST_VLAN_SIZE + 1];

        rtl9603d_acl_act_entry_t Rtl9607cVirtualAclActTable[SDK_ASICDRV_RTL9603D_TEST_ACLACTION_SIZE + 1];
        rtl9603d_acl_rule_entry_t Rtl9607cVirtualAclDataTable[SDK_ASICDRV_RTL9603D_TEST_ACLACTION_SIZE + 1];
        rtl9603d_acl_rule_entry_t Rtl9607cVirtualAclMaskTable[SDK_ASICDRV_RTL9603D_TEST_ACLACTION_SIZE + 1];

        rtl9603d_cf_act_entry_t Rtl9607cVirtualCfActDsTable[SDK_ASICDRV_RTL9603D_TEST_CFACTION_SIZE + 1];
        rtl9603d_cf_act_entry_t Rtl9607cVirtualCfActUsTable[SDK_ASICDRV_RTL9603D_TEST_CFACTION_SIZE + 1];
        rtl9603d_cf_rule_entry_t Rtl9607cVirtualCfDataTable[SDK_ASICDRV_RTL9603D_TEST_CFTBLENTRY_SIZE + 1];
        rtl9603d_cf_rule_entry_t Rtl9607cVirtualCfMaskTable[SDK_ASICDRV_RTL9603D_TEST_CFTBLENTRY_SIZE + 1];
        rtl9603d_l2_lut_entry_t Rtl9607cVirtualLutTable[SDK_ASICDRV_RTL9603D_TEST_L2_SIZE + 1];

    #endif


#endif /*CONFIG_SDK_RTL9603D*/
...
#ifdef CONFIG_SDK_RTL9603D
    int32 rtl9603d_l34_table_write(uint32 table, rtk_table_t *pTable, uint32  addr,uint32 *pData);
    int32 rtl9603d_l34_table_read(uint32 table, rtk_table_t *pTable, uint32  addr, uint32 *pData);
    int32 rtl9603d_l2_table_write(uint32 table, rtk_table_t *pTable, uint32  addr,uint32 *pData);
    int32 rtl9603d_l2_table_read(uint32 table, rtk_table_t *pTable, uint32  addr, uint32 *pData);
    int32 rtl9603d_lut_table_write(rtk_table_t *pTable, uint32 addr, uint32 *pData);
    int32 rtl9603d_lut_table_read(rtk_table_t *pTable, uint32 addr, uint32 *pData);
    static int32 rtl9603d_lutStToTblData(rtl9603d_lut_table_t *pL2Table, uint32 *pTblData);
    static int32 rtl9603d_tblDataToLutSt(rtl9603d_lut_table_t *pL2Table, uint32 *pTblData);
    #if defined(CONFIG_SDK_ASICDRV_TEST)
    int32 _rtl9603d_drv_virtualTable_read(
        uint32 table,
        rtk_table_t *pTable,
        uint32  addr,
        uint32  *pData);

    int32 _rtl9603d_drv_virtualTable_write(
        uint32  table,
        rtk_table_t *pTable,
        uint32  addr,
        uint32  *pData);
...
#endif /*#ifdef CONFIG_SDK_RTL9603D*/
    ...
    uint32  *pData)
{
    ...
    switch (table)
    {
        case RTL9603D_VLANt:
            ptr = (uint32 *)&Rtl9607cVirtualVlanTable[addr];
            break;
        case RTL9603D_ACL_ACTION_TABLEt:
            ptr = (uint32 *)&Rtl9607cVirtualAclActTable[addr];
            break;
        case RTL9603D_ACL_DATAt:
            ptr = (uint32 *)&Rtl9607cVirtualAclDataTable[addr];
            break;
        case RTL9603D_ACL_MASKt:
            ptr = (uint32 *)&Rtl9607cVirtualAclMaskTable[addr];
            break;

#if 0  /*RTL9603D remove Classify fateure*/ 
        case RTL9603D_CF_MASK_T0t:
        case RTL9603D_CF_MASK_T1t:
        case RTL9603D_CF_MASK_T2t:
            ptr = (uint32 *)&Rtl9607cVirtualCfMaskTable[addr];
            break;
        case RTL9603D_CF_RULE_T0t:
        case RTL9603D_CF_RULE_T1t:
        case RTL9603D_CF_RULE_T2t:
            ptr = (uint32 *)&Rtl9607cVirtualCfDataTable[addr];
            break;
        case RTL9603D_CF_ACTION_DSt:
            ptr = (uint32 *)&Rtl9607cVirtualCfActDsTable[addr];
            break;
        case RTL9603D_CF_ACTION_USt:
            ptr = (uint32 *)&Rtl9607cVirtualCfActUsTable[addr];
            break;
#endif
        case RTL9603D_L2_MC_DSLt:
        case RTL9603D_L2_UCt:
        case RTL9603D_L3_MCt:
            ptr = (uint32 *)&Rtl9607cVirtualLutTable[addr];
            break;
        default:
            return RT_ERR_INPUT;
...
#if 0   /*RTL9603D remove classify feature*/
        case RTL9603D_CF_MASK_T0t:
        case RTL9603D_CF_MASK_T1t:
        case RTL9603D_CF_MASK_T2t:
            ptr = (uint32 *)&Rtl9607cVirtualCfMaskTable[addr];
...
rtl9603d_init(void)
{
    /* No external phy for RTL9603D */

    return RT_ERR_OK;
} /* end of rtl9603d_init */



static int32 _rtl9603d_l2TableBusy_check(uint32 busyCounter)
{
    uint32      busy;
    int32   ret;
    /*check if table access status*/
    while(busyCounter)
    {
        if ((ret = reg_field_read(RTL9603D_TBL_ACCESS_STSr, RTL9603D_BUSY_FLAGf, &busy)) != RT_ERR_OK)
        {
            return ret;
        }
        if(!busy)
...
static int32 rtl9603d_lutStToTblData(rtl9603d_lut_table_t *pL2Table, uint32 *pTblData)
{
    ...
    /*--- Common part registers configuration ---*/
    /*CVID / CVID_FID*/
    if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_CVIDtf, &pL2Table->cvid_fid, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*L3LOOKUP*/
    if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_L3LOOKUPtf, &pL2Table->l3lookup, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*NOT_SALEARN*/
    if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_NOT_SALEARNtf, &pL2Table->nosalearn, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*IVL_SVL*/
    if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_IVL_SVLtf, &pL2Table->ivl_svl, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*VALID*/
    if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_VALIDtf, &pL2Table->valid, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    ...
    /*--- L2 ---*/
    if (pL2Table->table_type != RTL9603D_RAW_LUT_ENTRY_TYPE_L3MC)
    {
        /*MAC*/
        if ((ret = table_field_mac_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_MACtf, (uint8 *)&pL2Table->mac, pTblData)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return RT_ERR_FAILED;
        }
    ...
    /*(L2 MC DSL)(L3 MC)*/
    if (pL2Table->table_type != RTL9603D_RAW_LUT_ENTRY_TYPE_L2UC)
    {
        /*MBR*/
        if ((ret = table_field_set(RTL9603D_L3_MCt, RTL9603D_L3_MC_MBRtf, &pL2Table->mbr, pTblData)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return RT_ERR_FAILED;
        }
        /*EXT_MBR_IDX*/
        if ((ret = table_field_set(RTL9603D_L3_MCt, RTL9603D_L3_MC_EXT_MBRIDXtf, &pL2Table->ext_mbr_idx, pTblData)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return RT_ERR_FAILED;
        }
    ...
    switch ( pL2Table->table_type )
    {
        case RTL9603D_RAW_LUT_ENTRY_TYPE_L2UC: /*L2 UC*/
            /*FID*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_FIDtf, &pL2Table->fid, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*CTAG_IF*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_CTAG_IFtf, &pL2Table->ctag_if, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*SPA*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_SPAtf, &pL2Table->spa, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*AGE*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_AGEtf, &pL2Table->age, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*SA_BLOCK*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_SA_BLKtf, &pL2Table->sa_block, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*DA_BLOCK*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_DA_BLKtf, &pL2Table->da_block, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*ARP_USED*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_ARP_USAGEtf, &pL2Table->arp_used, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*EXT_SPA*/
            if ((ret = table_field_set(RTL9603D_L2_UCt, RTL9603D_L2_UC_EXT_SPAtf, &pL2Table->ext_spa, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
        ...
        case RTL9603D_RAW_LUT_ENTRY_TYPE_L2MC:
            break;

        case RTL9603D_RAW_LUT_ENTRY_TYPE_L3MC:
            /* ---L3 MC---*/
            /*GIP*/
            if ((ret = table_field_set(RTL9603D_L3_MCt, RTL9603D_L3_MC_GIPtf, &pL2Table->gip, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            ...
            if(hashType != RTL9603D_RAW_IPMC_TYPE_GIP_AND_SIP)
            {
                ...
                {
                    /* VID */
                    if ((ret = table_field_set(RTL9603D_L3_MC_VIDt, RTL9603D_L3_MC_VID_VIDtf, &pL2Table->sip_cvid_fid, pTblData)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                        return RT_ERR_FAILED;
                    }
                ...
                {
                    /* FID */
                    if ((ret = table_field_set(RTL9603D_L3_MC_FIDt, RTL9603D_L3_MC_FID_FIDtf, &pL2Table->sip_cvid_fid, pTblData)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                        return RT_ERR_FAILED;
                    }
            ...
            {
                /* SIP */
                if ((ret = table_field_set(RTL9603D_L3_MCt, RTL9603D_L3_MC_SIPtf, &pL2Table->sip_cvid_fid, pTblData)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                    return RT_ERR_FAILED;
                }
...
static int32 rtl9603d_tblDataToLutSt(rtl9603d_lut_table_t *pL2Table, uint32 *pTblData)
{
    ...
    /*--- Common part registers configuration ---*/
    /*CVID / CVID_FID*/
    if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_CVIDtf, &pL2Table->cvid_fid, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*L3LOOKUP*/
    if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_L3LOOKUPtf, &pL2Table->l3lookup, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*NOT_SALEARN*/
    if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_NOT_SALEARNtf, &pL2Table->nosalearn, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*IVL_SVL*/
    if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_IVL_SVLtf, &pL2Table->ivl_svl, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    /*VALID*/
    if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_VALIDtf, &pL2Table->valid, pTblData)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
        return RT_ERR_FAILED;
    }
    ...
    {
        /*MAC*/
        if ((ret = table_field_mac_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_MACtf, (uint8 *)&pL2Table->mac, pTblData)) != RT_ERR_OK)
        {
             RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return RT_ERR_FAILED;
        }
        if(pL2Table->mac.octet[0]&0x01)
            pL2Table->table_type = RTL9603D_RAW_LUT_ENTRY_TYPE_L2MC;
        else
            pL2Table->table_type = RTL9603D_RAW_LUT_ENTRY_TYPE_L2UC;
    }
    else
    {
        /*L3*/
        pL2Table->table_type = RTL9603D_RAW_LUT_ENTRY_TYPE_L3MC;
    }
    ...
    {
        /*MBR*/
        if ((ret = table_field_get(RTL9603D_L3_MCt, RTL9603D_L3_MC_MBRtf, &pL2Table->mbr, pTblData)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return RT_ERR_FAILED;
        }
        /*EXT_MBRIDX*/
        if ((ret = table_field_get(RTL9603D_L3_MCt, RTL9603D_L3_MC_EXT_MBRIDXtf, &pL2Table->ext_mbr_idx, pTblData)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return RT_ERR_FAILED;
        }
    ...
    switch(pL2Table->table_type)
    {
        case RTL9603D_RAW_LUT_ENTRY_TYPE_L2UC: /*L2 UC*/
            /*FID*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_FIDtf, &pL2Table->fid, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*CTAG_IF*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_CTAG_IFtf, &pL2Table->ctag_if, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*SPA*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_SPAtf, &pL2Table->spa, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*AGE*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_AGEtf, &pL2Table->age, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*SA_BLOCK*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_SA_BLKtf, &pL2Table->sa_block, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*DA_BLOCK*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_DA_BLKtf, &pL2Table->da_block, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*ARP_USED*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_ARP_USAGEtf, &pL2Table->arp_used, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            /*EXT_SPA*/
            if ((ret = table_field_get(RTL9603D_L2_UCt, RTL9603D_L2_UC_EXT_SPAtf, &pL2Table->ext_spa, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
        ...
        case RTL9603D_RAW_LUT_ENTRY_TYPE_L3MC:
            /* ---L3 MC ROUTE---*/
            /*GIP*/
            if ((ret = table_field_get(RTL9603D_L3_MCt, RTL9603D_L3_MC_GIPtf, &pL2Table->gip, pTblData)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                return RT_ERR_FAILED;
            }
            ...
            if(hashType != RTL9603D_RAW_IPMC_TYPE_GIP_AND_SIP)
            {
                ...
                {
                    /* VID */
                    if ((ret = table_field_get(RTL9603D_L3_MC_VIDt, RTL9603D_L3_MC_VID_VIDtf, &pL2Table->sip_cvid_fid, pTblData)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                        return RT_ERR_FAILED;
                    }
                ...
                {
                    /* FID */
                    if ((ret = table_field_get(RTL9603D_L3_MC_FIDt, RTL9603D_L3_MC_FID_FIDtf, &pL2Table->sip_cvid_fid, pTblData)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                        return RT_ERR_FAILED;
                    }
            ...
            {
                /* SIP */
                if ((ret = table_field_get(RTL9603D_L3_MCt, RTL9603D_L3_MC_SIPtf, &pL2Table->sip_cvid_fid, pTblData)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_L2|MOD_DAL), "");
                    return RT_ERR_FAILED;
                }
...
rtl9603d_lut_table_read(
    ...
    uint32  *pData)
{
    rtl9603d_lut_table_t *pLutSt = NULL;
    uint32      tableData[RTL9603D_LUT_TABLE_WORD];

    int32       ret = RT_ERR_FAILED;
    uint32      l2_table_data[RTL9603D_L2_TABLE_WORD];
    uint32      reg_data;
    uint32      cam_or_l2;
    uint32      address;
    uint32      field_data;
    ...
    pLutSt = (rtl9603d_lut_table_t *)pData;
    /*busyCounter = pLutSt->wait_time;*/
    pLutSt->lookup_hit = 0;
    pLutSt->lookup_busy = 1;
    osal_memset(l2_table_data,0,sizeof(l2_table_data));
    osal_memset(tableData,0,sizeof(tableData));
    if((ret = _rtl9603d_l2TableBusy_check(busyCounter))!=RT_ERR_OK)
        return ret;

    rtl9603d_lutStToTblData((rtl9603d_lut_table_t *)pData, tableData);
    /* Read TBL_ACCESS_CTRL register */
    if ((ret = reg_read(RTL9603D_TBL_ACCESS_CTRLr, &reg_data)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    switch (pLutSt->method)
    {
        case RTL9603D_RAW_LUT_READ_METHOD_MAC:
            for (i = 0 ; i < pTable->datareg_num ; i++)
            {
                l2_table_data[pTable->datareg_num-i-1] = tableData[i];
            }
            ...
            for (i = 0 ; i < pTable->datareg_num ; i++)
            {
                if ((ret = reg_array_write(RTL9603D_TBL_ACCESS_WR_DATAr,REG_ARRAY_INDEX_NONE,i,&l2_table_data[i])) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_HWMISC|MOD_DAL), "");
                    return ret;
                }
        ...
        case RTL9603D_RAW_LUT_READ_METHOD_ADDRESS:
        case RTL9603D_RAW_LUT_READ_METHOD_NEXT_ADDRESS:
        case RTL9603D_RAW_LUT_READ_METHOD_NEXT_L2UC:
        case RTL9603D_RAW_LUT_READ_METHOD_NEXT_L2MC:
        case RTL9603D_RAW_LUT_READ_METHOD_NEXT_L3MC:
        case RTL9603D_RAW_LUT_READ_METHOD_NEXT_L2L3MC:
            /*set address*/
            field_data = addr;
            if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_ADDRf, &field_data, &reg_data)) != RT_ERR_OK)
            {
                return ret;
            }
            break;
        case RTL9603D_RAW_LUT_READ_METHOD_NEXT_L2UCSPA:
            /*set address*/
            field_data = addr;
            if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_ADDRf, &field_data, &reg_data)) != RT_ERR_OK)
            {
             ...
             /*set spa*/
            field_data = pLutSt->spa;
            if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_SPAf, &field_data, &reg_data)) != RT_ERR_OK)
            {
                return ret;
            }
            break;
    ...
    /*set access methold */
    field_data = pLutSt->method;
    if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_ACCESS_METHODf, &field_data, &reg_data)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    /*set command type -- 0b0 read*/
    field_data = 0;
    if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_CMD_TYPEf, &field_data, &reg_data)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    /*set table type */
    field_data = pTable->type;
    if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_TBL_TYPEf, &field_data, &reg_data)) != RT_ERR_OK)
    {
        return ret;
    }

    /* Write indirect control register to start the read operation */
    if ((ret = reg_write(RTL9603D_TBL_ACCESS_CTRLr, &reg_data)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    for (i = 0 ; i < pTable->datareg_num ; i++)
    {
        if ((ret = reg_array_read(RTL9603D_TBL_ACCESS_RD_DATAr,REG_ARRAY_INDEX_NONE,i,&l2_table_data[i])) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_HWMISC|MOD_DAL), "");
            return ret;
        }
    ...
    rtl9603d_tblDataToLutSt((rtl9603d_lut_table_t *)pData, tableData);
    pLutSt->lookup_busy = 0;
    if ((ret = reg_field_read(RTL9603D_TBL_ACCESS_STSr, RTL9603D_HIT_STATUSf, &pLutSt->lookup_hit)) != RT_ERR_OK)
    {
        return ret;
    }

    if ((ret = reg_field_read(RTL9603D_TBL_ACCESS_STSr, RTL9603D_TYPEf, &cam_or_l2)) != RT_ERR_OK)
    {
        return ret;
    }

    if ((ret = reg_field_read(RTL9603D_TBL_ACCESS_STSr, RTL9603D_ADDRf, &address)) != RT_ERR_OK)
    {
        return ret;
    }
...
#if defined(CONFIG_SDK_ASICDRV_TEST)
    pLutSt = (rtl9603d_lut_table_t *)pData;
    _rtl9603d_drv_virtualTable_read(RTL9603D_L2_UCt,pTable,addr,tableData);
    rtl9603d_tblDataToLutSt((rtl9603d_lut_table_t *)pData, tableData);
    pLutSt->lookup_hit = 1;
    pLutSt->lookup_busy = 0;
#endif
    ...
    return RT_ERR_OK;
}/* end of rtl9603d_lut_table_read */




/* Function Name:
 *      rtl9603d_lut_table_write
 * Description:
 *      Write one LUT specified table entry by table index or methods.
 * Input:
 *      table - table index
    ...
    uint32  *pData)
{
    ...
    pLutSt = (rtl9603d_lut_table_t *)pData;
    rtl9603d_lutStToTblData((rtl9603d_lut_table_t *)pData, tableData);
    _rtl9603d_drv_virtualTable_write(RTL9603D_L2_UCt,pTable,addr,tableData);
    pLutSt->lookup_hit = 1;
    pLutSt->lookup_busy = 0;
#endif/* defined(CONFIG_SDK_ASICDRV_TEST) */

    return RT_ERR_OK;
}/* end of rtl9603d_lut_table_write */



/* Function Name:
 *      rtl9603d_l2_table_write
 * Description:
 *      Write one L2 specified table entry by table index.
 * Input:
 *      table - table index
    ...
    uint32  *pData)
{
    ...
    /*for ACL and CF data and mask use the same table,but different index*/
    /*ACL MASK*/
    if (table == RTL9603D_ACL_DATAt)
        addr += 128;

/*RTL9603D remove classify faeture*/
#if 0
    else if(table == RTL9603D_CF_RULE_T0t || table == RTL9603D_CF_RULE_T1t || table == RTL9603D_CF_RULE_T2t)
        addr += 256;
#endif
    ...
    if (table == RTL9603D_ACL_DATAt)
        addr -= 128;
#if 0 /*RTL9603D remove claffify feature*/
    else if(table == RTL9603D_CF_RULE_T0t || table == RTL9603D_CF_RULE_T1t || table == RTL9603D_CF_RULE_T2t)
        addr -= 256;
#endif
    _rtl9603d_drv_virtualTable_write(table,pTable,addr,pData);
#endif/* defined(CONFIG_SDK_ASICDRV_TEST) */


    return RT_ERR_OK;
}/* end of rtl9603d_l2_table_write */

/* Function Name:
 *      rtl9603d_l2_table_read
 * Description:
 *      Read one L2 specified table entry by table index.
 * Input:
 *      table - table index
    ...
    uint32  *pData)
{
...
#if 0 /*RTL9603D remove classify featire*/
    else if(table == RTL9603D_CF_RULE_T0t || table == RTL9603D_CF_RULE_T1t || table == RTL9603D_CF_RULE_T2t)
        addr += 256;
#endif
    if((ret = _rtl9603d_l2TableBusy_check(busyCounter))!=RT_ERR_OK)
    ...
    if (table == RTL9603D_ACL_DATAt)
        ...
        addr -= 256;
#endif
    _rtl9603d_drv_virtualTable_read(table,pTable,addr,pData);
#endif

    return RT_ERR_OK;
}/* end of rtl9603d_l2_table_read */

/* Function Name:
 *      rtl9603d_table_clear
 * Description:
 *      clear L2 specified table entry by table index range.
 * Input:
 *      table - table index
    ...
    uint32  endIdx)
{
    ...
    switch(table)
    {
        ...
        case RTL9603D_L2_MC_DSLt:
        case RTL9603D_L3_MCt:
        case RTL9603D_L3_MC_VIDt:
        case RTL9603D_L3_MC_FIDt:
            break;
        default:
            return RT_ERR_INPUT;
            break;
    ...
    for(addr = startAddr; addr<=endAddr; addr++)
    {
        _rtl9603d_drv_virtualTable_write(table,pTable,addr,l2_table_data);
    }
    ...
    if ((ret = reg_read(RTL9603D_TBL_ACCESS_CTRLr, &regData)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    /*set table type*/
    fieldData =pTable->type;
    if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_TBL_TYPEf, &fieldData, &regData)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    /*set command type -- 0b10 reset*/
    fieldData = 2;
    if ((ret = reg_field_set(RTL9603D_TBL_ACCESS_CTRLr, RTL9603D_CMD_TYPEf, &fieldData, &regData)) != RT_ERR_OK)
    {
        return ret;
    }

    /* Write indirect control register to start the write operation */
    if ((ret = reg_write(RTL9603D_TBL_ACCESS_CTRLr, &regData)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    return RT_ERR_OK;
}/* end of rtl9603d_l2_table_clear */
    ...
    uint32  *pData)
{
    ...
    switch(table)
    {
        ...
        case RTL9603D_L3_MC_VIDt:
        case RTL9603D_L3_MC_FIDt:
            return rtl9603d_lut_table_write(pTable, addr, pData);
...
#endif            
        case RTL9603D_VLANt:
            return rtl9603d_l2_table_write(table, pTable, addr, pData);
            break;
...
{
    rtk_table_t *pTable = NULL;
    RT_DBG(LOG_DEBUG, (MOD_HAL), "rtl9603d_table_read table=%d, addr=0x%x", table, addr);
    /* parameter check */
    RT_PARAM_CHK((table >= HAL_GET_MAX_TABLE_IDX()), RT_ERR_OUT_OF_RANGE);
    RT_PARAM_CHK((NULL == pData), RT_ERR_NULL_POINTER);
    ...
    switch(table)
    {
        ...
        case RTL9603D_L3_MC_VIDt:
        case RTL9603D_L3_MC_FIDt:
            return rtl9603d_lut_table_read(pTable ,addr ,pData);
            break;
...
#endif
        case RTL9603D_VLANt:
            return rtl9603d_l2_table_read(table, pTable ,addr ,pData);
            break;
        default:
            return RT_ERR_INPUT;
            break;
    ...
    uint16      *pData)
{
     ...
     */
    fieldData = (phyID << 16) | (ocpAddr & 0xffff);
    if ((ret = reg_field_set(RTL9603D_GPHY_IND_CMDr, RTL9603D_ADRf, &fieldData, &regData)) != RT_ERR_OK)
    {
        return ret;
    }
    /*set CMD to read*/
    fieldData = 0;
    if ((ret = reg_field_set(RTL9603D_GPHY_IND_CMDr, RTL9603D_WRENf, &fieldData, &regData)) != RT_ERR_OK)
    {
        return ret;
    }
    /*set CMD enable*/
    fieldData = 1;
    if ((ret = reg_field_set(RTL9603D_GPHY_IND_CMDr, RTL9603D_CMD_ENf, &fieldData, &regData)) != RT_ERR_OK)
    {
        return ret;
    }
    /*write to register*/
    if ((ret = reg_write(RTL9603D_GPHY_IND_CMDr, &regData)) != RT_ERR_OK)
    {
        return ret;
    }
    /* Wait operation completed */
    do
    {
        if ((ret = reg_field_read(RTL9603D_GPHY_IND_RDr, RTL9603D_BUSYf, &busy)) != RT_ERR_OK)
        {
            return ret;
        }
        waitCnt --;
    ...
    /* Read data register */
    if ((ret = reg_field_read(RTL9603D_GPHY_IND_RDr, RTL9603D_RD_DATf ,&fieldData)) != RT_ERR_OK)
    {
        return ret;
    }
    ...
    uint16      data)
{
    ...
    /*write data to write buffer*/
    fieldData = data;
    if ((ret = reg_field_write(RTL9603D_GPHY_IND_WDr, RTL9603D_WR_DATf ,&fieldData)) != RT_ERR_OK)
    {
        return ret;
    }
    /* set phy id and ocp address
    ...
    uint32      *pData)
{
    ...
    if ((ret = rtl9603d_ocpInterPhy_read(phyid, ocpAddr, &data)) != RT_ERR_OK)
    {
        return ret;
    }
#else
    ...
    uint32      data)
{
    ...
    if ((ret = rtl9603d_ocpInterPhy_write(phyid, ocpAddr, (uint16)data)) != RT_ERR_OK)
    {
        return ret;
    }
#else
