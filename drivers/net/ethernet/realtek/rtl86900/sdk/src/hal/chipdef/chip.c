...
#include <hal/chipdef/rtl9603d/rtl9603d_def.h>
#endif
...
static rt_portinfo_t ca8279_port_info =
{
    ...
    {
        RT_GE_PORT    /*P0 */, RT_GE_PORT    /*P1 */, RT_GE_PORT   /*P2 */, RT_GE_PORT    /*P3 */, RT_GE_PORT     /*P4 */,
        RT_PORT_NONE  /*P5 */, RT_XE_PORT    /*P6 */, RT_XE_PORT   /*P7 */, RT_PORT_NONE  /*P8 */, RT_PORT_NONE   /*P9 */,
        RT_PORT_NONE  /*P10*/, RT_PORT_NONE  /*P11*/, RT_PORT_NONE /*P12*/, RT_PORT_NONE  /*P13*/, RT_PORT_NONE   /*P14*/,
        RT_PORT_NONE  /*P15*/, RT_CPU_PORT   /*P16*/, RT_CPU_PORT  /*P17*/, RT_CPU_PORT   /*P18*/, RT_CPU_PORT    /*P19*/,
        RT_CPU_PORT   /*P20*/, RT_CPU_PORT   /*P21*/, RT_CPU_PORT  /*P22*/, RT_CPU_PORT   /*P23*/, RT_PORT_NONE   /*P24*/,
        RT_PORT_NONE  /*P25*/, RT_PORT_NONE  /*P26*/, RT_PORT_NONE /*P27*/, RT_PORT_NONE  /*P28*/, RT_PORT_NONE   /*P29*/,
...
#if defined(CONFIG_SDK_RTL9603D)
static rt_portinfo_t rtl9603d_port_info =
{
    /* Normal RTL9603D Chip Port Information */
    {
     ...
     .rgmiiPort = -1,
     .swPboLbPort = 6
}; /* end of rtl9603d_port_info */

/*
RTL9603D port mapping
...
/* Normal RTL9603D Chip Port Information */
static rt_register_capacity_t rtl9603d_capacityInfo =
{
    .max_num_of_mirror                  = RTL9603D_MAX_NUM_OF_MIRROR               ,
    .max_num_of_trunk                   = RTL9603D_MAX_NUM_OF_TRUNK                ,
    .max_num_of_trunkMember             = RTL9603D_MAX_NUM_OF_TRUNKMEMBER          ,
    .max_num_of_dumb_trunkMember        = RTL9603D_MAX_NUM_OF_DUMB_TRUNKMEMBER     ,
    .max_num_of_trunkHashVal            = RTL9603D_MAX_NUM_OF_TRUNKHASHVAL         ,
    .max_num_of_msti                    = RTL9603D_MAX_NUM_OF_MSTI                 ,
    .max_num_of_metering                = RTL9603D_MAX_NUM_OF_METERING             ,
    .max_num_of_field_selector          = RTL9603D_MAX_NUM_OF_FIELD_SELECTOR       ,
    .max_num_of_range_check_srcPort     = RTL9603D_MAX_NUM_OF_RANGE_CHECK_SRCPORT  ,
    .max_num_of_range_check_ip          = RTL9603D_MAX_NUM_OF_RANGE_CHECK_IP       ,
    .max_num_of_range_check_vid         = RTL9603D_MAX_NUM_OF_RANGE_CHECK_VID      ,
    .max_num_of_range_check_pktLen      = RTL9603D_MAX_NUM_OF_RANGE_CHECK_PKTLEN   ,
    .max_num_of_range_check_l4Port      = RTL9603D_MAX_NUM_OF_RANGE_CHECK_L4PORT   ,
    .max_num_of_pattern_match_data      = RTL9603D_MAX_NUM_OF_PATTERN_MATCH_DATA   ,
    .pattern_match_port_max             = RTL9603D_PATTERN_MATCH_PORT_MAX          ,
    .pattern_match_port_min             = RTL9603D_PATTERN_MATCH_PORT_MIN          ,
    .max_num_of_l2_hashdepth            = RTL9603D_MAX_NUM_OF_L2_HASHDEPTH         ,
    .max_num_of_queue                   = RTL9603D_MAX_NUM_OF_QUEUE                ,
    .min_num_of_queue                   = RTL9603D_MIN_NUM_OF_QUEUE                ,
    .max_num_of_pon_queue               = RTL9603D_MAX_NUM_OF_PON_QUEUE            ,
    .min_num_of_pon_queue               = RTL9603D_MIN_NUM_OF_PON_QUEUE            ,
    .max_num_of_cvlan_tpid              = RTL9603D_MAX_NUM_OF_CVLAN_TPID           ,
    .max_num_of_svlan_tpid              = RTL9603D_MAX_NUM_OF_SVLAN_TPID           ,
    .tpid_entry_idx_max                 = RTL9603D_TPID_ENTRY_IDX_MAX              ,
    .tpid_entry_mask_max                = RTL9603D_TPID_ENTRY_MASK_MAX             ,
    .protocol_vlan_idx_max              = RTL9603D_PROTOCOL_VLAN_IDX_MAX           ,
    .max_num_vlan_mbrcfg                = RTL9603D_MAX_NUM_VLAN_MBRCFG             ,
    .vlan_fid_max                       = RTL9603D_VLAN_FID_MAX                    ,
    .flowctrl_thresh_max                = RTL9603D_FLOWCTRL_THRESH_MAX             ,
    .flowctrl_pauseOn_page_packet_max   = RTL9603D_FLOWCTRL_PAUSEON_PAGE_PACKET_MAX,
    .pri_of_selection_max               = RTL9603D_PRI_OF_SELECTION_MAX            ,
    .pri_of_selection_min               = RTL9603D_PRI_OF_SELECTION_MIN            ,
    .pri_sel_group_index_max            = RTL9603D_PRI_SEL_GROUP_INDEX_MAX         ,
    .pri_sel_weight_max                 = RTL9603D_PRI_SEL_WEIGHT_MAX              ,
    .queue_weight_max                   = RTL9603D_QUEUE_WEIGHT_MAX                ,
    .qid0_weight_max                    = RTL9603D_QID0_WEIGHT_MAX                 ,
    .rate_of_bandwidth_max              = RTL9603D_RATE_OF_BANDWIDTH_MAX           ,
    .thresh_of_igr_bw_flowctrl_max      = RTL9603D_THRESH_OF_IGR_BW_FLOWCTRL_MAX   ,
    .max_num_of_fastPath_of_rate        = RTL9603D_MAX_NUM_OF_FASTPATH_OF_RATE     ,
    .rate_of_storm_control_max          = RTL9603D_RATE_OF_STORM_CONTROL_MAX       ,
    .burst_rate_of_storm_control_max    = RTL9603D_BURST_RATE_OF_STORM_CONTROL_MAX ,
    .internal_priority_max              = RTL9603D_INTERNAL_PRIORITY_MAX           ,
    .drop_precedence_max                = RTL9603D_DROP_PRECEDENCE_MAX             ,
    .priority_remap_group_idx_max       = RTL9603D_PRIORITY_REMAP_GROUP_IDX_MAX    ,
    .priority_remark_group_idx_max      = RTL9603D_PRIORITY_REMARK_GROUP_IDX_MAX   ,
    .priority_to_queue_group_idx_max    = RTL9603D_PRIORITY_TO_QUEUE_GROUP_IDX_MAX ,
    .wred_weight_max                    = RTL9603D_WRED_WEIGHT_MAX                 ,
    .wred_mpd_max                       = RTL9603D_WRED_MPD_MAX                    ,
    .acl_rate_max                       = RTL9603D_ACL_RATE_MAX                    ,
    .l2_learn_limit_cnt_max             = RTL9603D_L2_LEARN_LIMIT_CNT_MAX          ,
    .l2_learn_lut_4way_no               = RTL9603D_L2_LEARN_4WAY_NO                ,
    .l2_aging_time_max                  = RTL9603D_L2_AGING_TIME_MAX               ,
    .l2_entry_aging_max                 = RTL9603D_L2_ENTRY_AGING_MAX              ,
    .eee_queue_thresh_max               = RTL9603D_EEE_QUEUE_THRESH_MAX            ,
    .sec_minIpv6FragLen_max             = RTL9603D_SEC_MINIPV6FRAGLEN_MAX          ,
    .sec_maxPingLen_max                 = RTL9603D_SEC_MAXPINGLEN_MAX              ,
    .sec_smurfNetmaskLen_max            = RTL9603D_SEC_SMURFNETMASKLEN_MAX         ,
    .sflow_rate_max                     = RTL9603D_SFLOW_RATE_MAX                  ,
    .max_num_of_mcast_fwd               = RTL9603D_MAX_NUM_OF_MCAST_FWD            ,
    .miim_page_id_min                   = RTL9603D_MIIM_PAGE_ID_MIN                ,
    .miim_page_id_max                   = RTL9603D_MIIM_PAGE_ID_MAX                ,
    .miim_reg_id_max                    = RTL9603D_MIIM_REG_ID_MAX                 ,
    .miim_data_max                      = RTL9603D_MIIM_DATA_MAX                   ,
    .l34_netif_table_max                = RTL9603D_L34_NETIF_TABLE_MAX             ,
    .l34_arp_table_max                  = RTL9603D_L34_ARP_TABLE_MAX               ,
    .l34_extip_table_max                = RTL9603D_L34_EXTIP_TABLE_MAX             ,
    .l34_routing_table_max              = RTL9603D_L34_ROUTING_TABLE_MAX           ,
    .l34_napt_table_max                 = RTL9603D_L34_NAPT_TABLE_MAX              ,
    .l34_naptr_table_max                = RTL9603D_L34_NAPTR_TABLE_MAX             ,
    .l34_nh_table_max                   = RTL9603D_L34_NH_TABLE_MAX                ,
    .l34_pppoe_table_max                = RTL9603D_L34_PPPOE_TABLE_MAX             ,
    .l34_ipv6_routing_table_max         = RTL9603D_L34_IPV6_ROUTING_TABLE_MAX      ,
    .l34_ipv6_neighbor_table_max        = RTL9603D_L34_IPV6_NBR_TABLE_MAX          ,
    .l34_binding_table_max	            = RTL9603D_L34_BINDING_TABLE_MAX           ,
    .l34_wan_type_table_max	            = RTL9603D_L34_WAN_TYPE_TABLE_MAX          ,
    .l34_flow_route_table_max	        = RTL9603D_L34_FLOW_ROUTE_TABLE_MAX        ,
    .l34_dslite_table_max               = RTL9603D_L34_DSLITE_INF_TABLE_MAX        ,
    .l34_dslite_mc_table_max            = RTL9603D_L34_DSLITE_MCAST_TABLE_MAX      ,
    .l34_ipmc_tran_table_max            = RTL9603D_L34_IPMC_TRAN_TABLE_MAX         ,
    .gpon_tcont_max                     = RTL9603D_GPON_TCONT_MAX                  ,
    .gpon_flow_max                      = RTL9603D_GPON_FLOW_MAX                   ,
    .classify_entry_max                 = RTL9603D_CLASSIFY_ENTRY_MAX              ,
    .classify_sid_max                   = RTL9603D_CLASSIFY_SID_MAX                ,
    .classify_l4port_range_mum          = RTL9603D_CLASSIFY_L4PORT_RANGE_NUM       ,
    .classify_ip_range_mum              = RTL9603D_CLASSIFY_IP_RANGE_NUM           ,
    .max_num_of_acl_template            = RTL9603D_MAX_NUM_OF_ACL_TEMPLATE         ,
    .max_num_of_acl_rule_field          = RTL9603D_MAX_NUM_OF_ACL_RULE_FIELD       ,
    .max_num_of_acl_action              = RTL9603D_MAX_NUM_OF_ACL_ACTION           ,
    .max_num_of_acl_rule_entry          = RTL9603D_MAX_NUM_OF_ACL_RULE_ENTRY       ,
    .max_special_congest_second         = RTL9603D_MAX_SPECIAL_CONGEST_SEC         ,
    .max_enhanced_fid                   = RTL9603D_MAX_ENHANCED_FID                ,
    .max_num_of_log_mib                 = RTL9603D_MAX_NUM_OF_LOG_MIB              ,
	.max_num_of_host 					= RTL9603D_MAX_NUM_OF_HOST			   ,
    .ext_cpu_port_id                    = RTL9603D_EXT_CPU_PORT_ID                 ,
    .ponmac_tcont_queue_max             = RTL9603D_PONMAC_TCONT_QUEUE_MAX            ,
    .ponmac_pir_cir_rate_max            = RTL9603D_PONMAC_PIR_CIR_RATE_MAX           ,
    .max_mib_latch_timer                = RTL9603D_MAX_MIB_LATCH_TIMER             ,
    .max_num_of_nexthop               	= RTL9603D_MAX_NUM_OF_NEXTHOP			   ,
    .max_rgmii_tx_delay                 = RTL9603D_MAX_RGMII_TX_DELAY              ,
    .max_rgmii_rx_delay                 = RTL9603D_MAX_RGMII_RX_DELAY              ,
    .max_llid_entry                     = RTL9603D_MAX_LLID_ENTRY              ,

};



/* Normal RTL9603D Chip PER_PORT block information */
static rt_macPpInfo_t rtl9603d_macPpInfo =
{
    0x20000, /* lowerbound_addr */
    0x203FF, /* upperbound_addr */
    0x100,  /* interval */
};
#endif /* End of #if defined(CONFIG_SDK_RTL9603D) */
