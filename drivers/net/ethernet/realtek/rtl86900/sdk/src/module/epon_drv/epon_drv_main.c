...
#if !defined(CONFIG_RTK_L34_ENABLE) && (defined(CONFIG_RTL9607C_SERIES) || defined(CONFIG_RTL9602C_SERIES))
        ...
        *((unsigned char *)(skb->data + (skb->len - sizeof(chLlidIdx)))) = chLlidIdx;
        ...
        {    
            ...
            if ((ret = reg_field_write(RTL9607C_EPON_ASIC_OPTI1r,RTL9607C_STOP_SYNCf,&data)) != RT_ERR_OK)
            {
                ...
                break;
            case RTL9603D_CHIP_ID:
            #if defined(CONFIG_RTL9603D_SERIES)
            data = 1;
...
#if defined(CONFIG_RTK_OAM_V1) && !defined(CONFIG_RTK_L34_ENABLE)
