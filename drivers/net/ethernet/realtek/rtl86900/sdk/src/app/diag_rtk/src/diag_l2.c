 ...
 *
 * $Revision: 86481 $
 * $Date: 2018-03-08 14:41:43 +0800 (Thu, 08 Mar 2018) $
 *
...
#if defined(CONFIG_SDK_RTL9603D)
static void
_diag_rtl9603d_lutDisplay(rtk_l2_addr_table_t *diag_lut, uint32 displayAddr)
{
    int ret;
    uint32 type;
    uint8 strDip[64];
...
_display_ipMcast_entry(rtk_l2_ipMcastAddr_t *pEntry)
{
...
#if defined(CONFIG_SDK_RTL9602C) || defined(CONFIG_SDK_RTL9607C) || defined(CONFIG_SDK_RTL9603D) 
    ...
    case RTL9603D_CHIP_ID:
        lut_entry.entryType = RTK_LUT_L3MC;
        lut_entry.entry.ipmcEntry = *pEntry;
        _diag_rtl9603d_lutDisplay(&lut_entry, DISABLED);
        break;
#endif
    ...
    cparser_context_t *context)
{
    ...
    case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_LUT_CFGr, RTL9603D_LUT_ENTRY_FULL_ACTf, &value), ret);
    ...
    cparser_context_t *context)
{
    ...
    case RTL9603D_CHIP_ID:
        ...
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_LUT_CFGr, RTL9603D_LUT_ENTRY_FULL_ACTf, &value), ret);
        break;
#endif    
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
        {
            rtl9603d_l2_resAct_t act;
            DIAG_UTIL_ERR_CHK(rtl9603d_l2_unknReservedIpv4McAction_get(&act), ret);
            diag_util_printf("\n Unknown reserved IPv4 multicast action: %s", diagStr_l2unknownMcAct[act]);
            DIAG_UTIL_ERR_CHK(rtl9603d_l2_unknReservedIpv6McAction_get(&act), ret);
            diag_util_printf("\n Unknown reserved IPv6 multicast action: %s", diagStr_l2unknownMcAct[act]);
            break;
        }
#endif
...
#if defined(CONFIG_SDK_RTL9603D)
    case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_LUT_CFGr, RTL9603D_LUT_L2UC_ACTf, &action), ret);
        break;
#endif
    default:
        diag_util_printf("%s\n", DIAG_STR_NOTSUPPORT);
...
#if defined(CONFIG_SDK_RTL9603D)
    case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_LUT_CFGr, RTL9603D_LUT_L2UC_ACTf, &action), ret);
        break;
#endif
    default:
        diag_util_printf("%s\n", DIAG_STR_NOTSUPPORT);
...
#if defined(CONFIG_SDK_RTL9603D)
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_array_field_read(RTL9603D_LUT_WAN_ENr, port, REG_ARRAY_INDEX_NONE, RTL9603D_ENf, &value), ret);
            if( 1 == value)
            {
                lPortMask.bits[0] |= (1 << port);
            }
...
#if defined(CONFIG_SDK_RTL9603D)
                case RTL9603D_CHIP_ID:
                    DIAG_UTIL_ERR_CHK(reg_array_field_write(RTL9603D_LUT_WAN_ENr, port, REG_ARRAY_INDEX_NONE, RTL9603D_ENf, &value), ret);
                    break;
#endif
                default:
                    diag_util_printf("%s\n", DIAG_STR_NOTSUPPORT);
    ...
    char * *ports_ptr)
{
	...
	switch(DIAG_UTIL_CHIP_TYPE)
	{
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_PORTMASK_SCAN(portlist, port)
            {
                DIAG_UTIL_ERR_CHK(reg_array_field_write(RTL9603D_LUT_UNMATCHED_SA_CTRLr, port, REG_ARRAY_INDEX_NONE, RTL9603D_ACTf, &action), ret);
            }
...
#if defined(CONFIG_SDK_RTL9603D)
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(rtl9603d_raw_l2_flushCtrl_get(&rtl9603d_cfg), ret);

            rtl9603d_cfg.flushType = RTL9603D_RAW_FLUSH_TYPE_DYNAMIC;

            DIAG_UTIL_ERR_CHK(rtl9603d_raw_l2_flushCtrl_set(&rtl9603d_cfg), ret);
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            rtl9603d_cfg.flushType = RTL9603D_RAW_FLUSH_TYPE_BOTH;
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            rtl9603d_cfg.flushType = RTL9603D_RAW_FLUSH_TYPE_STATIC;
    ...
    uint32_t  *address_ptr)
{
...
#endif
#if defined(CONFIG_SDK_RTL9601B) || defined(CONFIG_SDK_RTL9602C) || defined(CONFIG_SDK_RTL9607C) || defined(CONFIG_SDK_RTL9603D)
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            _diag_rtl9603d_lutDisplay(&l2table, ENABLED);
        break;
#endif
        default:
            diag_util_printf("%s\n", DIAG_STR_NOTSUPPORT);
    ...
    cparser_context_t *context)
{
    ...
    case RTL9603D_CHIP_ID:
        ...
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_LUT_CFGr, RTL9603D_LUT_L34_ARP_USAGE_AS_KNOWNf, &value), ret);
        break;
#endif    
	default:
		diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9603D
    case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_LUT_CFGr, RTL9603D_LUT_L34_ARP_USAGE_AS_KNOWNf, &value), ret);
