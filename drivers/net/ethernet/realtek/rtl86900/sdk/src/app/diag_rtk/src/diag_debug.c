 ...
 *
 * $Revision: 90170 $
 * $Date: 2018-07-06 14:52:53 +0800 (Fri, 06 Jul 2018) $
 *
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            mode = 1; /*none*/
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_MODEf, &mode), ret);
            mode = 3; /*first-pass*/
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_MODEf, &mode), ret);

            if(!osal_strcmp(TOKEN_STR(2),"hsb"))
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_hsbData_get(&hsbData), ret);
				DIAG_UTIL_ERR_CHK(rtl9603d_hsbPar_get(&hsbData), ret);
            ...
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_hsaData_get(&hsaData), ret);
                _diag_debug_hsa_display(&hsaData);
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
			...
			{
				DIAG_UTIL_ERR_CHK(rtl9603d_hsdData_get(&hsdData), ret);
				_diag_debug_hsd_display(&hsdData);
			}
			else if(!osal_strcmp(TOKEN_STR(2),"fb"))
			{
				DIAG_UTIL_ERR_CHK(rtl9603d_fbData_get(&hsaData), ret);
				 _diag_debug_hsa_display(&hsaData);
			}							
			break;
#endif
...
#ifdef CONFIG_SDK_RTL9603D
void _rtl9603d_fpga_debug_phy_write(uint16 phy,uint16 reg,uint16 data)
{
    uint16 inputData;
...
static int32 _diag_debug_rtl9603d_fpga_init(void)
{
#if defined(FPGA_DEFINED)
    int32 ret;
    unsigned int value;
    ...
    /* Remove Giga ability */
    _rtl9603d_fpga_debug_phy_write(0, 4, 0x5e1);
    _rtl9603d_fpga_debug_phy_write(0, 9, 0x0);
    _rtl9603d_fpga_debug_phy_write(0, 0, 0x1200);
    _rtl9603d_fpga_debug_phy_write(1, 4, 0x5e1);
    _rtl9603d_fpga_debug_phy_write(1, 9, 0x0);
    _rtl9603d_fpga_debug_phy_write(1, 0, 0x1200);
    _rtl9603d_fpga_debug_phy_write(2, 4, 0x5e1);
    _rtl9603d_fpga_debug_phy_write(2, 9, 0x0);
    _rtl9603d_fpga_debug_phy_write(2, 0, 0x1200);
    _rtl9603d_fpga_debug_phy_write(3, 4, 0x5e1);
    _rtl9603d_fpga_debug_phy_write(3, 9, 0x200);
    _rtl9603d_fpga_debug_phy_write(3, 0, 0x1240);
    _rtl9603d_fpga_debug_phy_write(4, 4, 0x5e1);
    _rtl9603d_fpga_debug_phy_write(4, 9, 0x200);
    _rtl9603d_fpga_debug_phy_write(4, 0, 0x1240);
    _rtl9603d_fpga_debug_phy_write(5, 4, 0x5e1);
    _rtl9603d_fpga_debug_phy_write(5, 9, 0x200);
    _rtl9603d_fpga_debug_phy_write(5, 0, 0x1240);

    /* Disable EEE */
    _rtl9603d_fpga_debug_phy_write(0, 31, 0xa43);
    _rtl9603d_fpga_debug_phy_write(0, 25, 0x843);
    _rtl9603d_fpga_debug_phy_write(1, 31, 0xa43);
    _rtl9603d_fpga_debug_phy_write(1, 25, 0x843);
    _rtl9603d_fpga_debug_phy_write(2, 31, 0xa43);
    _rtl9603d_fpga_debug_phy_write(2, 25, 0x843);
    _rtl9603d_fpga_debug_phy_write(3, 31, 0xa43);
    _rtl9603d_fpga_debug_phy_write(3, 25, 0x843);
    _rtl9603d_fpga_debug_phy_write(4, 31, 0xa43);
    _rtl9603d_fpga_debug_phy_write(4, 25, 0x843);
    _rtl9603d_fpga_debug_phy_write(5, 31, 0xa43);
    _rtl9603d_fpga_debug_phy_write(5, 25, 0x843);

    /* Giga reverset */
    _rtl9603d_fpga_debug_phy_write(3, 31, 0x0d08);
    _rtl9603d_fpga_debug_phy_write(3, 21, 0x18);
    _rtl9603d_fpga_debug_phy_write(3, 31, 0x0000);
    _rtl9603d_fpga_debug_phy_write(4, 31, 0x0d08);
    _rtl9603d_fpga_debug_phy_write(4, 21, 0x18);
    _rtl9603d_fpga_debug_phy_write(4, 31, 0x0000);
    _rtl9603d_fpga_debug_phy_write(5, 31, 0x0d08);
    _rtl9603d_fpga_debug_phy_write(5, 21, 0x18);
    _rtl9603d_fpga_debug_phy_write(5, 31, 0x0000);
    ...
    /* Disable CPU tag aware for all GMACs*/
    value = 0;
    DIAG_UTIL_ERR_CHK(reg_write(RTL9603D_CPU_TAG_AWARE_CTRLr, &value), ret);
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(_diag_debug_rtl9603d_fpga_init(), ret);
            break;
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);
    ...
    cparser_context_t *context)
{
...
#elif FORCE_PROBE_RTL9603D
    diag_util_mprintf("Chip probe setting: Force RTL9603D\n");
#else
...
#if defined(CONFIG_SDK_APOLLOMP) || defined(CONFIG_SDK_APOLLO) || defined(CONFIG_SDK_RTL9602C) || defined(CONFIG_SDK_RTL9607C) || defined(CONFIG_SDK_RTL9603D)
    ...
    for(i = 0; i < total_entry; i++)
    {
        ...
        reg_field_read(rgf_ver_reg[0], RTL9607C_REGFILE_VERf, &rtl_version);
        //diag_util_printf("%-22s: 0x%08x\n",rgf_ver_str[0], rtl_version);
        ...
        for(i = 0; i < total_entry; i++)
        {
            reg_field_read(rgf_ver_reg[i], RTL9607C_REGFILE_VERf, &sw_version);
        
            if((rtl_version != sw_version))
                diag_util_printf("Mismatch, %-22s: 0x%08x (%-22s: 0x%08x)\n",rgf_ver_str[i],sw_version,rgf_ver_str[0], rtl_version);
        }
#endif

#if defined(CONFIG_SDK_RTL9603D)
        
        reg_field_read(rgf_ver_reg[0], RTL9603D_REGFILE_VERf, &rtl_version);
        //diag_util_printf("%-22s: 0x%08x\n",rgf_ver_str[0], rtl_version);
        ...
        for(i = 0; i < total_entry; i++)
        {
            reg_field_read(rgf_ver_reg[i], RTL9603D_REGFILE_VERf, &sw_version);
    ...
    uint32_t *value_ptr)
{
    ...
    cpuTag.txmask_vidx = *value_ptr & 0b111111;
...
cparser_cmd_debug_packet_tx_set_cputag_gmac_num(
    ...
    uint32_t  *num_ptr)
{
#if defined(CONFIG_LINUX_USER_SHELL) && defined(CONFIG_SOC_DEPEND_FEATURE) && (defined(CONFIG_SDK_RTL9607C) || defined(CONFIG_SDK_RTL9603D))  
    int32 ret;
    struct pkt_dbg_cputag cpuTag;
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_MODEf, &latchNoneValue), ret);
           
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_MODEf, &value), ret);
            break;
#endif
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_HSB_CTRLr,RTL9603D_VALIDf, &value), ret);
        diag_util_mprintf("Valid: %d\n",value);
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_EGR_PMSKf, &portlist.portmask.bits[0]), ret);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_IGR_PMSKf, &portlist.portmask.bits[0]), ret);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_IGR_PBOf, &state), ret);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    ...
    uint32_t  *reason_ptr)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CTRLr,RTL9603D_LATCH_HSA_REASONf, reason_ptr), ret);
            return CPARSER_NOT_OK;
        break;
#endif
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_FBHSA_CTRLr,RTL9603D_LATCH_FB_EGR_PMSKf, &portlist.portmask.bits[0]), ret);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_FBHSA_CTRLr,RTL9603D_LATCH_FB_IGR_PMSKf, &portlist.portmask.bits[0]), ret);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    ...
    uint32_t  *reason_ptr)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_FBHSA_CTRLr,RTL9603D_LATCH_FB_HSA_REASONf, reason_ptr), ret);
            return CPARSER_NOT_OK;
        break;
#endif
        default:
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_FBHSA_CTRLr,RTL9603D_LATCH_FB_MODEf, &value), ret);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSD_CFGr,RTL9603D_LATCH_MODEf, &value), ret);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    ...
    uint32_t  *port_ptr)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSD_CFGr,RTL9603D_LATCH_EGR_PORTf, port_ptr), ret);
            return CPARSER_NOT_OK;
            break;
#endif
        default:
    ...
    uint32_t  *port_ptr)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSD_CFGr,RTL9603D_LATCH_IGR_PORTf, port_ptr), ret);
            return CPARSER_NOT_OK;
            break;
#endif
        default:
    ...
    uint32_t  *reason_ptr)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSD_CFGr,RTL9603D_LATCH_HSD_REASONf, reason_ptr), ret);
            return CPARSER_NOT_OK;
            break;
#endif
        default:
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_HSB_CFGr,RTL9603D_INVALID_IP_TYPE_ACTf, &value), ret);
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_HSB_CFGr,RTL9603D_INVALID_IP_TYPE_ACTf, &value), ret);
            diag_util_mprintf("%s\n",(0==value)? DIAG_STR_FORWARD : DIAG_STR_TRAP2CPU);
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_CFG_L2TP_SPORTr,RTL9603D_CFG_L2TP_UDP_SPORTf, &value), ret);
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            ...
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_CFG_L2TP_SPORTr,RTL9603D_CFG_L2TP_UDP_SPORTf, &value), ret);
            diag_util_mprintf("UDP Source Port: %d\n", value);
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            if('a'==TOKEN_CHAR(2,0))
            {
                field   = RTL9603D_CFG_SFT_RSB_ANAf;
            }
            else if ('g'==TOKEN_CHAR(2,0))
            {
                field   = RTL9603D_CFG_SFT_RSTB_GPONf;
            }
            else if ('e'==TOKEN_CHAR(2,0))
            {
                field   = RTL9603D_CFG_SFT_RSTB_EPONf;
            }
            else if ('w'==TOKEN_CHAR(2,0))
            {
                field   = RTL9603D_CFG_SFT_RSTBf;
            }
            data=0;
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_WSDS_DIG_00r,field,&data), ret);
            data=1;
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_WSDS_DIG_00r,field,&data), ret);
    ...
    uint32_t *phyid_ptr)
{
    ...
    rtk_mdio_init();
    rtk_mdio_cfg_set(*set_ptr,*port_ptr,*phyid_ptr,MDIO_FMT_C22);
#else
    diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    return RT_ERR_FAILED;
#endif
...
{
#if defined(CONFIG_SDK_RTL9607C)
    rtk_mdio_c22_write(*reg_ptr,*value_ptr);
#else
    diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    return RT_ERR_FAILED;
#endif
...
#if defined(CONFIG_SDK_RTL9607C)
    uint16 data;
    rtk_mdio_c22_read(*reg_ptr,&data);
    *value_ptr = data;
#else
    diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    return RT_ERR_FAILED;
...
cparser_cmd_debug_ext_mdio_c22_set_reg_value(
    ...
    uint32_t *value_ptr)
{
    ext_mdio_c22_write(reg_ptr,value_ptr);
    ...
    uint32_t *reg_ptr)
{
    ...
    ext_mdio_c22_read(reg_ptr, &value);
    ...
    uint32_t *phyid_ptr)
{
    ...
    rtk_mdio_init();
    rtk_mdio_cfg_set(*set_ptr,*port_ptr,*phyid_ptr,MDIO_FMT_C45);
#else
    diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    return RT_ERR_FAILED;
#endif
...
{
#if defined(CONFIG_SDK_RTL9607C)
    rtk_mdio_c45_write(*dev_ptr,*reg_ptr,*value_ptr);
#else
    diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    return RT_ERR_FAILED;
#endif
...
#if defined(CONFIG_SDK_RTL9607C)
    uint16 data;
    rtk_mdio_c45_read(*dev_ptr,*reg_ptr,&data);
    *value_ptr = data;
#else
    diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    return RT_ERR_FAILED;
...
cparser_cmd_debug_ext_mdio_c45_set_dev_reg_value(
    ...
    uint32_t *value_ptr)
{
    ext_mdio_c45_write(dev_ptr,reg_ptr,value_ptr);
    ...
    uint32_t *reg_ptr)
{
    ...
    ext_mdio_c45_read(dev_ptr,reg_ptr,&value);
    ...
    uint32_t  *count_ptr)
{
    ...
    for(i = 0 ; i < *count_ptr ; i ++ )
    {
        ...
        DIAG_UTIL_ERR_CHK(rtk_i2c_seq_write(*port_ptr, *dev_id_ptr, *register_ptr, pData, *len_ptr), ret);
        for(j = 0 ; j < *len_ptr ; j ++)
        {
            pData[j] = *data_ptr;
        }
        ...
        DIAG_UTIL_ERR_CHK(rtk_i2c_seq_read(*port_ptr, *dev_id_ptr, *register_ptr, pData, *len_ptr), ret);
        for(j = 0 ; j < *len_ptr ; j ++)
        {
            if(pData[j] != *data_ptr)
            {
    ...
    uint32_t  *count_ptr)
{
    ...
    for(i = 0 ; i < *count_ptr ; i ++ )
    {
        ...
        DIAG_UTIL_ERR_CHK(rtk_i2c_seq_write(*port_ptr, *dev_id_ptr, *register_ptr, pData, *len_ptr), ret);
        memset(pData, 0, sizeof(pData) * (*len_ptr));
        DIAG_UTIL_ERR_CHK(rtk_i2c_read(*port_ptr, *dev_id_ptr, *register_ptr, &pData[0]), ret);
        if(*len_ptr > 1)
        {
            DIAG_UTIL_ERR_CHK(rtk_i2c_seqCurr_read(*port_ptr, *dev_id_ptr, pData + 1, (*len_ptr) - 1), ret);
        }
        for(j = 0 ; j < *len_ptr ; j ++)
        {
            if(pData[j] != *data_ptr)
