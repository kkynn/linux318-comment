 ...
 *
 * $Revision: 89794 $
 * $Date: 2018-06-29 14:56:47 +0800 (Fri, 29 Jun 2018) $
 *
...
static void __pon_mac_scheduler_queue_list_get(int32 isTcont, uint32 scheduleId)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9607C_CHIP_ID:
            ...
            reg_array_read(RTL9607C_PON_SCH_QMAPr,REG_ARRAY_INDEX_NONE, regIndex, &qmap);
        ...
        case RTL9603D_CHIP_ID:
            ...
            //reg_array_read(RTL9603D_PON_SCH_QMAPr,REG_ARRAY_INDEX_NONE, regIndex, &qmap);
            reg_array_field_read(RTL9603D_PON_SCH_QMAPr,REG_ARRAY_INDEX_NONE, regIndex, RTL9603D_MAPPING_TBLf, &qmap);
...
#ifdef CONFIG_SDK_RTL9607C
        case RTL9607C_CHIP_ID:
            reg_array_read(RTL9607C_PON_SCH_QMAPr,REG_ARRAY_INDEX_NONE, index, &qmap);
            break;
#endif
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            reg_array_field_read(RTL9603D_PON_SCH_QMAPr,REG_ARRAY_INDEX_NONE, index, RTL9603D_MAPPING_TBLf, &qmap);
            break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9601B_CHIP_ID:
            ...
            tmp = 0x1;
            reg_field_write(RTL9601B_WSDS_DIG_12r, RTL9601B_CFG_FRC_TX_DISABLE_OPTICf, &tmp);
            reg_field_write(RTL9601B_WSDS_DIG_12r, RTL9601B_TX_DISABLE_OPTIC_OEf, &enable);
            reg_field_write(RTL9601B_IO_MODE_ENr, RTL9601B_DIS_TX_ENf, &enable);
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
            break;
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9601B_CHIP_ID:
            ...
            reg_field_read(RTL9601B_IO_MODE_ENr, RTL9601B_DIS_TX_ENf, &enable);
            reg_field_read(RTL9601B_GPON_GEM_US_PWR_SAV_CFGr, RTL9601B_OPT_AHEAD_CYCLESf, &tCycleAhead);
            reg_field_read(RTL9601B_GPON_GEM_US_PWR_SAV_CFGr, RTL9601B_OPT_BEHIND_CYCLESf, &tCycleBehind);
    ...
    uint32_t  *cycle_ptr)
{
        ...
        switch(DIAG_UTIL_CHIP_TYPE)
        {
            ...
            case RTL9601B_CHIP_ID:
                ...
                if('a'==TOKEN_CHAR(3,0))
                {
                    reg_field_write(RTL9601B_GPON_GEM_US_PWR_SAV_CFGr, RTL9601B_OPT_AHEAD_CYCLESf, &tCycle);
                }
                else
                {
                    reg_field_write(RTL9601B_GPON_GEM_US_PWR_SAV_CFGr, RTL9601B_OPT_BEHIND_CYCLESf, &tCycle);
                }
                break;
#endif
            default:
    ...
    cparser_context_t *context)
{
    ...
    rtk_ponmac_aggregate_tcont_t aggIndex;
    rtk_enable_t state;
    char *aggTcontStr[4]={"0-3","4-7","8-11","12-15"};
