 ...
 *
 * $Revision: 88530 $
 * $Date: 2018-05-31 13:24:53 +0800 (Thu, 31 May 2018) $
 *
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        {
            uint32 val;
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_MPCP_CTRr,RTL9603D_GATE_HANDLEf,&val), ret); 
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
        {
            ...
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_MPCP_CTRr,RTL9603D_GATE_HANDLEf,&val), ret); 
            break;
        }
#endif
        default:
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        {
            uint32 tmp_val;
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_MPCP_CTRr,RTL9603D_INVALID_LEN_HANDLEf,&tmp_val), ret); 
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
        {
            ...
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_MPCP_CTRr,RTL9603D_INVALID_LEN_HANDLEf,&writeVal), ret); 
            break;
        }
#endif 
        default:
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_RGSTR2r,RTL9603D_REG_PENDDING_GRANTf,&grantNum), ret); 
            diag_util_mprintf("grant number:%d\n",grantNum);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_RGSTR2r,RTL9603D_REG_PENDDING_GRANTf,number_ptr), ret); 
            break;
#endif 
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_LOCAL_TIMEr,RTL9603D_LOCAL_TIMEf,&localTime), ret); 
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_GRANT_SHIFT_STARTr,RTL9603D_GRANT_SHIFTf,&shiftTime), ret); 
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_GRANT_SHIFT_STARTr,RTL9603D_GRANT_SHIFTf,number_ptr), ret); 
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_MPCP_CTRr,RTL9603D_GATE_TRAP_TYPEf,&type), ret); 
            break;
#endif 
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_MPCP_CTRr,RTL9603D_GATE_TRAP_TYPEf,&type), ret); 
            break;
#endif 
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_ASIC_TIMING_ADJUST2r,RTL9603D_LSR_ON_SHIFTf,&value), ret); 
            break;
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_ASIC_TIMING_ADJUST2r,RTL9603D_LSR_ON_SHIFTf,&value), ret); 
            break;
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_ASIC_TIMING_ADJUST2r,RTL9603D_LSR_OFF_SHIFTf,&value), ret); 
            break;
#endif 
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_ASIC_TIMING_ADJUST2r,RTL9603D_LSR_OFF_SHIFTf,&value), ret); 
            break;
#endif 
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_SYNC_TIMEr,RTL9603D_NORMAL_SYNC_TIMEf,&value), ret); 
            break;
#endif 
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(dal_rtl9603d_epon_reportMode_set(mode), ret); 
            break;
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(dal_rtl9603d_epon_reportMode_get(&mode), ret); 
            break;
#endif 
...
#ifdef CONFIG_SDK_RTL9603D
		case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_GATE_ANAr,RTL9603D_LATCH_FILTERf,&type), ret); 
			trigger = 0x1;
            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_GATE_ANAr,RTL9603D_GRANT_LATCH_TRIGGERf,&trigger), ret); 
			break;
#endif 
		default:
			diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);		 
    ...
    uint32_t *llididx_ptr)
{
	...
	switch(DIAG_UTIL_CHIP_TYPE)
	{
		...
		case RTL9603D_CHIP_ID:
			DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_GATE_ANAr,RTL9603D_LATCH_FILTERf,&type), ret); 
			DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_GATE_ANAr,RTL9603D_GRANT_LATCH_LLIDf,&llid), ret); 
			trigger = 0x1;
			DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_GATE_ANAr,RTL9603D_GRANT_LATCH_TRIGGERf,&trigger), ret); 
			break;
...
#define GATE_ANA_BUSY_TIMEOUT  80000
	...
	switch(DIAG_UTIL_CHIP_TYPE)
	{
		...
		case RTL9603D_CHIP_ID:
			...
			for(index = index1; index <= index2; index++)
			{
				DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_TBL_ACCESS_STSr,RTL9603D_INDEXf,&index), ret); 
				do {
					DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_TBL_ACCESS_STSr,RTL9603D_BUSY_FLAGf,&busy_flag), ret); 
    			    loopcnt++;
    			    if(loopcnt>GATE_ANA_BUSY_TIMEOUT)
    			    {
    			        diag_util_printf("Access Timeout\n");	
				...
				DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_TBL_ACCESS_RD_DATAr,RTL9603D_DATA0f,&data0), ret); 
				DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_TBL_ACCESS_RD_DATAr,RTL9603D_DATA1f,&data1), ret); 
...
#ifdef CONFIG_SDK_RTL9603D
		case RTL9603D_CHIP_ID:
			DIAG_UTIL_ERR_CHK(reg_array_field_read(RTL9603D_EPON_LLID_SIDMAP_CTRLr, REG_ARRAY_INDEX_NONE, llid_idx, RTL9603D_IDXf, &index), ret);
...
#ifdef CONFIG_SDK_RTL9603D
		case RTL9603D_CHIP_ID:
			DIAG_UTIL_ERR_CHK(reg_array_field_write(RTL9603D_EPON_LLID_SIDMAP_CTRLr, REG_ARRAY_INDEX_NONE, llid_idx, RTL9603D_IDXf, &index), ret);
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_ASIC_TIMING_ADJUST2r,RTL9603D_ADJ_BCf,&data), ret); 
            diag_util_printf("adj-bc       :%d\n",data); 
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_ASIC_TIMING_ADJUST1r,RTL9603D_RPT_TMGf,&data), ret); 
            diag_util_printf("rpt-tmg      :%d\n",data); 
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_ASIC_TIMING_ADJUST1r,RTL9603D_REG_TMGf,&data), ret); 
            diag_util_printf("reg-tmg      :%d\n",data); 
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_ASIC_TIMING_ADJUST1r,RTL9603D_QU_TMGf,&data), ret); 
            diag_util_printf("qu-tmg       :%d\n",data); 
            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_SCH_TIMINGr,RTL9603D_CFG_EPON_SCH_LATENCYf,&data), ret); 
            diag_util_printf("sche latency :%d\n",data); 

            DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_ASIC_TIMING_ADJUST2r,RTL9603D_DY_ADJ_BCf,&data), ret); 
            diag_util_printf("adj-bc       :%d, %d(TQ)\n",data,(data==0?0:2^(data-1))); 
            break;
#endif 
        default:
    ...
    uint32_t  *value_ptr)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            if('a'==TOKEN_CHAR(3,0))
            {
        		reg   = RTL9603D_EPON_ASIC_TIMING_ADJUST2r;
        		field = RTL9603D_ADJ_BCf;
            }
        	else if ('q'==TOKEN_CHAR(3,0))
        	{
        		reg   = RTL9603D_EPON_ASIC_TIMING_ADJUST1r;
        		field = RTL9603D_QU_TMGf;
        	}
        	else if ('s'==TOKEN_CHAR(3,0))
        	{
        		reg   = RTL9603D_EPON_SCH_TIMINGr;
        		field = RTL9603D_CFG_EPON_SCH_LATENCYf;
            }
        	else if ('r'==TOKEN_CHAR(3,0))
        	{
                if ('p'==TOKEN_CHAR(3,1))
                {/*rpt_tmg*/
            		reg   = RTL9603D_EPON_ASIC_TIMING_ADJUST1r;
            		field = RTL9603D_RPT_TMGf;                    
                }
                else
                {
             		reg   = RTL9603D_EPON_ASIC_TIMING_ADJUST1r;
            		field = RTL9603D_REG_TMGf;                   
                }
        	}
        	else if ('d'==TOKEN_CHAR(3,0))
        	{
        		reg   = RTL9603D_EPON_ASIC_TIMING_ADJUST2r;
        		field = RTL9603D_DY_ADJ_BCf;
            }
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_TIME_CTRLr,RTL9603D_RTT_ADJf,&data), ret);
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_TIME_CTRLr,RTL9603D_RTT_ADJf,&data), ret);
        break;        
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EP_MISCr,RTL9603D_STOP_LOCAL_TIMEf,&data), ret);
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EP_MISCr,RTL9603D_STOP_LOCAL_TIMEf,&data), ret);
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_ASIC_OPTI1r,RTL9603D_STOP_SYNCf,&data), ret);
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_DBG_LCTM_DRFr,RTL9603D_UPD_LCL_TYPEf,&data), ret);
        break;        
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_REPORT_MODEr,RTL9603D_REPORT_CNT_ADJf,&data), ret);
        break;        
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_EPON_REPORT_MODEr,RTL9603D_REPORT_CNT_ADJf,&data), ret);
        break;        
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
        DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_EPON_GRANT_SHIFT_STARTr,RTL9603D_GRANT_SHIFTf,&data), ret);
        break;        
#endif
        default:
            diag_util_printf("%s\n",DIAG_STR_NOTSUPPORT);        
    ...
    uint32_t  *value_ptr)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
        ...
        case RTL9603D_CHIP_ID:
            if('0'==TOKEN_CHAR(3,11))
            {
        		reg   = RTL9603D_PRG_EPON_GN0r;
            }
        	else if ('1'==TOKEN_CHAR(3,11))
        	{
        		reg   = RTL9603D_PRG_EPON_GN1r;
        	}
        	else if ('2'==TOKEN_CHAR(3,11))
        	{
        		reg   = RTL9603D_PRG_EPON_GN2r;
            }
            DIAG_UTIL_ERR_CHK(reg_write(reg,&data), ret);
        break;        
#endif
