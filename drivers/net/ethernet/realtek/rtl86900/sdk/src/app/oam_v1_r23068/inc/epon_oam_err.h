...
enum {
    ...
    EPON_OAM_ERR_WRAPPER    = -10,/* Wrapper execution error */
    EPON_OAM_ERR_NO_RESPONSE = -11, /* Not reply to broadcast oam request if onu id is not matched */
    EPON_OAM_ERR_DOWNLOAD_ACK = -12, /* special download ack response packet, save it to resend if needed */
};
