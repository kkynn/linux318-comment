...
*
* $Revision: 87698 $
* $Date: 2018-05-08 11:40:50 +0800 (Tue, 08 May 2018) $
*
...
#define CID  rtl9603d
#define UPPER_CASE_CID RTL9603D
#endif
...
static void _sid_used_page_dump(void)
{
    ...
    uint32                  qcurrent[8], qmaximum[8], flow[8];
    rtk_enable_t            enable;
    ...
    if (!osal_strcmp(TOKEN_STR(3),"switch")) {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9607C_CHIP_ID:
                ...
                {
                    /*call API*/
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_dropAllThreshold_get(&threshold), ret);
                    diag_util_printf("Drop All Threshold is %u\n", threshold);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_pauseAllThreshold_get(&threshold), ret);
                    diag_util_printf("Pause All Threshold is %u\n", threshold);

                    diag_util_printf("\nFlow Control On-Off Threshold\n");
                    diag_util_printf("                        On Threshold     Off-Threshold\n");
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global High FC-On            %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global Low FC-On             %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port High FC-On              %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port Low FC-On               %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global High FC-Off           %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global Low FC-Off            %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port High FC-Off             %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port Low FC-Off              %-4u              %-4u\n",onThresh,offThresh);
                    diag_util_printf("\n");
                    ...
                    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
                    {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portEegressDropThreshold_get(port, &threshold), ret);
                        diag_util_printf("%-18u  %u\n", port, threshold);
                    }
                    diag_util_printf("\n");
                    queuelist.min = HAL_MIN_NUM_OF_QUEUE() - 1;
                    ...
                    DIAG_UTIL_MASK_SCAN(queuelist, queue)
                    {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_queueEegressDropThreshold_get(queue, &threshold), ret);
                        diag_util_printf("%-18u  %u\n", queue, threshold);
                    }
                    ...
                    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
                    {
                        ...
                        DIAG_UTIL_MASK_SCAN(queuelist, queue)
                        {
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_egressDropEnable_get(port, queue, &enable), ret);
                            diag_util_printf("   %3s",enable?"En":"Dis");
                        }
                        diag_util_printf("\n");
                    }
                    ...
                    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
                    {
                        ...
                        DIAG_UTIL_MASK_SCAN(queuelist, queue)
                        {
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponEgressDropEnable_get(port, queue, &enable), ret);
                            diag_util_printf("   %3s",enable?"En":"Dis");
                        }
                        diag_util_printf("\n");
                    }
        ...
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9607C_CHIP_ID:
                ...
                case RTL9603D_CHIP_ID:
                {
                    diag_util_printf("\nPON Flow Control On-Off Threshold\n");
                    diag_util_printf("                        On Threshold     Off-Threshold\n");
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global High                       %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global Low                        %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port High                         %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port Low                          %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global Drop High                  %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Global Drop Low                   %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropHighThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port Drop High                    %-4u              %-4u\n",onThresh,offThresh);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropLowThreshold_get(&onThresh, &offThresh), ret);
                    diag_util_printf("Port Drop Low                     %-4u              %-4u\n",onThresh,offThresh);
                }
                break;
#endif
                ...
                case RTL9603D_CHIP_ID:
                    {
                        diag_util_printf("\nSWPBO Flow Control On-Off Threshold\n");
                        diag_util_printf("                        On Threshold     Off-Threshold\n");
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalHighThreshold_get(&onThresh, &offThresh), ret);
                        diag_util_printf("Global High                       %-4u              %-4u\n",onThresh,offThresh);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalLowThreshold_get(&onThresh, &offThresh), ret);
                        diag_util_printf("Global Low                        %-4u              %-4u\n",onThresh,offThresh);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortHighThreshold_get(&onThresh, &offThresh), ret);
                        diag_util_printf("Port High                         %-4u              %-4u\n",onThresh,offThresh);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortLowThreshold_get(&onThresh, &offThresh), ret);
                        diag_util_printf("Port Low                          %-4u              %-4u\n",onThresh,offThresh);
                        diag_util_printf("\nEgress-Port       Drop-Threshold\n");
                        diag_util_printf("------------------------------------\n");
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboEgressDropThreshold_get(&threshold), ret);
                        diag_util_printf("Swpbo               %-4u\n", threshold);
                    }
                    break;
#endif
...
#if defined(CONFIG_SDK_RTL9603D)
            case RTL9603D_CHIP_ID:
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_totalUsedPageCnt_get(&current, &maximum), ret);
                diag_util_printf("Total page Count: Current  %u maximum  %u\n", current, maximum);
                diag_util_printf("\n");
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_publicUsedPageCnt_get(&current, &maximum), ret);
                diag_util_printf("Public page Count: Current  %u maximum  %u\n", current, maximum);
                diag_util_printf("\n");
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_publicFcoffUsedPageCnt_get(&current, &maximum), ret);
                diag_util_printf("Public page Count for FC-off: Current  %u maximum  %u\n", current, maximum);
                diag_util_printf("\n");
                ...
                DIAG_UTIL_PORTMASK_SCAN(portlist, port)
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portUsedPageCnt_get(port, &current, &maximum), ret);
                    diag_util_printf("    %-18u %-18u%u\n", port, current, maximum);
                }
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortUsedUsedPage_get(&current, &maximum), ret);
                diag_util_printf("    %-18u %-18u%u\n", HAL_GET_SWPBOLB_PORT(), current, maximum);
                ...
                {
                    diag_util_printf("          P%u     Q0     Q1     Q2     Q3     Q4     Q5     Q6     Q7  \n", port);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portEgressUsedPageCnt_get(port, &current, &maximum), ret);

                    DIAG_UTIL_MASK_SCAN(queuelist, queue)
                    {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_queueEgressUsedPageCnt_get(port, queue, &qcurrent[queue], &qmaximum[queue]), ret);
                    }
                    diag_util_printf("Current : %-5u  ", current);
                ...
                diag_util_printf("          P%u     Q0  \n", HAL_GET_SWPBOLB_PORT());
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboEgressUsedPage_get(&current, &maximum), ret);
                diag_util_printf("Current : %-5u  ", current);
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboEgressQueueUsedPage_get(&qcurrent[0], &qmaximum[0]), ret);
                diag_util_printf("%-5u\n", qcurrent[0]);
                diag_util_printf("Maximum : %-5u  ", maximum);
                diag_util_printf("%-5u\n", qmaximum[0]);
                diag_util_printf("-------------------------------------------------------------------\n");
            ...
            case RTL9603D_CHIP_ID:
                {
                    ...
                    for (idx = 0; idx < idx_end; idx++) {
                        ...
                        for (queue=0;queue<8; queue++) {
                            ...
                            tmp_queue = (idx<<3) | queue;
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponUsedPage_get(tmp_queue, &qcurrent[queue], &qmaximum[queue]), ret);
                            if ((queue == 7) || (idx == idx_end && queue==0))
                                diag_util_printf("%-5u\n", tmp_queue);
                            else
                                diag_util_printf("%-5u   ", tmp_queue);
                                                     ...
                                                     uint32_t  *threshold_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_dropAllThreshold_set(*threshold_ptr), ret);
            }
            break;
#endif
                                                      ...
                                                      uint32_t  *threshold_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_pauseAllThreshold_set(*threshold_ptr), ret);
            }
            break;
#endif
        ...
        case RTL9603D_CHIP_ID:
            {
                if ('d'==TOKEN_CHAR(4,0)) {
                    if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffHighThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Global FC-Off High Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffHighThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Global FC-Off High On Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffLowThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Global FC-Off Low Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFcoffLowThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Global FC-Off Low On Threshold to %u\n",*threshold_ptr);
                    }
                } else if ('f'==TOKEN_CHAR(4,0)) {
                    if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconHighThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Global FC-On High Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconHighThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Global FC-On High On Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconLowThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Global FC-On Low Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_globalFconLowThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Global FC-On Low On Threshold to %u\n",*threshold_ptr);
                    }
                }
        ...
        case RTL9603D_CHIP_ID:
            {
                if ('d'==TOKEN_CHAR(4,0)) {
                    if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffHighThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Port FC-Off High Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffHighThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Port FC-Off High On Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffLowThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Port FC-Off Low Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFcoffLowThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Port FC-Off Low On Threshold to %u\n",*threshold_ptr);
                    }
                } else if ('f'==TOKEN_CHAR(4,0)) {
                    if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconHighThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Port FC-On High Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconHighThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconHighThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Port FC-On High On Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconLowThreshold_set(onThresh, *threshold_ptr), ret);
                        diag_util_printf("Set Flow Control Port FC-On Low Off Threshold to %u\n",*threshold_ptr);
                    } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconLowThreshold_get(&onThresh, &offThresh), ret);
                        DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portFconLowThreshold_set(*threshold_ptr, offThresh), ret);
                        diag_util_printf("Set Flow Control Port FC-On Low On Threshold to %u\n",*threshold_ptr);
                    }
                }
            }
                                                                               ...
                                                                               uint32_t  *threshold_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portEegressDropThreshold_set(port, *threshold_ptr), ret);
                }
                break;
#endif
                                                                                 ...
                                                                                 uint32_t  *threshold_ptr)
{
    ...
    DIAG_UTIL_MASK_SCAN(queuelist, queue)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_queueEegressDropThreshold_set(queue, *threshold_ptr), ret);
                }
                break;
#endif
        ...
        DIAG_UTIL_MASK_SCAN(queuelist, queue)
        {
            switch (DIAG_UTIL_CHIP_TYPE) {
                ...
                case RTL9603D_CHIP_ID:
                    {
                        if ('e'==TOKEN_CHAR(9,0)) {
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_egressDropEnable_set(port, queue, ENABLED), ret);
                            diag_util_printf("    En");
                        } else if ('d'==TOKEN_CHAR(9,0)) {
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_egressDropEnable_set(port, queue, DISABLED), ret);
                            diag_util_printf("   Dis");
                        } else
                            return RT_ERR_FAILED;
                    }
        ...
        case RTL9603D_CHIP_ID:
            {
                if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalHighThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Global High Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalHighThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Global High On Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalLowThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Global Low Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalLowThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Global Low On Threshold to %u\n",*threshold_ptr);
                }

                if (!osal_strcmp(TOKEN_STR(5),"drop-high-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropHighThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Global Drop High Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"drop-high-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropHighThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Global Drop High On Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"drop-low-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropLowThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Global Drop Low Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"drop-low-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponGlobalDropLowThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Global Drop Low On Threshold to %u\n",*threshold_ptr);
                }
            }
            break;
        ...
        case RTL9603D_CHIP_ID:
            {
                if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortHighThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Port High Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortHighThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Port High On Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortLowThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Port Low Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortLowThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Port Low On Threshold to %u\n",*threshold_ptr);
                }
                if (!osal_strcmp(TOKEN_STR(5),"drop-high-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropHighThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Port Drop High Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"drop-high-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropHighThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Port Drop High On Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"drop-low-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropLowThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set PON MAC Port Drop Low Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"drop-low-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponPortDropLowThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set PON MAC Port Drop Low On Threshold to %u\n",*threshold_ptr);
                }
            }
            break;
                                                                 ...
                                                                 uint32_t  *sid_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponSidState_set(*sid_ptr, state), ret);
                diag_util_mprintf("PON SID %u State %s \n", *sid_ptr, diagStr_enable[state]);
            }
            break;
#endif
                                                  ...
                                                  uint32_t  *sid_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponSidState_get(*sid_ptr, &state), ret);
                diag_util_mprintf("PON SID %u State %s \n", *sid_ptr, diagStr_enable[state]);
            }
            break;
#endif
                                                             ...
                                                             char * *ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_debugCtrl_set(port, ENABLED, mask), ret);
                }
                break;
#endif
                                           ...
                                           cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_clrTotalPktCnt_set(ENABLED), ret);
            }
            break;
#endif
                                              ...
                                              cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_clrMaxUsedPageCnt_set(ENABLED), ret);
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_clrTotalPktCnt_set(ENABLED), ret);

                queuelist.mask.bits[0] = 0xFF;
                HAL_SCAN_ALL_PORT(port)
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_debugCtrl_set(port, ENABLED, queuelist.mask), ret);
                }

                for(i=0;i<HAL_MAX_NUM_OF_PON_QUEUE();i++)
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponUsedPageCtrl_set(i, ENABLED), ret);
                }
            }
            break;
#endif
                                                                                    ...
                                                                                    char * *qid_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_debugCtrl_set(port, DISABLED, queuelist.mask), ret);
                }
                break;
#endif
            ...
            case RTL9603D_CHIP_ID:
                {
                    ...
                    DIAG_UTIL_MASK_SCAN(queuelist, queue)
                    {
                        if (queue == 0)
                        {
                            ...
                            diag_util_mprintf("------------------------------------------------------------------------------------\n");
                            diag_util_printf("Port%2u  Current   ", HAL_GET_SWPBOLB_PORT());
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboEgressQueueUsedPage_get(&current, &maximum[queue]), ret);
                            diag_util_printf("%5u   ", current);
                            diag_util_mprintf("\n");
                            diag_util_printf("        Maximum   ");
                            diag_util_printf("%5u   ", maximum[queue]);
        ...
        DIAG_UTIL_PORTMASK_SCAN(portlist, port)
        {
            ...
            DIAG_UTIL_MASK_SCAN(queuelist, queue)
            {
                switch (DIAG_UTIL_CHIP_TYPE) {
                    ...
                    case RTL9603D_CHIP_ID:
                        {
                            DIAG_UTIL_ERR_CHK( rtl9603d_raw_flowctrl_queueEgressUsedPageCnt_get(port, queue, &current, &maximum[queue]), ret);
                        }
                        break;
#endif
                                       ...
                                       cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_totalPageCnt_get(&count), ret);
            }
            break;
#endif
                                                           ...
                                                           char * *qid_ptr)
{
    ...
    DIAG_UTIL_MASK_SCAN(queuelist, queue)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponUsedPage_get(queue, &current, &maximum), ret);
                }
                break;
#endif
                                                        ...
                                                        uint32_t  *qid_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponUsedPageCtrl_set(*qid_ptr, ENABLED), ret);
            }
            break;
#endif
                                                     ...
                                                     uint32_t  *threshold_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_txPrefet_set(*threshold_ptr), ret);
            }
            break;
#endif
                                           ...
                                           cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_txPrefet_get(&threshold), ret);
            }
            break;
#endif
                                                            ...
                                                            uint32_t  *threshold_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portEegressGapThreshold_set(*threshold_ptr), ret);
            }
            break;
#endif
                                                  ...
                                                  cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portEegressGapThreshold_get(&threshold), ret);
            }
            break;
#endif
                                                             ...
                                                             uint32_t  *threshold_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_queueEegressGapThreshold_set(*threshold_ptr), ret);
            }
            break;
#endif
                                                   ...
                                                   cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_queueEegressGapThreshold_get(&threshold), ret);
            }
            break;
#endif
        ...
        DIAG_UTIL_MASK_SCAN(queuelist, queue)
        {
            switch (DIAG_UTIL_CHIP_TYPE) {
                ...
                case RTL9603D_CHIP_ID:
                    {
                        if ('e'==TOKEN_CHAR(10,0)) {
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponEgressDropEnable_set(port, queue, ENABLED), ret);
                            diag_util_printf("    En");
                        } else if ('d'==TOKEN_CHAR(10,0)) {
                            DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_ponEgressDropEnable_set(port, queue, DISABLED), ret);
                            diag_util_printf("   Dis");
                        } else
                            return RT_ERR_FAILED;
                    }
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                ...
                DIAG_UTIL_ERR_CHK(reg_array_field_write(RTL9603D_OUTPUT_DROP_ENr, port, REG_ARRAY_INDEX_NONE, RTL9603D_ENf,&state), ret);
                                                                                   ...
                                                                                   cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            ...
            if ('b' == TOKEN_CHAR(3,0)) {
                bitField = RTL9603D_OD_BC_SELf;
            } else if ('m' == TOKEN_CHAR(3,0)) {
                bitField = RTL9603D_OD_MC_SELf;
            } else if ('u' == TOKEN_CHAR(3,0)) {
                bitField = RTL9603D_OD_UC_SELf;
            }

            DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_OUTPUT_DROP_CFGr, bitField,&sel), ret);
        ...
        case RTL9603D_CHIP_ID:
            {
                ...
                DIAG_UTIL_PORTMASK_SCAN(portlist, port)
                {
                    DIAG_UTIL_ERR_CHK(reg_array_field_read(RTL9603D_OUTPUT_DROP_ENr, port, REG_ARRAY_INDEX_NONE, RTL9603D_ENf,&state), ret);

                    diag_util_mprintf("Port %d: %s\n",port,state?"Enable":"Disable");
                }

                DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_OUTPUT_DROP_CFGr, RTL9603D_OD_BC_SELf,&bcSel), ret);

                DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_OUTPUT_DROP_CFGr, RTL9603D_OD_MC_SELf,&mcSel), ret);

                DIAG_UTIL_ERR_CHK(reg_field_read(RTL9603D_OUTPUT_DROP_CFGr, RTL9603D_OD_UC_SELf,&ucSel), ret);
                                                                                  ...
                                                                                  char * *ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portBackPressureEnable_set(port, state), ret);
                }
                break;
#endif
                                                                   ...
                                                                   char * *ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        switch (DIAG_UTIL_CHIP_TYPE) {
            ...
            case RTL9603D_CHIP_ID:
                {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_portBackPressureEnable_get(port, &state), ret);
                    diag_util_mprintf("\n%-4d %-10s", port, diagStr_enable[state]);
                }
                break;
#endif
                                                                   ...
                                                                   uint32_t  *threshold_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_rsvPageBeforeFcDrop_set(*threshold_ptr), ret);
            }
            break;
#endif
                                                         ...
                                                         cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_rsvPageBeforeFcDrop_get(&threshold), ret);
            }
            break;
#endif
                                                                 ...
                                                                 cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_changeDuplexEnable_set(enable), ret);
            }
            break;
#endif
                                                  ...
                                                  cparser_context_t *context)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_changeDuplexEnable_get(&enable), ret);
            }
            break;
#endif
        ...
        case RTL9603D_CHIP_ID:
            {
                if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalHighThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set SWPBO MAC Global High Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalHighThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set SWPBO MAC Global High On Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalLowThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set SWPBO MAC Global Low Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboGlobalLowThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set SWPBO MAC Global Low On Threshold to %u\n",*threshold_ptr);
                }
            }
            break;
        ...
        case RTL9603D_CHIP_ID:
            {
                if (!osal_strcmp(TOKEN_STR(5),"high-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortHighThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set SWPBO MAC Port High Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"high-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortHighThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortHighThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set SWPBO MAC Port High On Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-off")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortLowThreshold_set(onThresh, *threshold_ptr), ret);
                    diag_util_printf("Set SWPBO MAC Port Low Off Threshold to %u\n",*threshold_ptr);
                } else if (!osal_strcmp(TOKEN_STR(5),"low-on")) {
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortLowThreshold_get(&onThresh, &offThresh), ret);
                    DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboPortLowThreshold_set(*threshold_ptr, offThresh), ret);
                    diag_util_printf("Set SWPBO MAC Port Low On Threshold to %u\n",*threshold_ptr);
                }
            }
            break;
                                                                       ...
                                                                       uint32_t  *threshold_ptr)
{
    ...
    switch (DIAG_UTIL_CHIP_TYPE) {
        ...
        case RTL9603D_CHIP_ID:
            {
                DIAG_UTIL_ERR_CHK(rtl9603d_raw_flowctrl_swpboEgressDropThreshold_set(*threshold_ptr), ret);
            }
            break;
#endif
