 ...
 *
 * $Revision: 86692 $
 * $Date: 2018-03-16 17:35:06 +0800 (Fri, 16 Mar 2018) $
 *
...
diag_util_str2LPortMask(uint8 *str, rtk_portmask_t *mask)
{
    ...
    while (NULL != ptr)
    {
        ...
        else if(!strncasecmp(ptr, "cpu0", 4))
        {
            ...
            {
                diag_util_printf("Error! get CPU0 port id failure!\n",__LINE__, __FUNCTION__);
                return RT_ERR_FAILED;
            }
            _diag_util_port2LPortMask_set(mask, i);
        }
        else if(!strncasecmp(ptr, "cpu1", 4))
        {
            ...
            {
                diag_util_printf("Error! get CPU1 port id failure!\n",__LINE__, __FUNCTION__);
                return RT_ERR_FAILED;
            }
            _diag_util_port2LPortMask_set(mask, i);
        }
        else if(!strncasecmp(ptr, "cpu2", 4))
        {
            ...
            {
                diag_util_printf("Error! get CPU2 port id failure!\n",__LINE__, __FUNCTION__);
                return RT_ERR_FAILED;
            }
            _diag_util_port2LPortMask_set(mask, i);
        }
