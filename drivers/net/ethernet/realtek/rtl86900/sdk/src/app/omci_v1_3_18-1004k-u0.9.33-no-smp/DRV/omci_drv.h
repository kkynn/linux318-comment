...
typedef struct {
	...
	//other
	int (*pf_SetLoidAuthStatus)(unsigned char authStatus);
...
typedef struct {
    ...
    unsigned int            usAclIndex;
    unsigned int            dsAclIndex;
...
//other
int omcidrv_wrapper_setLoidAuthStatus(unsigned char authStatus);
