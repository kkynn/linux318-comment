...
#define MIB_TABLE_ETHUNI_ATTR_NUM (17)
...
#define MIB_TABLE_ETHUNI_PHYSICAL_PORT_ID_INDEX ((MIB_ATTR_INDEX)17)
...
typedef enum
{
    PPTP_ETH_UNI_BRIIPIND_BRIDGED     = 0,
    PPTP_ETH_UNI_BRIIPIND_ROUTER      = 1,
    PPTP_ETH_UNI_BRIIPIND_CIRCUITPACK = 2
} pptp_eth_ni_attr_briIpInd_t;
