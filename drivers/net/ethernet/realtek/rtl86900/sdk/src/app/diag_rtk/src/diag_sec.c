    ...
    uint32_t  *unit_ptr)
{
    ...
    if(!osal_strcmp(TOKEN_STR(5),"512"))
    {
        *unit_ptr = SEC_THRESH_UNIT_512MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"256"))
    {
        *unit_ptr = SEC_THRESH_UNIT_256MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"128"))
    {
        *unit_ptr = SEC_THRESH_UNIT_128MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"64"))
    {
        *unit_ptr = SEC_THRESH_UNIT_64MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"32"))
    {
        *unit_ptr = SEC_THRESH_UNIT_32MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"16"))
    {
        *unit_ptr = SEC_THRESH_UNIT_16MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"8"))
    {
        *unit_ptr = SEC_THRESH_UNIT_8MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"4"))
    {
        *unit_ptr = SEC_THRESH_UNIT_4MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"2"))
    {
        *unit_ptr = SEC_THRESH_UNIT_2MS;
    }
    else if(!osal_strcmp(TOKEN_STR(5),"1"))
    {
        *unit_ptr = SEC_THRESH_UNIT_1MS;
    }
    else 
    {
