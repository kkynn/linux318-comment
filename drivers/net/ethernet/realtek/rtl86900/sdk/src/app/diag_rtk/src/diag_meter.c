 ...
 *
 * $Revision: 86702 $
 * $Date: 2018-03-19 16:57:40 +0800 (Mon, 19 Mar 2018) $
 *
    ...
    char * *index_ptr)
{
	...
	DIAG_UTIL_ERR_CHK(DIAG_UTIL_EXTRACT_MASK64(mask, 3), ret);
#else
    ...
    cparser_context_t *context)
{
    ...
    switch(DIAG_UTIL_CHIP_TYPE)
    {
		...
		case RTL9607C_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9607C_METER_TB_CTRLr, RTL9607C_TICK_PERIODf, &tickPeriod)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9607C_METER_TB_CTRLr, RTL9607C_TKNf, &tkn)), ret);
			break;
#endif
#ifdef CONFIG_SDK_RTL9603D
		case RTL9603D_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9603D_METER_TB_CTRLr, RTL9603D_TICK_PERIODf, &tickPeriod)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9603D_METER_TB_CTRLr, RTL9603D_TKNf, &tkn)), ret);
			break;
#endif
       default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9607C
		case RTL9607C_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9607C_METER_TB_CTRLr, RTL9607C_TICK_PERIODf, &period)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9607C_METER_TB_CTRLr, RTL9607C_TKNf, &token)), ret);
			break;
#endif
#ifdef CONFIG_SDK_RTL9603D
		case RTL9603D_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9603D_METER_TB_CTRLr, RTL9603D_TICK_PERIODf, &period)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9603D_METER_TB_CTRLr, RTL9603D_TKNf, &token)), ret);
			break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9607C
		case RTL9607C_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9607C_PON_TB_CTRLr, RTL9607C_TICK_PERIODf, &tickPeriod)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9607C_PON_TB_CTRLr, RTL9607C_TKNf, &tkn)), ret);
			break;
#endif

#ifdef CONFIG_SDK_RTL9603D
		case RTL9603D_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9603D_PON_TB_CTRLr, RTL9603D_TICK_PERIODf, &tickPeriod)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_read(RTL9603D_PON_TB_CTRLr, RTL9603D_TKNf, &tkn)), ret);
			break;
#endif
        default:
            diag_util_mprintf("%s\n",DIAG_STR_NOTSUPPORT);
...
#ifdef CONFIG_SDK_RTL9607C
		case RTL9607C_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9607C_PON_TB_CTRLr, RTL9607C_TICK_PERIODf, &period)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9607C_PON_TB_CTRLr, RTL9607C_TKNf, &token)), ret);
			break;
#endif

#ifdef CONFIG_SDK_RTL9603D
		case RTL9603D_CHIP_ID:
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9603D_PON_TB_CTRLr, RTL9603D_TICK_PERIODf, &period)), ret);
			DIAG_UTIL_ERR_CHK((reg_field_write(RTL9603D_PON_TB_CTRLr, RTL9603D_TKNf, &token)), ret);
			break;
#endif
