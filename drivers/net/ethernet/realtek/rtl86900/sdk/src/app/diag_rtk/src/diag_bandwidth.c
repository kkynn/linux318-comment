 ...
 *
 * $Revision: 86479 $
 * $Date: 2018-03-08 14:18:41 +0800 (Thu, 08 Mar 2018) $
 *
...
#ifdef CONFIG_SDK_RTL9603D
        case RTL9603D_CHIP_ID:
            DIAG_UTIL_ERR_CHK((reg_field_read(RTL9603D_IGR_BWCTRL_GLB_CTRLr, RTL9603D_BYPASS_ENf, &enable)), ret);
            break;
#endif
...
#ifdef CONFIG_SDK_RTL9603D
            case RTL9603D_CHIP_ID:
                DIAG_UTIL_ERR_CHK(reg_field_write(RTL9603D_IGR_BWCTRL_GLB_CTRLr, RTL9603D_BYPASS_ENf, &enable), ret);
                break;
#endif
    ...
    char * *ports_ptr)
{
    ...
    DIAG_UTIL_PORTMASK_SCAN(portlist, port)
    {
        switch(DIAG_UTIL_CHIP_TYPE)
        {
			...
			case RTL9603D_CHIP_ID:
				DIAG_UTIL_ERR_CHK(
                    reg_array_field_read(RTL9603D_IGR_BWCTRL_P_CTRLr, port, REG_ARRAY_INDEX_NONE, RTL9603D_MODEf, &enable), ret);
				break;
#endif
...
#ifdef CONFIG_SDK_RTL9603D
			case RTL9603D_CHIP_ID:
				DIAG_UTIL_ERR_CHK(reg_array_field_write(RTL9603D_IGR_BWCTRL_P_CTRLr, port, REG_ARRAY_INDEX_NONE, RTL9603D_MODEf, &enable), ret);
				break;
#endif
