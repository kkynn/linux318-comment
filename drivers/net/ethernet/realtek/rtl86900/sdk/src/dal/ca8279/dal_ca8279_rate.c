...
typedef struct dal_ca8279_storm_entry_s
{
    uint8   enable;
} dal_ca8279_storm_entry_t;


typedef struct dal_ca8279_storm_ctrl_s
{
    dal_ca8279_storm_entry_t entry[DAL_LUNA_G3_STORM_MAX_IDX];
} dal_ca8279_storm_ctrl_t;
...
static dal_ca8279_storm_ctrl_t stormGlobalCfg;
...
int32 _dal_ca8279_use_ca_l2_classifier_flood_set(rtk_port_t port,rtk_rate_storm_group_t stormType,rtk_enable_t enable,ca_uint16_t flow_id)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_classifier_key_t key;
...
/* Function Name:
 *      dal_ca8279_rate_stormControlEnable_get
 * Description:
 *      Get enable status of storm control on specified port.
 * Input:
 *      stormType  - storm group type
 ...
 */
int32
dal_ca8279_rate_stormControlEnable_get(rtk_rate_storm_group_ctrl_t  *stormCtrl)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_rate_stormControlEnable_get */


/* Function Name:
 *      dal_ca8279_rate_stormControlEnable_set
 * Description:
 *      Set enable status of storm control on specified port.
 * Input:
 *      stormType  - storm group type
 ...
 */
int32
dal_ca8279_rate_stormControlEnable_set(rtk_rate_storm_group_ctrl_t  *stormCtrl)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_RATE),"%s",__FUNCTION__);
    ...
    memset(&stormGlobalCfg,0x0,sizeof(dal_ca8279_storm_ctrl_t));
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_rate_stormControlEnable_set */
