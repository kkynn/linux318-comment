...
dal_rtl9603d_gpio_state_set ( uint32 gpioId, rtk_enable_t enable )
{
    ...
    /* parameter check */
    RT_PARAM_CHK((RTL9603D_GPIO_PIN_NUM <= gpioId), RT_ERR_INPUT);
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9603d_gpio_state_set */
...
dal_rtl9603d_gpio_state_get ( uint32 gpioId, rtk_enable_t* enable )
{
    ...
    *enable = value;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9603d_gpio_state_get */
...
dal_rtl9603d_gpio_mode_set ( uint32 gpioId, rtk_gpio_mode_t mode )
{
    ...
    {
        case 0:
            reg = RTL9603D_GPIO_DIR_ABCDr;
            break;
        case 1:
            reg = RTL9603D_GPIO_DIR_EFGHr;
            break;
        case 2:
            reg = RTL9603D_GPIO_DIR_JKMNr;
            break;
        default:
            return RT_ERR_INPUT;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9603d_gpio_mode_set */
...
dal_rtl9603d_gpio_mode_get ( uint32 gpioId, rtk_gpio_mode_t* mode )
{
    ...
    *mode = (value >> offset) & 0x1;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9603d_gpio_mode_get */
...
dal_rtl9603d_gpio_databit_get ( uint32 gpioId, uint32* data )
{
    ...
    {
        case 0:
            reg = RTL9603D_GPIO_DATA_ABCDr;
            break;
        case 1:
            reg = RTL9603D_GPIO_DATA_EFGHr;
            break;
        case 2:
            reg = RTL9603D_GPIO_DATA_JKMNr;
            break;
        default:
            return RT_ERR_INPUT;
    }
    ...
    *data = (value >> offset) & 0x1;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9603d_gpio_databit_get */
...
dal_rtl9603d_gpio_databit_set ( uint32 gpioId, uint32 data )
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9603d_gpio_databit_set */
...
dal_rtl9603d_gpio_intr_set ( uint32 gpioId, rtk_gpio_intrMode_t intrMode )
{
    ...
    RT_PARAM_CHK((RTK_GPIO_INTR_SET3 < gpioId), RT_ERR_INPUT);
...
dal_rtl9603d_gpio_intr_get ( uint32 gpioId, rtk_gpio_intrMode_t* pIntrMode )
{
    ...
    RT_PARAM_CHK((RTL9603D_GPIO_INTR_NUM <= gpioId), RT_ERR_INPUT);
...
dal_rtl9603d_gpio_intrStatus_clean ( uint32 gpioId )
{
    ...
    {
        value = 0;
        reg = RTL9603D_GPIO_IMS_ABCDr;
        if ((ret = ioal_socMem32_write(reg, ~value)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL | MOD_GPIO), "");
            return ret;
        }
        reg = RTL9603D_GPIO_IMS_EFGHr;
        if ((ret = ioal_socMem32_write(reg, ~value)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL | MOD_GPIO), "");
            return ret;
        }
        reg = RTL9603D_GPIO_IMS_JKMNr;
        if ((ret = ioal_socMem32_write(reg, ~value)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL | MOD_GPIO), "");
            return ret;
