...
void dal_rtl9602c_meter_exceed_isr_entry(void)
{
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_METER_EXCEED,DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_METER_EXCEED,ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
...
void dal_rtl9602c_learn_over_isr_entry(void)
{
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_LEARN_OVER,DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_LEARN_OVER,ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
...
void dal_rtl9602c_speed_change_isr_entry(void)
{
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_SPEED_CHANGE,DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_SPEED_CHANGE,ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
...
void dal_rtl9602c_special_congest_isr_entry(void)
{
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_SPECIAL_CONGEST,DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_SPECIAL_CONGEST,ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
...
void dal_rtl9602c_thermal_isr_entry(void)
{
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_THERMAL,DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_THERMAL,ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
...
void dal_rtl9602c_debug_isr_entry(void)
{
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_DEBUG,DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_DEBUG,ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
...
void dal_rtl9602c_crash_isr_entry(void)
{
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_SWITCH_ERROR,DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
    ...
    if((ret = dal_rtl9602c_intr_imr_set(INTR_TYPE_SWITCH_ERROR,ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret,(MOD_DAL|MOD_INTR), "");
        return ;
    }
