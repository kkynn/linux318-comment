...
static rtk_enable_t RTL8198F_L2_FLUSH_INTR = DISABLED;
...
dal_rtl8198f_l2_init(void)
{
    ...
    if((ret = dal_rtl8198f_l2_aging_set(RTK_L2_DEFAULT_AGING_TIME)) != RT_ERR_OK)
    {
...
dal_rtl8198f_l2_flushLinkDownPortAddrEnable_get(rtk_enable_t *pEnable)
{
    ...
    *pEnable = RTL8198F_L2_FLUSH_INTR;

    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_flushLinkDownPortAddrEnable_get */
...
dal_rtl8198f_l2_flushLinkDownPortAddrEnable_set(rtk_enable_t enable)
{
    ...
    if(RTL8198F_L2_FLUSH_INTR == DISABLED && enable == ENABLED)
    {
    ...
    if(RTL8198F_L2_FLUSH_INTR == ENABLED && enable == DISABLED)
    {
    ...
    RTL8198F_L2_FLUSH_INTR = enable;

    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_flushLinkDownPortAddrEnable_set */
...
dal_rtl8198f_l2_portLimitLearningCnt_get(rtk_port_t port, uint32 *pMacCnt)
{
    ...
    *pMacCnt = number;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_portLimitLearningCnt_get */
...
dal_rtl8198f_l2_portLimitLearningCnt_set(rtk_port_t port, uint32 macCnt)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_portLimitLearningCnt_set */
...
dal_rtl8198f_l2_portLimitLearningCntAction_get(rtk_port_t port, rtk_l2_limitLearnCntAction_t *pLearningAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_portLimitLearningCntAction_get */
...
dal_rtl8198f_l2_portLimitLearningCntAction_set(rtk_port_t port, rtk_l2_limitLearnCntAction_t learningAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_portLimitLearningCntAction_set */
...
dal_rtl8198f_l2_aging_get(uint32 *pAgingTime)
{
    ...
    *pAgingTime=time;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_aging_get */
...
dal_rtl8198f_l2_aging_set(uint32 agingTime)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_aging_set */
...
dal_rtl8198f_l2_portAgingEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_portAgingEnable_get */
...
dal_rtl8198f_l2_portAgingEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_portAgingEnable_set */
...
dal_rtl8198f_l2_lookupMissAction_get(rtk_l2_lookupMissType_t type, rtk_action_t *pAction)
{
    ...
    if((ret = dal_rtl8198f_l2_portLookupMissAction_get(0, type, pAction)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_lookupMissAction_get */
...
dal_rtl8198f_l2_lookupMissAction_set(rtk_l2_lookupMissType_t type, rtk_action_t action)
{
    ...
    {
        if ((ret = dal_rtl8198f_l2_portLookupMissAction_set(port, type, action)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return ret;
        }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_lookupMissAction_set */
...
} /* end of dal_rtl8198f_l2_portLookupMissAction_get */
...
} /* end of dal_rtl8198f_l2_portLookupMissAction_set */
        ...
        rtk_l2_addr_table_t     *pL2Entry)
{
    ...
    *pScanIdx= ((uint32)ca_entry.prev_handle )-1;//hit entry
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_nextValidEntry_get */
...
dal_rtl8198f_l2_addr_add(rtk_l2_ucastAddr_t *pL2Addr)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_addr_add */
...
dal_rtl8198f_l2_addr_del(rtk_l2_ucastAddr_t *pL2Addr)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_addr_del */
...
dal_rtl8198f_l2_addr_get(rtk_l2_ucastAddr_t *pL2Addr)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_addr_get */
...
dal_rtl8198f_l2_addr_delAll(uint32 includeStatic)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_addr_delAll */
    ...
    rtk_action_t        *pFwdAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_illegalPortMoveAction_get */
    ...
    rtk_action_t        fwdAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_l2_illegalPortMoveAction_set */
