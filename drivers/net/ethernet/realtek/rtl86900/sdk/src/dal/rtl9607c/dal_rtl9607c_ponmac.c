...
static int32 _rtl9607c_ponMacEponModeV1_set(void)
{
    ...
    /*mapping mpcp oam packet ot pbo high queue*/
    {
        ...
        {
            if ((ret = rtl9607c_raw_pbo_dsSidToQueueMap_set(streamId,RTL9607C_PBO_DSQUEUE_TYPE_HIGH)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_PONMAC|MOD_DAL), "");
                return ret;
            }
...
dal_rtl9607c_ponmac_opticalPolarity_get(rtk_ponmac_polarity_t *pPolarity)
{
    ...
    /* function body */
    if ((ret = reg_field_read(RTL9607C_WSDS_DIG_12r,RTL9607C_CFG_FRC_BEN_INVf,&val)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_PONMAC|MOD_DAL), "");
        return ret;
    }
...
dal_rtl9607c_ponmac_opticalPolarity_set(rtk_ponmac_polarity_t polarity)
{
    ...
    if ((ret = reg_field_write(RTL9607C_WSDS_DIG_12r,RTL9607C_CFG_FRC_BEN_INVf,&val)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_PONMAC|MOD_DAL), "");
        return ret;
    }
