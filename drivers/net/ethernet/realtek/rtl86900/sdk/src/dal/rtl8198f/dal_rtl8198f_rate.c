...
#define DAL_RTL8198F_STORM_UM_IDX         0
#define DAL_RTL8198F_STORM_UC_IDX         1
#define DAL_RTL8198F_STORM_MC_IDX         2
#define DAL_RTL8198F_STORM_BC_IDX         3
#define DAL_RTL8198F_STORM_DHCP_IDX       4
#define DAL_RTL8198F_STORM_ARP_IDX        5
#define DAL_RTL8198F_STORM_IGMP_MLD_IDX   6
#define DAL_RTL8198F_STORM_MAX_IDX        7
...
typedef struct dal_rtl8198f_storm_ctrl_s
{
    dal_rtl8198f_storm_entry_t entry[DAL_RTL8198F_STORM_MAX_IDX];
} dal_rtl8198f_storm_ctrl_t;
...
static dal_rtl8198f_storm_ctrl_t stormGlobalCfg;
    ...
    uint32                  *pIndex)
{
    ...
    {
        case STORM_GROUP_UNKNOWN_MULTICAST:
            groupIdx = DAL_RTL8198F_STORM_UM_IDX;
            *pIndex = stormCfg[port].umc_flow_id;
            break;
        case STORM_GROUP_BROADCAST:
            groupIdx = DAL_RTL8198F_STORM_BC_IDX;
            *pIndex = stormCfg[port].bc_flow_id;
            break;
        case STORM_GROUP_MULTICAST:
            groupIdx = DAL_RTL8198F_STORM_MC_IDX;
            *pIndex = stormCfg[port].mc_flow_id;
            break;
        case STORM_GROUP_DHCP:
            groupIdx = DAL_RTL8198F_STORM_DHCP_IDX;
            *pIndex = stormCfg[port].dhcp_flow_id;
            break;
        case STORM_GROUP_ARP:
            groupIdx = DAL_RTL8198F_STORM_ARP_IDX;
            *pIndex = stormCfg[port].arp_flow_id;
            break;
        case STORM_GROUP_IGMP_MLD:
            groupIdx = DAL_RTL8198F_STORM_IGMP_MLD_IDX;
    ...
    uint32                  index)
{
    ...
    switch(stormType)
    {
        ...
        case STORM_GROUP_BROADCAST:
            ...
            {
                if((ret=_dal_rtl8198f_use_ca_l2_flood_set(port,stormType,stormCfg[port].bc_enable,index)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_RATE | MOD_DAL), "");
                    return ret;
                }
    ...
    rtk_enable_t            enable)
{
    ...
    switch(stormType)
    {
        ...
        case STORM_GROUP_BROADCAST:
            ...
            {
                if((ret=_dal_rtl8198f_use_ca_l2_flood_set(port,stormType,enable,stormCfg[port].bc_flow_id)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_RATE | MOD_DAL), "");
                    return ret;
                }
...
/* Function Name:
 *      dal_rtl8198f_rate_stormControlEnable_get
 * Description:
 *      Get enable status of storm control on specified port.
 * Input:
 *      stormType  - storm group type
 ...
 */
int32
dal_rtl8198f_rate_stormControlEnable_get(rtk_rate_storm_group_ctrl_t  *stormCtrl)
{
    ...
    stormCtrl->unknown_unicast_enable  =stormGlobalCfg.entry[DAL_RTL8198F_STORM_UC_IDX].enable       ;
    stormCtrl->unknown_multicast_enable=stormGlobalCfg.entry[DAL_RTL8198F_STORM_UM_IDX].enable       ;
    stormCtrl->broadcast_enable        =stormGlobalCfg.entry[DAL_RTL8198F_STORM_BC_IDX].enable       ;
    stormCtrl->multicast_enable        =stormGlobalCfg.entry[DAL_RTL8198F_STORM_MC_IDX].enable       ;
    stormCtrl->dhcp_enable             =stormGlobalCfg.entry[DAL_RTL8198F_STORM_DHCP_IDX].enable     ;
    stormCtrl->arp_enable              =stormGlobalCfg.entry[DAL_RTL8198F_STORM_ARP_IDX].enable      ;
    stormCtrl->igmp_mld_enable         =stormGlobalCfg.entry[DAL_RTL8198F_STORM_IGMP_MLD_IDX].enable ;

    return RT_ERR_OK;
} /* end of dal_rtl8198f_rate_stormControlEnable_get */


/* Function Name:
 *      dal_rtl8198f_rate_stormControlEnable_set
 * Description:
 *      Set enable status of storm control on specified port.
 * Input:
 *      stormType  - storm group type
 ...
 */
int32
dal_rtl8198f_rate_stormControlEnable_set(rtk_rate_storm_group_ctrl_t  *stormCtrl)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_RATE),"%s",__FUNCTION__);
    ...
    memset(&stormGlobalCfg,0x0,sizeof(dal_rtl8198f_storm_ctrl_t));

    /*disable all strom control for all port*/

    stormGlobalCfg.entry[DAL_RTL8198F_STORM_UC_IDX].enable       = stormCtrl->unknown_unicast_enable;
    stormGlobalCfg.entry[DAL_RTL8198F_STORM_UM_IDX].enable       = stormCtrl->unknown_multicast_enable;
    stormGlobalCfg.entry[DAL_RTL8198F_STORM_BC_IDX].enable       = stormCtrl->broadcast_enable;
    stormGlobalCfg.entry[DAL_RTL8198F_STORM_MC_IDX].enable       = stormCtrl->multicast_enable;
    stormGlobalCfg.entry[DAL_RTL8198F_STORM_DHCP_IDX].enable     = stormCtrl->dhcp_enable;
    stormGlobalCfg.entry[DAL_RTL8198F_STORM_ARP_IDX].enable      = stormCtrl->arp_enable;
    stormGlobalCfg.entry[DAL_RTL8198F_STORM_IGMP_MLD_IDX].enable = stormCtrl->igmp_mld_enable;

    return RT_ERR_OK;
} /* end of dal_rtl8198f_rate_stormControlEnable_set */
