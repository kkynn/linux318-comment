...
#include <rtk/rldp.h>
#include <dal/rtl9603d/dal_rtl9603d_rldp.h>
 ...
 * Data Declaration
 */
static uint32    rtl9603d_rldp_init = {INIT_NOT_COMPLETED}; 
...
dal_rtl9603d_rldp_init(void)
{
    ...
    rtl9603d_rldp_init = INIT_COMPLETED;
    ...
    config.num_loop = 4;
    if ((ret = dal_rtl9603d_rldp_config_set(&config)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_RLDP|MOD_DAL), "");
        rtl9603d_rldp_init = INIT_NOT_COMPLETED;
        return ret;
    }
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        ...
        {
            if ((ret = dal_rtl9603d_rldp_portConfig_set(port, &portConfig)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_RLDP|MOD_DAL), "");
                rtl9603d_rldp_init = INIT_NOT_COMPLETED;
                return ret;
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        if(HAL_IS_RLDP_PORT(port))
        {
            if ((ret = dal_rtl9603d_rldp_portStatus_clear(port, &portStatus)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_RLDP|MOD_DAL), "");
                rtl9603d_rldp_init = INIT_NOT_COMPLETED;
                return ret;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_init */


/* Function Name:
 *      dal_rtl9603d_rldp_config_set
 * Description:
 ...
 */
int32
dal_rtl9603d_rldp_config_set(rtk_rldp_config_t *pConfig)
{
    int32   ret;
    uint32 tmp[2];
    uint32 val;
    ...
    /* check Init status */
    RT_INIT_CHK(rtl9603d_rldp_init);
    ...
    RT_PARAM_CHK((RTL9603D_RLDP_INTERVAL_MAX < pConfig->interval_check), RT_ERR_INPUT);
    RT_PARAM_CHK((RTL9603D_RLDP_NUM_MAX < pConfig->num_check), RT_ERR_INPUT);	
    RT_PARAM_CHK((RTL9603D_RLDP_INTERVAL_MAX < pConfig->interval_loop), RT_ERR_INPUT);
    RT_PARAM_CHK((RTL9603D_RLDP_NUM_MAX < pConfig->num_loop), RT_ERR_INPUT);

    val = pConfig->rldp_enable;
    if ((ret = reg_field_write(RTL9603D_RLDP_CTRL_1r, RTL9603D_ENf, &val)) != RT_ERR_OK)
    {
    ...
    val = pConfig->fc_mode;
    if ((ret = reg_field_write(RTL9603D_RLDP_CTRL_0r, RTL9603D_ACT_RUNOUTDSCf, &val)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_RLDP), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_config_set */


/* Function Name:
 *      dal_rtl9603d_rldp_config_get
 * Description:
    ...
    rtk_rldp_config_t *pConfig)
{
    ...
    if ((ret = reg_field_read(
                    RTL9603D_RLDP_CTRL_1r,
                    RTL9603D_ENf, &val)) != RT_ERR_OK) {
    ...
    if ((ret = reg_field_read(
                    RTL9603D_RLDP_CTRL_0r,
                    RTL9603D_ACT_RUNOUTDSCf, &val)) != RT_ERR_OK) {
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_config_get */


/* Function Name:
 *      dal_rtl9603d_rldp_portConfig_set
 * Description:
    ...
    rtk_rldp_portConfig_t *pPortConfig)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_portConfig_set */

/* Function Name:
 *      dal_rtl9603d_rldp_portConfig_get
 * Description:
 ...
 */
int32
dal_rtl9603d_rldp_portConfig_get(rtk_port_t port, rtk_rldp_portConfig_t *pPortConfig)
{
    int32 ret;
    uint32 val;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_portConfig_get */


/* Function Name:
 *      dal_rtl9603d_rldp_status_get
 * Description:
 ...
 */
int32
dal_rtl9603d_rldp_status_get(rtk_rldp_status_t *pStatus)
{
    int32   ret;
    uint32 tmp[2];
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_status_get */


/* Function Name:
 *      dal_rtl9603d_rldp_portStatus_get
 * Description:
 *      Get RLDP module status
 * Input:
 *      port    - port number to be get
    ...
    rtk_rldp_portStatus_t *pPortStatus)
{
    ...
    if ((ret = reg_array_field_read(
                    RTL9603D_RLDP_PORT_LP_ENTER_STSr,
                    port,
                    REG_ARRAY_INDEX_NONE,
                    RTL9603D_STSf,
                    &val)) != RT_ERR_OK) {
    ...
    if ((ret = reg_array_field_read(
                    RTL9603D_RLDP_PORT_LP_LEAVE_STSr,
                    port,
                    REG_ARRAY_INDEX_NONE,
                    RTL9603D_STSf,
                    &val)) != RT_ERR_OK) {
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_portStatus_get */
 ...
 *          Name:
 *
 *                  dal_rtl9603d_rldp_portStatus_clear
 * Description
 *          :
 *      Clear
    ...
    rtk_rldp_portStatus_t *pPortStatus)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_rldp_portStatus_clear */
