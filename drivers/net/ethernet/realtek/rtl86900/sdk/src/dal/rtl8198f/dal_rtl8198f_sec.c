...
int32 _dal_rtl8198f_synfin_deny_classification_add(rtk_port_t port,rtk_action_t rtk_action,ca_uint32_t *pIndex)
{
...
int32 _dal_rtl8198f_synfin_deny_classification_delete(ca_uint32_t index)
{
    ca_status_t ret=CA_E_OK;
...
int32 _dal_rtl8198f_icmp_flood_classification_add(rtk_port_t port,rtk_action_t rtk_action,uint32 floodThresh,ca_uint32_t *pIndex)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
...
int32 _dal_rtl8198f_icmp_flood_classification_delete(ca_uint32_t index)
{
    ca_status_t ret=CA_E_OK;
...
int32 _dal_rtl8198f_syn_flood_classification_add(rtk_port_t port,rtk_action_t rtk_action,uint32 floodThresh,ca_uint32_t *pIndex)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_policer_t policer;
...
int32 _dal_rtl8198f_syn_flood_classification_delete(ca_uint32_t index)
{
    ca_status_t ret=CA_E_OK;
...
int32 _dal_rtl8198f_fin_flood_classification_add(rtk_port_t port,rtk_action_t rtk_action,uint32 floodThresh,ca_uint32_t *pIndex)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_policer_t policer;
...
int32 _dal_rtl8198f_fin_flood_classification_delete(ca_uint32_t index)
{
    ca_status_t ret=CA_E_OK;
...
dal_rtl8198f_sec_portAttackPreventState_set(rtk_port_t port, rtk_enable_t enable)
{
    ...
    if((atkPrvt[port].enable == DISABLED)&&(enable == ENABLED)) //DISABLE -> ENABLE
    {
        ...
        {
            if((ret = _dal_rtl8198f_synfin_deny_classification_add(port,SYNFIN_DENY_ACTION,&index)) != RT_ERR_OK)
            {
        ...
        {
            if((ret = _dal_rtl8198f_icmp_flood_classification_add(port,ICMP_FLOOD_ACTION,ICMP_FLOOD_TH,&index)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        {
            if((ret = _dal_rtl8198f_syn_flood_classification_add(port,SYN_FLOOD_ACTION,SYN_FLOOD_TH,&index)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        {
            if((ret = _dal_rtl8198f_fin_flood_classification_add(port,FIN_FLOOD_ACTION,FIN_FLOOD_TH,&index)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
    ...
    else if((atkPrvt[port].enable == ENABLED)&&(enable == DISABLED)) //ENABLE -> DISABLE
    {
        if(SYNFIN_DENY_ACTION != ACTION_FORWARD)
        {
            if((ret = _dal_rtl8198f_synfin_deny_classification_delete(atkPrvt[port].synfin_deny_index)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        if(ICMP_FLOOD_ACTION != ACTION_FORWARD)
        {
            if((ret = _dal_rtl8198f_icmp_flood_classification_delete(atkPrvt[port].icmp_flood_index)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        if(SYN_FLOOD_ACTION != ACTION_FORWARD)
        {
            if((ret = _dal_rtl8198f_syn_flood_classification_delete(atkPrvt[port].syn_flood_index)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        if(FIN_FLOOD_ACTION != ACTION_FORWARD)
        {
            if((ret = _dal_rtl8198f_fin_flood_classification_delete(atkPrvt[port].fin_flood_index)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        case SYNFIN_DENY:
            if((SYNFIN_DENY_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    ...
                    {
                        if((ret = _dal_rtl8198f_synfin_deny_classification_add(port,action,&index)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
        ...
        case ICMPFLOOD_DENY:
            ...
            if((ICMP_FLOOD_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        if((ret = _dal_rtl8198f_icmp_flood_classification_add(port,action,ICMP_FLOOD_TH,&index)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
        ...
        case SYNFLOOD_DENY:
            ...
            if((SYN_FLOOD_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        if((ret = _dal_rtl8198f_syn_flood_classification_add(port,action,SYN_FLOOD_TH,&index)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
        ...
        case FINFLOOD_DENY:
            ...
            if((FIN_FLOOD_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        if((ret = _dal_rtl8198f_fin_flood_classification_add(port,action,FIN_FLOOD_TH,&index)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
            ...
            if((ICMP_FLOOD_ACTION != ACTION_FORWARD) && (ICMP_FLOOD_TH != floodThresh))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        ...
                        if((ret = _dal_rtl8198f_icmp_flood_classification_add(port,ICMP_FLOOD_ACTION,floodThresh,&index)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
            ...
            if((SYN_FLOOD_ACTION != ACTION_FORWARD) && (SYN_FLOOD_TH != floodThresh))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        ...
                        if((ret = _dal_rtl8198f_syn_flood_classification_add(port,SYN_FLOOD_ACTION,floodThresh,&index)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
            ...
            if((FIN_FLOOD_ACTION != ACTION_FORWARD) && (FIN_FLOOD_TH != floodThresh))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        ...
                        if((ret = _dal_rtl8198f_fin_flood_classification_add(port,FIN_FLOOD_ACTION,floodThresh,&index)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
