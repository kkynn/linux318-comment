...
#include <dal/rtl9603d/dal_rtl9603d_mirror.h>
...
dal_rtl9603d_mirror_init(void)
{
    ...
    if( (ret = dal_rtl9603d_mirror_portBased_set(HAL_GET_CPU_PORT(), &rx_portmask, &tx_portmask)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_MIRROR), "");
        return ret;
    }

    if( (ret = dal_rtl9603d_mirror_portIso_set(DISABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_MIRROR), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_mirror_init */

/* Module Name    : Mirror            */
/* Sub-module Name: Port-based mirror */

/* Function Name:
 *      dal_rtl9603d_mirror_portBased_set
 * Description:
 ...
 */
int32
dal_rtl9603d_mirror_portBased_set(rtk_port_t mirroringPort, rtk_portmask_t *pMirroredRxPortmask, rtk_portmask_t *pMirroredTxPortmask)
{
    int32   ret;
    ...
    if ((ret = reg_field_write(RTL9603D_MIR_CTRLr, RTL9603D_MIR_MONITOR_PORTf, &monitor_port)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }

    if ((ret = reg_field_write(RTL9603D_MIR_CTRLr, RTL9603D_MIR_RXf, &mirror_rx)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }

    if ((ret = reg_field_write(RTL9603D_MIR_CTRLr, RTL9603D_MIR_TXf, &mirror_tx)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }

    if ((ret = reg_field_write(RTL9603D_MIR_CTRLr, RTL9603D_MIR_SRC_PMSKf, &(mirrored_portmask.bits[0]))) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_mirror_portBased_set */

/* Function Name:
 *      dal_rtl9603d_mirror_portBased_get
 * Description:
 ...
 */
int32
dal_rtl9603d_mirror_portBased_get(rtk_port_t *pMirroringPort, rtk_portmask_t *pMirroredRxPortmask, rtk_portmask_t *pMirroredTxPortmask)
{
    int32   ret;
    ...
    if ((ret = reg_field_read(RTL9603D_MIR_CTRLr, RTL9603D_MIR_MONITOR_PORTf, &monitor_port)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }

    if ((ret = reg_field_read(RTL9603D_MIR_CTRLr, RTL9603D_MIR_RXf, &mirror_rx)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }

    if ((ret = reg_field_read(RTL9603D_MIR_CTRLr, RTL9603D_MIR_TXf, &mirror_tx)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }

    if ((ret = reg_field_read(RTL9603D_MIR_CTRLr, RTL9603D_MIR_SRC_PMSKf, &mirrored_portmask)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }
    ...
    *pMirroringPort = monitor_port;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_mirror_portBased_get */

/* Function Name:
 *      dal_rtl9603d_mirror_portIso_set
 * Description:
 ...
 */
int32
dal_rtl9603d_mirror_portIso_set(rtk_enable_t enable)
{
    int32   ret;
    ...
    if ((ret = reg_field_write(RTL9603D_MIR_CTRLr, RTL9603D_MIR_ISOf, (uint32 *)&enable)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_mirror_portIso_set */

/* Function Name:
 *      dal_rtl9603d_mirror_portIso_get
 * Description:
 ...
 */
int32
dal_rtl9603d_mirror_portIso_get(rtk_enable_t *pEnable)
{
    int32   ret;
    ...
    if ((ret = reg_field_read(RTL9603D_MIR_CTRLr, RTL9603D_MIR_ISOf, (uint32 *)pEnable)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_TRAP), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9603d_mirror_portIso_get */
