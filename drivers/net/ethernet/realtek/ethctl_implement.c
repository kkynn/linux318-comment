...
void eth_ctl(struct eth_arg * arg){
	...
	switch(cmd1){
		...
		#endif
		case 9:
		    	gpioConfig(cmd2, GPIO_FUNC_INPUT);
			printk("GPIO %u = %d\n", cmd2, gpioRead(cmd2));
			break;	
		case 10:  //GPIO test
		...
		case 14: {
		#if !defined(CONFIG_RTL9607C)	//shlee 8672	
	   ...
	   case 16:
        ...
        case 54://change nas0 carrier
            ...
            break;
#ifdef CONFIG_RTK_HOST_SPEEDUP
		case 55://get hostspeedup stream stats
			{
				...
				arg->cmd2 = HostSpeedUP_Stat_get(dip, sip, dport, sport);
			}
			break;
#endif
		default:
