 ...
 *	re8686_rtl9602c.h
*/
#ifndef _RE8686_RTL9602C_H_
#define _RE8686_RTL9602C_H_
...
#define RE8670_RX_RING6_SIZE 64
#endif
...
#define RE8670_TX_RING3_SIZE 64
#define RE8670_TX_RING4_SIZE 0
#define RE8670_TX_RING5_SIZE 64
#else
#define RE8670_TX_RING2_SIZE 64
#define RE8670_TX_RING3_SIZE 64
#define RE8670_TX_RING4_SIZE 64
#define RE8670_TX_RING5_SIZE 64
#endif
...
struct rx_info{
	...
	union{
		struct{
			u32 src_port_num:4;//27~31
			u32 dst_port_mask:7;//21~26
			u32 reason:8;//13~20
...
#define GMAC_RXINFO_PKTTYPE(x)              (((struct rx_info *)x)->opts1.bit.pkttype)
#define GMAC_RXINFO_L3ROUTING(x)            (((struct rx_info *)x)->opts1.bit.l3routing)
#define GMAC_RXINFO_ORIGFORMAT(x)           (((struct rx_info *)x)->opts1.bit.origformat)
#define GMAC_RXINFO_PCTRL(x)                (((struct rx_info *)x)->opts1.bit.pctrl)
...
#define GMAC_RXINFO_PON_STREAM_ID(x)        (((struct rx_info *)x)->opts2.bit.pon_stream_id)
...
#define GMAC_RXINFO_DST_PORT_MASK(x)        (((struct rx_info *)x)->opts3.bit.dst_port_mask)
#define GMAC_RXINFO_REASON(x)               (((struct rx_info *)x)->opts3.bit.reason)
#define GMAC_RXINFO_INTERNAL_PRIORITY(x)    (((struct rx_info *)x)->opts3.bit.internal_priority)
#define GMAC_RXINFO_EXT_PORT_TTL_1(x)       (((struct rx_info *)x)->opts3.bit.ext_port_ttl_1)
...
#define GMAC_TXINFO_KEEP(x)                 (((struct tx_info *)x)->opts1.bit.keep)
#define GMAC_TXINFO_BLU(x)                  (((struct tx_info *)x)->opts1.bit.blu)
#define GMAC_TXINFO_CRC(x)                  (((struct tx_info *)x)->opts1.bit.crc)
#define GMAC_TXINFO_VSEL(x)                 (((struct tx_info *)x)->opts1.bit.vsel)
#define GMAC_TXINFO_DISLRN(x)               (((struct tx_info *)x)->opts1.bit.dislrn)
#define GMAC_TXINFO_CPUTAG_IPCS(x)          (((struct tx_info *)x)->opts1.bit.cputag_ipcs)
#define GMAC_TXINFO_CPUTAG_L4CS(x)          (((struct tx_info *)x)->opts1.bit.cputag_l4cs)
#define GMAC_TXINFO_CPUTAG_PSEL(x)          (((struct tx_info *)x)->opts1.bit.cputag_psel)
...
#define GMAC_TXINFO_ASPRI(x)                (((struct tx_info *)x)->opts2.bit.aspri)
#define GMAC_TXINFO_CPUTAG_PRI(x)           (((struct tx_info *)x)->opts2.bit.cputag_pri)
#define GMAC_TXINFO_TX_VLAN_ACTION(x)       (((struct tx_info *)x)->opts2.bit.tx_vlan_action)
#define GMAC_TXINFO_TX_PPPOE_ACTION(x)      (((struct tx_info *)x)->opts2.bit.tx_pppoe_action)
#define GMAC_TXINFO_TX_PPPOE_IDX(x)         (((struct tx_info *)x)->opts2.bit.tx_pppoe_idx)
#define GMAC_TXINFO_EFID(x)                 (((struct tx_info *)x)->opts2.bit.efid)
#define GMAC_TXINFO_ENHANCE_FID(x)          (((struct tx_info *)x)->opts2.bit.enhance_fid)
#define GMAC_TXINFO_VIDL(x)                 (((struct tx_info *)x)->opts2.bit.vidl)
#define GMAC_TXINFO_PRIO(x)                 (((struct tx_info *)x)->opts2.bit.prio)
#define GMAC_TXINFO_CFI(x)                  (((struct tx_info *)x)->opts2.bit.cfi)
#define GMAC_TXINFO_VIDH(x)                 (((struct tx_info *)x)->opts2.bit.vidh)

#define GMAC_TXINFO_EXTSPA(x)               (((struct tx_info *)x)->opts3.bit.extspa)
#define GMAC_TXINFO_TX_PMASK(x)             (((struct tx_info *)x)->opts3.bit.tx_portmask)
#define GMAC_TXINFO_TX_DST_STREAM_ID(x)     (((struct tx_info *)x)->opts3.bit.tx_dst_stream_id)
#define GMAC_TXINFO_SB(x)                   (((struct tx_info *)x)->opts3.bit.sb)
#define GMAC_TXINFO_L34_KEEP(x)             (((struct tx_info *)x)->opts3.bit.l34_keep)
#define GMAC_TXINFO_PTP(x)                  (((struct tx_info *)x)->opts3.bit.ptp)
