...
)
{
	...
	if (ODMPTR->support_ic_type & (ODM_RTL8812 | ODM_RTL8881A | ODM_RTL8814A | ODM_RTL8822B))
	...
	if ((priv->up_time % 3) == 0)  {
		int disable_pwr_ctrl = ((ODMPTR->false_alm_cnt.cnt_all > 1000) || ((ODMPTR->false_alm_cnt.cnt_all > 300) && ((RTL_R8(0xc50) & 0x7f) >= 0x32))) ? 1 : 0;
