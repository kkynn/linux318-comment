...
#define DRV_VERSION_SUBL	2
#endif

#define DRV_RELDATE		"2018-05-25"
...
// Support Tx AMSDU
//-------------------------------------------------------------
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8192FE)
...
// Support Rx AMSDU
//-------------------------------------------------------------
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8821CE) || defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8192FE)
...
//-------------------------------------------------------------
#if !defined(CONFIG_RTL8196B_GW_8M) && !defined(CONFIG_WIRELESS_LAN_MODULE) && !defined(WIFI_LIMITED_MEM) && !defined(__OSK__) && !defined(NOT_RTK_BSP)
#define PRIV_STA_BUF
#endif
...
//-------------------------------------------------------------
//Detect special test environment (Veriwave or testcenter)
//-------------------------------------------------------------
...
#if defined(STA_CONTROL_ALGO3) && (STA_CONTROL_ALGO == STA_CONTROL_ALGO3)
...
#if defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8821CE) /*eric-8822 ??*/
...
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8197F) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8821CE)
...
#else
// Note: WLAN_HAL_TX_AMSDU_MAX_NUM must be the same as MAX_NUM_OF_MSDU_IN_AMSDU in WlanHAL !!!
#define WLAN_HAL_TX_AMSDU_MAX_NUM   16  // 4  // recommended value: 4, 6, 8, 
#define WLAN_HAL_TX_AMSDU_NUM       16 // 4  // priv->pmib->dot11nConfigEntry.dot11nAMSDUSendNum
#endif
...
#define dybw_thrd	3
    ...
    #define NUM_RX_DESC		320	//256
        ...
        #elif (defined(CONFIG_WLAN_HAL_8814AE) && defined(CONFIG_RTL_8198C)) || defined(CONFIG_WLAN_HAL_8822BE)|| defined(CONFIG_WLAN_HAL_8821CE)
...
#elif (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8822BE)) || (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8821CE))
...
// Tansit band of associated STAs using 11v BTM or forced disassociation
#ifdef STA_CONTROL
...
/*adjusted for support AMSDU*/
    ...
    #ifdef RX_BUFFER_GATHER
        #ifdef __LINUX_2_6__
            #if (defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8192FE)) && defined(SUPPORT_RX_AMSDU_AMPDU) && (!defined(WIFI_BUFFER_LIMITED))
...
#if (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8822BE)) ||(defined(CONFIG_WLAN_HAL_8197F)&& defined(CONFIG_WLAN_HAL_8821CE))
#ifdef __ECOS
...
#else
	#define MAX_RX_BUF_LEN_1 8800  // wlan1 92E
	#define MIN_RX_BUF_LEN_1 8800 // wlan1 92E
#endif
    #undef MAX_RX_BUF_LEN
    #undef MIN_RX_BUF_LEN
...
#if CONFIG_BAND_2G_ON_WLAN0 && (!defined(CONFIG_ARCH_CORTINA_G3) && !defined(CONFIG_ARCH_CORTINA_G3HGU))
	#define WLANIDX	1
#else
	#define WLANIDX	0
#endif
