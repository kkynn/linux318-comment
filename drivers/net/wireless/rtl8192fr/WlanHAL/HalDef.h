...
typedef enum _HW_VARIABLES{
...
#if defined(PWR_BY_RATE_92E_HP) || defined(WLAN_REG_FW_RAM_REFINE)			
...
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(WLAN_REG_FW_RAM_REFINE)	
...
#if defined(BEAMFORMING_AUTO) || defined(WLAN_REG_FW_RAM_REFINE) 		
        ...
        HW_VAR_PS_TIMER,
#if defined(CFG_HAL_MACDM) || defined(WLAN_REG_FW_RAM_REFINE)
//3 MACDM
        //Default
...
#if (IS_RTL8814A_SERIES || IS_RTL8192F_SERIES)
...
#define IS_HARDWARE_TYPE_MAC_V2(_Adapter)	    (IS_HARDWARE_TYPE_8814A(_Adapter)|| IS_HARDWARE_TYPE_8197F(_Adapter)|| IS_HARDWARE_TYPE_8822B(_Adapter) || IS_HARDWARE_TYPE_8821C(_Adapter))
#define IS_HARDWARE_MACHAL_SUPPORT(_Adapter)	(IS_HARDWARE_TYPE_8821C(_Adapter)|| IS_HARDWARE_TYPE_8822B(_Adapter))
...
#define IS_HARDWARE_TYPE_8192F(_Adapter)	(IS_HARDWARE_TYPE_8192FE(_Adapter))
