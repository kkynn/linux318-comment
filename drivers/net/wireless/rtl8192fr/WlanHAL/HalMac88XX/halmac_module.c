...
HALMAC_API_ARG api_arg_table[HALMAC_API_MAX] = {
		...
		{HALMAC_API_INTF_INTEGRA_TUNING, 1, {TLP_TYPE_PHALMAC_INTF_INTGRA} },
...
)
{
	...
	case HALMAC_API_SWITCH_EFUSE_BANK:
		if (halmac_obj->version >= HALMAC_VERSION(1, 2, 0))
			state = halmac_obj->halmac_api_entry->halmac_switch_efuse_bank(halmac_obj->halmac_adapter, *((HALMAC_EFUSE_BANK *)arg_list[0].ptr));
		break;
	case HALMAC_API_WRITE_EFUSE_BT:
		if (halmac_obj->version >= HALMAC_VERSION(1, 2, 0))
			state = halmac_obj->halmac_api_entry->halmac_write_efuse_bt(halmac_obj->halmac_adapter, *((u32 *)arg_list[0].ptr), *((u8 *)arg_list[1].ptr), *((HALMAC_EFUSE_BANK *)arg_list[2].ptr));
		break;
	...
	case HALMAC_API_INTF_INTEGRA_TUNING:
		if (halmac_obj->version >= HALMAC_VERSION(1, 3, 0))
			state = halmac_obj->halmac_api_entry->halmac_interface_integration_tuning(halmac_obj->halmac_adapter, (PHALMAC_INTF_INTGRA)arg_list[0].ptr);
		break;
	...
	case HALMAC_API_READ_FLASH:
		if (halmac_obj->version >= HALMAC_VERSION(1, 3, 7))
			state = halmac_obj->halmac_api_entry->halmac_read_flash(halmac_obj->halmac_adapter, *((u32 *)arg_list[0].ptr));
		break;
	...
	case HALMAC_API_CFG_PINMUX_GET_FUNC:
		if (halmac_obj->version >= HALMAC_VERSION(1, 3, 8))
			state = halmac_obj->halmac_api_entry->halmac_pinmux_get_func(halmac_obj->halmac_adapter, *((HALMAC_GPIO_FUNC *)arg_list[0].ptr), (u8 *)arg_list[1].ptr);
		break;
	case HALMAC_API_CFG_PINMUX_SET_FUNC:
		if (halmac_obj->version >= HALMAC_VERSION(1, 3, 8))
			state = halmac_obj->halmac_api_entry->halmac_pinmux_set_func(halmac_obj->halmac_adapter, *((HALMAC_GPIO_FUNC *)arg_list[0].ptr));
		break;
	case HALMAC_API_CFG_PINMUX_FREE_FUNC:
		if (halmac_obj->version >= HALMAC_VERSION(1, 3, 8))
			state = halmac_obj->halmac_api_entry->halmac_pinmux_free_func(halmac_obj->halmac_adapter, *((HALMAC_GPIO_FUNC *)arg_list[0].ptr));
		break;
	case HALMAC_API_CFG_PINMUX_WL_LED_MODE:
		if (halmac_obj->version >= HALMAC_VERSION(1, 3, 8))
			state = halmac_obj->halmac_api_entry->halmac_pinmux_wl_led_mode(halmac_obj->halmac_adapter, *((HALMAC_WLLED_MODE *)arg_list[0].ptr));
		break;
...
)
{
	...
	case HALMAC_API_DUMP_EFUSE_MAP_BT:
		if (halmac_obj->version >= HALMAC_VERSION(1, 2, 0))
			state = halmac_obj->halmac_api_entry->halmac_dump_efuse_map_bt(halmac_obj->halmac_adapter, *((HALMAC_EFUSE_BANK *)arg_list[0].ptr), arg_list[1].length, (u8 *)arg_list[1].ptr);
		break;
#endif
#if (HALMAC_VERSION(1, 3, 0) <= HALMAC_CURRENT_VERSION)
	...
	case HALMAC_API_READ_EFUSE_BT:
		if (halmac_obj->version >= HALMAC_VERSION(1, 3, 7))
			state = halmac_obj->halmac_api_entry->halmac_read_efuse_bt(halmac_obj->halmac_adapter, *((u32 *)arg_list[0].ptr), (u8 *)arg_list[1].ptr, *((HALMAC_EFUSE_BANK *)arg_list[2].ptr));
		break;
#endif
	default:
