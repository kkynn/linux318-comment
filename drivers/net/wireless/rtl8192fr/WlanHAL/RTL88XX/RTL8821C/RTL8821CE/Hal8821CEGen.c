	...
	)
{
	...
	if (pDM_Odm->RFType == RF_2T2R) { /*2T2R*/
		ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s: RFType is 2T2R\n", __func__));
	...
	)
{
	...
	ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("[%s] BFerBFeeIdx=%d, BFerIdx=%d, BFeeIdx=%d\n", __func__, BFerBFeeIdx, BFerIdx, BFeeIdx));
	/*************SU BFer Entry Init*************/
	if ((pBeamformingInfo->beamformer_su_cnt > 0) && (BFerIdx < BEAMFORMER_ENTRY_NUM)) {
		ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("[%s]SU BFer Entry Init\n", __func__));
	...
	if ((pBeamformingInfo->beamformee_su_cnt > 0) && (BFeeIdx < BEAMFORMEE_ENTRY_NUM)) {
		ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("[%s]SU BFee Entry Init\n", __func__));
	...
	if ((pBeamformingInfo->beamformer_mu_cnt > 0) && (BFerIdx < BEAMFORMER_ENTRY_NUM)) {
		ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("[%s]MU BFer Entry Init\n", __func__));
		pBeamformerEntry = &pBeamformingInfo->BeamformerEntry[BFerIdx];
		pBeamformerEntry->HwState = BEAMFORM_ENTRY_HW_STATE_ADDING;
	...
	if ((pBeamformingInfo->beamformee_mu_cnt > 0) && (BFeeIdx < BEAMFORMEE_ENTRY_NUM)) {
		ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("[%s]MU BFee Entry Init, RegMUTxCtrl=0x%x\n", __func__, pBeamformingInfo->RegMUTxCtrl));
		pBeamformeeEntry = &pBeamformingInfo->BeamformeeEntry[BFeeIdx];
		pBeamformeeEntry->HwState = BEAMFORM_ENTRY_HW_STATE_ADDING;
		...
		ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("@%s, RegMUTxCtrl = 0x%x, user_position_l = 0x%x, user_position_h = 0x%x\n", 
...
#if 1
		{
			...
			ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("@%s, MacId = %d, ctrl_info_offset = 0x%x, mu_reg_index = %x\n", 
	...
	)
{
	...
	if(pSoundingInfo->State == SOUNDING_STATE_SU_SOUNDDOWN) {
		...
		ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("@%s, BeamformEntry.BeamformEntryState = %d", __func__, pBeamformEntry->BeamformEntryState));
		...
		if (pBeamformEntry->BeamformEntryState == BEAMFORMING_ENTRY_STATE_PROGRESSED) {
			...
			ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("@%s, Don't apply Vmatrix",  __func__));
			BeamCtrlVal &= ~(BIT9|BIT10|BIT11);
		}
		...
		//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("@%s, MU Sounding Done\n",  __func__));
		/*MU sounding done */
		if (1){//(pBeamformEntry->BeamformEntryState == BEAMFORMING_ENTRY_STATE_PROGRESSED) {
			//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_TRACE, ("@%s, BEAMFORMING_ENTRY_STATE_PROGRESSED\n",  __func__));
			...
			//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("@%s, is_sounding_success STA1:%d,  STA2:%d, STA3:%d, STA4:%d, STA5:%d, STA6:%d\n", 
...
#else
				//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s, ptcl_gen_mu_cnt = %d\n",  __func__, ptcl_gen_mu_cnt));
				//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s, wmac_tx_mu_cnt = %d\n",  __func__, wmac_tx_mu_cnt));
				//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s, wmac_rx_mu_ba_ok_cnt = %d\n",  __func__, wmac_rx_mu_ba_ok_cnt));
				//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s, wmac_tx_bar_cnt = %d\n",  __func__, wmac_tx_bar_cnt));
				//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s, wmac_rx_sta2_ba_ok_cnt = %d\n",  __func__, wmac_rx_sta2_ba_ok_cnt));
				//ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s, mu2su_tx_cnt = %d\n\n\n",  __func__, mu2su_tx_cnt));
#endif
	...
	)
{
	...
	ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s==>\n", __func__));
	...
	ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s: STA0: gid_valid = 0x%x, user_position_l = 0x%x, user_position_h = 0x%x\n",
	...
	ODM_RT_TRACE(pDM_Odm, DBG_TXBF, ODM_DBG_LOUD, ("%s: STA1: gid_valid = 0x%x, user_position_l = 0x%x, user_position_h = 0x%x\n",
		__func__, gid_valid, user_position_l, user_position_h));
