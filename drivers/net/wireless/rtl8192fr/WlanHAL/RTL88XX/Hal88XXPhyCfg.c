...
#if IS_RTL8814A_SERIES || IS_RTL8821C_SERIES	
		if(IS_HARDWARE_TYPE_8814A(Adapter) || IS_HARDWARE_TYPE_8821C(Adapter)){
...
)
{
	...
	case CHANNEL_WIDTH_20:
		...
		if (GET_CHIP_VER(Adapter) == VERSION_8192F)
			config_phydm_dfir_setting_8192f(&Adapter->pshare->_dmODM);
#endif
...
#endif //(IS_RTL8814A_SERIES || IS_RTL8197F_SERIES || IS_RTL8822B_SERIES || IS_RTL8821C_SERIES)
