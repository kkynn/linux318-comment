...
#if (IS_RTL8192E_SERIES || IS_RTL8192F_SERIES || IS_RTL8814A_SERIES || IS_RTL8822B_SERIES || IS_RTL8821C_SERIES)
		if ( IS_HARDWARE_TYPE_8192E(Adapter) || IS_HARDWARE_TYPE_8192F(Adapter) || IS_HARDWARE_TYPE_8814A(Adapter)|| IS_HARDWARE_TYPE_8822B(Adapter) || IS_HARDWARE_TYPE_8821C(Adapter) ) {
        ...
        if ( IS_HARDWARE_TYPE_8197F(Adapter) ) {
...
#endif				
			{
				if(HAL_RFE_TYPE == 0){
					...
					*((unsigned long*)(val)) = (unsigned long)(data_PHY_REG_PG_8197Fmp_Type6_start);							
				}else{
					printk("[%s][PHY_REG_PG_8197Fmp]\n",__FUNCTION__);
          				*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8197Fmp_start;
				}
			...
			*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8822B_start;
			...
			if(HAL_VAR_use_ext_pa){
				if(HAL_RFE_TYPE == 1){
					...
					*((unsigned long*)(val)) = (unsigned long)(data_PHY_REG_PG_8822Bmp_Type4_start);
				}else if(HAL_RFE_TYPE == 6){
					...
					*((unsigned long*)(val)) = (unsigned long)(data_PHY_REG_PG_8822Bmp_Type11_start);
				}else {
...
#endif				
			{
				if(HAL_RFE_TYPE == 0){
					...
					*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8822Bmp_Type8_start;
				}else if(HAL_RFE_TYPE == 9){
					panic_printk("[%s][PHY_REG_PG_8822Bmp_Type9\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8822Bmp_Type9_start;
				}else if(HAL_RFE_TYPE == 10){
					panic_printk("[%s][PHY_REG_PG_8822Bmp_Type10\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8822Bmp_Type10_start;
				}else if(HAL_RFE_TYPE == 13){
					panic_printk("[%s][PHY_REG_PG_8822Bmp_Type13\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8822Bmp_Type13_start;
				}else if(HAL_RFE_TYPE == 14){
					panic_printk("[%s][PHY_REG_PG_8822Bmp_Type14\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8822Bmp_Type14_start;
				}else{
					panic_printk("[%s][PHY_REG_PG_8822Bmp]\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_PHY_REG_PG_8822Bmp_start;
				}
		...
		if ( IS_HARDWARE_TYPE_8197F(Adapter) ) {
...
#endif				
			{
				if(HAL_RFE_TYPE == 0){
					...
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8197Fmp_Type6_start;
				}else{
					panic_printk("[TXPWR_LMT_8197Fmp]\n");
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8197Fmp_start;
				}
		...
		if ( IS_HARDWARE_TYPE_8822B(Adapter) ) {
			...
			if(HAL_VAR_use_ext_pa){
				if(HAL_RFE_TYPE == 1){
					...
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_Type4_start;
				}else if(HAL_RFE_TYPE == 6){
					...
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_Type11_start;
				}else {
...
#endif				
			{
				if(HAL_RFE_TYPE == 0){
					...
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_Type8_start;
				}else if (HAL_RFE_TYPE == 9){
					panic_printk("[%s][TXPWR_LMT_8822Bmp_TYPE9]\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_Type9_start;
				}else if (HAL_RFE_TYPE == 10){
					panic_printk("[%s][TXPWR_LMT_8822Bmp_TYPE10]\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_Type10_start;
				}else if (HAL_RFE_TYPE == 13){
					panic_printk("[%s][TXPWR_LMT_8822Bmp_TYPE13]\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_Type13_start;
				}else if (HAL_RFE_TYPE == 14){
					panic_printk("[%s][TXPWR_LMT_8822Bmp_TYPE14]\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_Type14_start;
				}else{
					panic_printk("[%s][TXPWR_LMT_8822Bmp]\n",__FUNCTION__);
					*((unsigned long*)(val)) = (unsigned long)data_TXPWR_LMT_8822Bmp_start;
				}
...
#if (IS_RTL8192E_SERIES || IS_RTL8192F_SERIES || IS_RTL8881A_SERIES || IS_RTL8822B_SERIES)
        *((pu4Byte)(val)) = platform_efio_read_4byte(Adapter, REG_TSFTR1);
#else
...
#endif
#if (IS_RTL8192E_SERIES || IS_RTL8192F_SERIES || IS_RTL8197F_SERIES || IS_RTL8822B_SERIES)
		if ( IS_HARDWARE_TYPE_8192E(Adapter) || IS_HARDWARE_TYPE_8192F(Adapter) || IS_HARDWARE_TYPE_8197F(Adapter) || IS_HARDWARE_TYPE_8822B(Adapter) ) {
...
)
{
    ...
    if (IS_SUPPORT_AP_SWPS_OFFLOAD(Adapter)) {
		...
		HAL_RTL_W8(REG_SWPS_CTRL+1,0x7F); //tmp set swps_rpt_length
...
)
{
	...
	HAL_RTL_W32(0x210, 0x0);
        ...
        GET_HAL_INTERFACE(Adapter)->SetAPPSOffloadHandler(Adapter,1, Adapter->APPS_phase, 4, 1);
        #endif
        }     
        #endif
...
#if IS_EXIST_RTL8822BE || IS_EXIST_RTL8822BS || IS_EXIST_RTL8821CE || IS_EXIST_RTL8821CS /* 8822B temp Etic remove*/
...
)
{
	...
	if (HAL_IS_PCIBIOS_TYPE(Adapter)) {
		...
		printk("page_ptr=%p, size=%d, alloc_dma_buf:%08lx, ring_virt_addr:%08lx, ring_dma_addr:%08lx\n",
			page_ptr, dma_len, _GET_HAL_DATA(Adapter)->alloc_dma_buf, _GET_HAL_DATA(Adapter)->ring_virt_addr, _GET_HAL_DATA(Adapter)->ring_dma_addr);
	}
#endif
...
#if (IS_EXIST_RTL8192EE || IS_EXIST_RTL8814AE || IS_EXIST_RTL8822BE || IS_EXIST_RTL8821CE || IS_EXIST_RTL8192FE)
	if ( IS_HARDWARE_TYPE_8192EE(Adapter) || IS_HARDWARE_TYPE_8814AE(Adapter) ||  IS_HARDWARE_TYPE_8822BE(Adapter) ||  IS_HARDWARE_TYPE_8821CE(Adapter) || IS_HARDWARE_TYPE_8192FE(Adapter)) {
...
#if IS_EXIST_RTL8822BE || IS_EXIST_RTL8197FEM || IS_EXIST_RTL8821CE
...
)
{
	...
	if (HAL_IS_PCIBIOS_TYPE(Adapter) && _GET_HAL_DATA(Adapter)->alloc_dma_buf) {
		...
		unsigned long page_align_phy = (HAL_PAGE_SIZE - (((unsigned long)_GET_HAL_DATA(Adapter)->alloc_dma_buf) & (HAL_PAGE_SIZE - 1)));
		...
		page_align_phy = (HAL_PAGE_SIZE - (((unsigned long)_GET_HAL_DATA(Adapter)->desc_dma_buf_amsdu) & (HAL_PAGE_SIZE-1)));
#ifndef USE_DMA_ALLOCATE
...
#if (IS_EXIST_RTL8192EE || IS_EXIST_RTL8192FE || IS_EXIST_RTL8814AE || IS_EXIST_RTL8822BE || IS_EXIST_RTL8821CE)
	if ( IS_HARDWARE_TYPE_8192EE(Adapter) || IS_HARDWARE_TYPE_8192FE(Adapter) || IS_HARDWARE_TYPE_8814AE(Adapter) || IS_HARDWARE_TYPE_8822BE(Adapter) || IS_HARDWARE_TYPE_8821CE(Adapter) ) {
		value32 = HAL_RTL_R32(REG_PCIE_CTRL);
		value32 = value32 | (0x7FFF);
		HAL_RTL_W32(REG_PCIE_CTRL, value32);
	}
...
)
{
    ...
    if (IS_HARDWARE_TYPE_8197F(Adapter)) 
	{
        mask_MBIDCAM_addr = BIT_MASK_MBIDCAM_ADDR_8197F;
    }
	else
#endif
	{
...
#if IS_RTL88XX_MAC_V2
        if (_GET_HAL_DATA(Adapter)->MacVersion.is_MAC_v2)
            HAL_RTL_W8(REG_BCN_CTRL, BIT3 | BIT_DIS_TSF_UDT | BIT_P0_EN_TXBCN_RPT);
#endif
#if IS_RTL88XX_MAC_V1
        if (_GET_HAL_DATA(Adapter)->MacVersion.is_MAC_v1)
...
)
{
   // clear HW TX shortCut SRAM buffer
    int lenTXSC = 0x80;
    int baseReg = 0x8000, start_addr, shift, index;
    start_addr = ((baseReg+ (macID << 7))&0x8FFF);
    ...
    for(index = 0; index < lenTXSC; index++) {
        HAL_RTL_W8(start_addr+index,0x0);            
    }       
}
...
{
    int baseReg = 0x8000, start_addr, shift;
    ...
    *(val) = ((HAL_RTL_R32(start_addr+0x28+shift)>>8)&0xFFF);
...
#if (HALMAC_8192E_SUPPORT || HALMAC_8192F_SUPPORT || HALMAC_8881A_SUPPORT) //fix compile errors of 22b+97f
    switch(mode)
    {
