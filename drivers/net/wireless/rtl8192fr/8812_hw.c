	...
	)
{
	...
	*/
	...
	if(Idx == 0)
	{	
		ODM_RT_TRACE(ODMPTR, DBG_TXBF, ODM_DBG_LOUD, ("[Beamforming]@%s, BeamformeeEntryCap == NONE, Idx=%d\n", __FUNCTION__, Idx));
    ...
    if (BeamformerEntry.BeamformEntryCap == BEAMFORMING_CAP_NONE) 
    {
        if(Idx == 0)
        {
			ODM_RT_TRACE(ODMPTR, DBG_TXBF, ODM_DBG_LOUD, ("[Beamforming]@%s, BeamformerEntryCap == NONE, Idx=%d\n", __FUNCTION__, Idx));
    ...
    if(((pBeamformingInfo->BeamformerEntry[0]).BeamformEntryCap == BEAMFORMING_CAP_NONE)
		...
		ODM_RT_TRACE(ODMPTR, DBG_TXBF, ODM_DBG_LOUD, ("[Beamforming]@%s, All BeamformerEntryCap == NONE, STOP feedback CSI\n", __FUNCTION__, Idx));
