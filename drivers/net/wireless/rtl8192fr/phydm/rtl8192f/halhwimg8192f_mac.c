...
void
odm_read_and_config_mp_8192f_mac_reg(
	struct	dm_struct *dm
)
{
	u32	i = 0;
	...
	u32	array_len = sizeof(array_mp_8192f_mac_reg) / sizeof(u32);
	u32	*array = array_mp_8192f_mac_reg;
