...
void
odm_read_and_config_mp_8197f_agc_tab(
	struct	dm_struct *dm
)
{
	u32	i = 0;
	...
	u32	array_len = sizeof(array_mp_8197f_agc_tab) / sizeof(u32);
	u32	*array = array_mp_8197f_agc_tab;
...
void
odm_read_and_config_mp_8197f_phy_reg(
	struct	dm_struct *dm
)
{
	u32	i = 0;
	u8	c_cond;
	boolean	is_matched = true, is_skipped = false;
	u32	array_len = sizeof(array_mp_8197f_phy_reg) / sizeof(u32);
	u32	*array = array_mp_8197f_phy_reg;
