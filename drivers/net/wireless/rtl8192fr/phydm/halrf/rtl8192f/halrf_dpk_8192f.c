	...
	void *dm_void)
{
	...
	u32 bb_reg[DPK_BB_REG_NUM_8192F] = {
		...
		R_0x848, R_0x930, R_0x938, R_0x93c, R_0x92c};
	...
	RF_DBG(dm, DBG_RF_DPK, "[DPK] DPK Start (Ver: %s), cut is %d\n",
	       DPK_VERSION_8192F, dm->cut_version);
...
#endif
	dpk_info->thermal_dpk_avg[dpk_info->thermal_dpk_avg_index] = thermal_value;
