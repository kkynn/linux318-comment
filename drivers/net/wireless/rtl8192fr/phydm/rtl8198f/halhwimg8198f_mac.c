...
void
odm_read_and_config_mp_8198f_mac_reg(
	struct	dm_struct *dm
)
{
	u32	i = 0;
	...
	u32	array_len = sizeof(array_mp_8198f_mac_reg)/sizeof(u32);
	u32	*array = array_mp_8198f_mac_reg;

	u32	v1 = 0, v2 = 0, pre_v1 = 0, pre_v2 = 0;

	PHYDM_DBG(dm, ODM_COMP_INIT, "===> odm_read_and_config_mp_8198f_mac_reg\n");
