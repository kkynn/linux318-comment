	...
	u8 central_ch)
{
	...
	if (central_ch <= 14) {
		...
		} else if ((central_ch >= 12) && (central_ch <= 13)) {
			odm_set_bb_reg(dm, R_0xa20, MASKHWORD, 0x5998);
			odm_set_bb_reg(dm, R_0xa24, MASKDWORD, 0x2a65a0a5);
			odm_set_bb_reg(dm, R_0xa28, MASKLWORD, 0x3213);
			odm_set_bb_reg(dm, R_0xa98, MASKHWORD, 0x2d90);
			odm_set_bb_reg(dm, R_0xaac, MASKDWORD, 0x12345677);
		} else {
			odm_set_bb_reg(dm, R_0xa20, MASKHWORD, (rega20_8195b & MASKHWORD));
			odm_set_bb_reg(dm, R_0xa24, MASKDWORD, rega24_8195b);
			odm_set_bb_reg(dm, R_0xa28, MASKLWORD, (rega28_8195b & MASKLWORD));
			odm_set_bb_reg(dm, R_0xa98, MASKHWORD, (rega98_8195b & MASKHWORD));
