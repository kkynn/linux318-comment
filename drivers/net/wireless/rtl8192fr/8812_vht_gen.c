...
//VHT CAPABILITIES INFO field
	...
	{
		if ((get_rf_mimo_mode(priv) == RF_2T2R) || (get_rf_mimo_mode(priv) == RF_3T3R)) //eric_8814 
...
//VHT CAPABILITIES INFO field
	...
	if(GET_CHIP_VER(priv) == VERSION_8822B && priv->pmib->dot11RFEntry.txbf) {
...
//// ===== VHT CAPABILITIES ELEMENT ===== /////
	...
	if((priv->pshare->is_40m_bw == CHANNEL_WIDTH_80) || (GET_CHIP_VER(priv)==VERSION_8814A))
	{
		vht_oper->vht_oper_info[0] = ((priv->pshare->is_40m_bw == CHANNEL_WIDTH_80)
