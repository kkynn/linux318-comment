	...
	if(rev > CHIP_REV_ID_A) {
		...
		if (ePHY[CLK25_9607C_P0][0].port==0) {
			struct pcie_para g2phy[PHY_PARAM_SIZE] = {
				{ 0, 0x00, 0x4008 },{ 0, 0x01, 0xa812 },{ 0, 0x02, 0x6042 },{ 0, 0x04, 0x7000 },
				...
				{ 0, 0x40, 0x4008 },{ 0, 0x41, 0xa811 },{ 0, 0x42, 0x6042 },{ 0, 0x44, 0x7000 },
...
void PCIE_PHY_MDIO_Write(unsigned int portnum, unsigned int regaddr, unsigned short val)
{
	unsigned int mdioaddr;
	volatile int count;
...
void PCIeMDIOPHYParameterSetRLE0600(unsigned int portnum)
{
	unsigned int temp=0;
...
void PCIE_MDIO_PHY_Parameter_Set(unsigned int portnum)
{
