...
typedef struct _HAL_DATA_COMMON_
{
    ...
    u4Byte              txBD_dma_ring_addr[15]; //there are 15 queues in system, including BCN queue
    u4Byte              txDesc_dma_ring_addr[15]; //there are 15 queues in system, including BCN queue
#endif
