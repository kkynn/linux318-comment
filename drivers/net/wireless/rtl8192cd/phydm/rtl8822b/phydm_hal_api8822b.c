...
{
	if(channel_num >= 52 && channel_num <= 144)
		return 1;
	else
		return 0;
}
	...
	)
{
	...
	if ((phydm_is_dfs_channel(central_ch_8822b)) && (bw_8822b == ODM_BW20M))
	...
	)
{
	...
	if (central_ch <= 14) {
		...
		/* SoML on */
		if ((reg_8 == 0x1) && (!((pDM_Odm->RFEType == 0) || (pDM_Odm->RFEType == 3) || (pDM_Odm->RFEType == 5) || (pDM_Odm->RFEType == 8) || (pDM_Odm->RFEType == 10) || (pDM_Odm->RFEType == 12) || (pDM_Odm->RFEType == 13) || (pDM_Odm->RFEType == 14)))) {
		...
		/* SoML off */
		} else if ((reg_8 == 0x0) && ((pDM_Odm->RFEType == 1) || (pDM_Odm->RFEType == 6) || (pDM_Odm->RFEType == 7) || (pDM_Odm->RFEType == 9))) {
			ODM_SetBBReg(pDM_Odm, 0x8cc, bMaskDWord, 0x08100000);
			ODM_SetBBReg(pDM_Odm, 0x8d8, BIT27, 0x0);
			ODM_SetBBReg(pDM_Odm, 0xc04, (BIT(18)|BIT(21)), 0x0);
			ODM_SetBBReg(pDM_Odm, 0xe04, (BIT(18)|BIT(21)), 0x0);
		} else {
			ODM_SetBBReg(pDM_Odm, 0x8cc, bMaskDWord, 0x08108492);
			ODM_SetBBReg(pDM_Odm, 0x8d8, BIT27, 0x1);
			/* ODM_SetBBReg(pDM_Odm, 0xc04, BIT18, 0x1); */
			/* ODM_SetBBReg(pDM_Odm, 0xe04, BIT18, 0x1); */
			/* ODM_SetBBReg(pDM_Odm, 0xc04, BIT21, 0x1); */
			/* ODM_SetBBReg(pDM_Odm, 0xe04, BIT21, 0x1); */
		}
