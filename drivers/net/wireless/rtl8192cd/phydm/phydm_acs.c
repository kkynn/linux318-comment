...
)
{
    ...
    {        
        ...
        u2Byte  period;
        period = (SS_AUTO_CHNL_NHM_TO_VALUE * (1000/4));//0x61a8;
        ...
        {   
            ...
            if(pACS->ACS_Step == 0)
            {
				...
				{
					ODM_SetBBReg(pDM_Odm,0x1850,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x3E);
					ODM_SetBBReg(pDM_Odm,0x1a50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x3E);					
				}
            ...
            else if(pACS->ACS_Step == 1)
            {
				...
				if (get_rf_mimo_mode(priv) == MIMO_3T4R)
				{
					ODM_SetBBReg(pDM_Odm,0x1850,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x2A);
					ODM_SetBBReg(pDM_Odm,0x1a50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x2A);					
				}
        ...
        else if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
        {
            ...
            ODM_Write2Byte(pDM_Odm, ODM_REG_CCX_PERIOD_11N+2, period);
            //4 Set NHM ignore_cca=1, ignore_txon=1, ccx_en=0
