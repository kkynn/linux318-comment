...
)
{
	...
	if (p_dbg->vht_pkt_not_zero){
		...
		for (i = 0; i < rate_num; i++) {
			...
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_COMMON, ODM_DBG_LOUD, ("* Driver VHT-%d ss MCS[0:9] = {%d, %d, %d, %d, %d, %d, %d, %d, %d, %d}\n",
				(i + 1),
				p_dbg->dNumQryVhtPkt[rate_ss_shift + 0], p_dbg->dNumQryVhtPkt[rate_ss_shift + 1],
				p_dbg->dNumQryVhtPkt[rate_ss_shift + 2], p_dbg->dNumQryVhtPkt[rate_ss_shift + 3],
				p_dbg->dNumQryVhtPkt[rate_ss_shift + 4], p_dbg->dNumQryVhtPkt[rate_ss_shift + 5],
				p_dbg->dNumQryVhtPkt[rate_ss_shift + 6], p_dbg->dNumQryVhtPkt[rate_ss_shift + 7],
				p_dbg->dNumQryVhtPkt[rate_ss_shift + 8], p_dbg->dNumQryVhtPkt[rate_ss_shift + 9]));
			
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_COMMON, ODM_DBG_LOUD, ("* Driver VHT-%d ss MCS[0:9] = {%d, %d, %d, %d, %d, %d, %d, %d, %d, %d}\n",
				(i + 1),
				p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 0], p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 1],
				p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 2], p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 3],
				p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 4], p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 5],
				p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 6], p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 7],
				p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 8], p_dbg->dNumQryVhtPktBytes[rate_ss_shift + 9]));
			
			
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_COMMON, ODM_DBG_LOUD, ("* Driver-retry VHT-%d ss MCS[0:9] = {%d, %d, %d, %d, %d, %d, %d, %d, %d, %d}\n",
				(i + 1),
				p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 0], p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 1],
				p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 2], p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 3],
				p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 4], p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 5],
				p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 6], p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 7],
				p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 8], p_dbg->dNumQryVhtPktRetry[rate_ss_shift + 9]));

			ODM_RT_TRACE(p_dm_odm, ODM_COMP_COMMON, ODM_DBG_LOUD, ("* Driver-CRC VHT-%d ss MCS[0:9] = {%d, %d, %d, %d, %d, %d, %d, %d, %d, %d}\n",
				(i + 1),
				p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 0], p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 1],
				p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 2], p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 3],
				p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 4], p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 5],
				p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 6], p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 7],
				p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 8], p_dbg->dNumQryVhtPktCRC[rate_ss_shift + 9]));
...
*/	
    ...
    //if (pDM_Odm->bLinked) {
        phydm_rx_rate_distribution(pDM_Odm);
    //} 
}
