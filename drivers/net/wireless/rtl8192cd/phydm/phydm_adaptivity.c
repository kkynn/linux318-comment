...
)
{
	...
	if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES) {
		...
		ODM_Write2Byte(pDM_Odm, ODM_REG_CCX_PERIOD_11N+ 2, (SS_AUTO_CHNL_NHM_TO_VALUE * (1000/4)));			/*0x894[31:16]=0x0xC350	Time duration for NHM unit: us, 0xc350=200ms*/
...
#if defined(ADAPTIVITY_IDLE_PERIOD_TIME_PATCH) && defined(NOT_RTK_BSP)
	if(priv->pshare->rf_ft_var.adaptivity_enable)
	{
		// issue idle period time > 20 us in adaptiviry test
		// 1. CTS2SELF=0
		// 2. Beacon Interframe Space 0x510 = 0x1c
		// 3. SIFS 0x514=0x17171717
		RTL_W8(0x510,0x1c);
		RTL_W32(0x514,0x17171717); //
	}
#endif
