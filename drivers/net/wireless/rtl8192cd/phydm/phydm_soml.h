...
struct _ADAPTIVE_SOML_ {
	...
	u8			soml_on_cnt;
	u8			soml_off_cnt;
	u32			pre_num_ht_pkt[HT_RATE_IDX];
	u32 		num_ht_pkt_on[HT_RATE_IDX];
	u32 		num_ht_pkt_off[HT_RATE_IDX];
	...
	u32			pre_num_vht_pkt[VHT_RATE_IDX];
	u32			num_vht_pkt_on[VHT_RATE_IDX];
	u32 		num_vht_pkt_off[VHT_RATE_IDX];
	u32			pre_num_vht_error[VHT_RATE_IDX];
	u32			num_vht_error_on[VHT_RATE_IDX];
	u32			num_vht_error_off[VHT_RATE_IDX];
#endif
