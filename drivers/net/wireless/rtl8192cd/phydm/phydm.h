...
typedef struct _ODM_Phy_Dbg_Info_
{
	...
	u8			gid_num[4];
#endif
	u32			num_qry_legacy_pkt[12];
	u32			num_qry_ht_pkt[32];
	u8			ht_pkt_not_zero;
	...
	u4Byte		dNumQryVhtPkt[40];
	u4Byte		dNumQryVhtPktBytes[40];
	u4Byte		dNumQryVhtPktRetry[40];
	u4Byte		dNumQryVhtPktCRC[40];
