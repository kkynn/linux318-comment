...
#endif
		DOT11_EVENT_WSC_NEED_DISASSOC_SET = 96,
		DOT11_EVENT_WSC_NEED_DISASSOC_GET = 97,
...
typedef struct _DOT11_WSC_CHECK_STA_IND{
	unsigned char EventId;
	unsigned char IsMoreEvent;
	unsigned char staAddr[MACADDRLEN];
	unsigned char need_disassoc;
} DOT11_WSC_CHECK_STA_IND;
#endif
#ifdef RSSI_MONITOR_NCR
