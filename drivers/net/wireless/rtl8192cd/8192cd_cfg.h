...
#define DRV_VERSION_SUBL	6

#define DRV_RELDATE		"2018-08-10"
...
//#define DMA_MAP_REFINE
//#define DEBUG_DMA_MAP
#define DEBUG_STATISTIC_PACKETS

#ifdef DEBUG_DMA_MAP
#define TX_MAP_TYPE      0
#define RX_MAP_TYPE      1
#define BEACON_MAP_TYPE  2
#define BUS1_TX_MAP_TYPE      3
#define BUS1_RX_MAP_TYPE      4
#define BUS1_BEACON_MAP_TYPE      5
#define UNKNOW_MAP_TYPE      6
#define TOTAL_MAP_TYPE      7
#endif /*DMA_MAP_REFINE end*/
...
#define CLM_SAMPLE_SS   ((50-10)*1000/4)       /*  CLM sample num , 10000*4us = 40 ms* , smaller than SS_TIME */
...
// Support Rx AMSDU
//-------------------------------------------------------------
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_RTL_8812_SUPPORT) || defined(CONFIG_WLAN_HAL_8192EE)
...
#define STA_CONTROL_SUPPORT_NUM     1
#define STA_CONTROL_SHM_SIZE        (2000 / STA_CONTROL_SUPPORT_NUM)
#endif
#endif
...
//-------------------------------------------------------------
	...
	#define RX_TASKLET
#endif
#ifndef CONFIG_RTL9607C // do not close direct rx
...
#define dybw_thrd	3
    ...
    #define NUM_RX_DESC		320	//256
		...
		#define NUM_RX_DESC 	320
			...
			#define NUM_RX_DESC		480	//256 
				...
				#else
					#define NUM_RX_DESC     3000
				#endif
			#endif
			#else		
				#define NUM_RX_DESC     1024//256  
			#endif
	...
	#define NUM_RX_DESC_2G 512 //400  /* wlan1 92E */
#else
...
#define SS_TIME			50		/* unit: MILISECONDS*/
...
#define SS_TO			RTL_MILISECONDS_TO_JIFFIES(SS_TIME)
...
#define LED_NOBLINK_TIME		RTL_SECONDS_TO_JIFFIES(5)	// time more than watchdog interval
...
#define ADAPTIVITY_IDLE_PERIOD_TIME_PATCH
...
#ifdef RX_BUFFER_GATHER
#ifdef __LINUX_2_6__
#if defined(SUPPORT_RX_AMSDU_AMPDU) && (!defined(WIFI_BUFFER_LIMITED))
...
//-------------------------------------------------------------
// Create kernel thread to do IQK
// This support only for 92E, 8812E, 8814A and 8812B. If want to support other chip, need further modification
//-------------------------------------------------------------
//#define IQK_THREAD

#if defined(IQK_THREAD) && defined(TPT_THREAD)
#undef TPT_THREAD
#endif
...
#elif defined(CONFIG_WLAN_HAL_8192EE) && defined(CONFIG_WLAN_HAL_8822BE)
	#define MAX_SKB_NUM_1 400  /* wlan1 92E */
#else
...
#define RTL8192CD_NUM_VWLAN  (4) //harware limitation of HWNAT
#else
