...
#define RTL8812_TRANS_CARDEMU_TO_ACT 														\
	...
	{0x0028, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT(3), 0}, /* 0x28[33] Choose the type of buffer after xosc: nand*/	
...
#define RTL8812_TRANS_CARDDIS_TO_CARDEMU													\
	...
	{0x0028, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT(3), BIT(3)}, /* 0x28[33] Choose the type of buffer after xosc: schmitt trigger*/	\
